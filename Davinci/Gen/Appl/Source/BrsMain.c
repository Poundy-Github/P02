...
#if !defined (BRS_FBL_LEGACY) && !defined (_MICROSOFT_C_VTT_)
...
#  endif
# endif
#endif /*!BRS_FBL_LEGACY&&!_MICROSOFT_C_VTT_*/
...
# endif /*BRS_ENABLE_OS_MULTICORESUPPORT*/
#endif /*!BRS_FBL_LEGACY && !BRS_FBL_NO_OSSCHEDULE*/
...
//#define VHSM_SYNC_WITH_RAMLOOP
#ifdef VHSM_SYNC_WITH_RAMLOOP
	___asm(;/* Copy function to RAM and jump there to wait for vHsm in RAM */)
	__as1(mov ___ghs_ramcodestart, r11 ; /* start address */)
	__as1(mov ___ghs_ramcodeend, r12 ; /* end address */)
	__as1(mov ___ghs_romramcodestart, r13 ; /* end address */)
	___asm(_initRamCode:)
	__as1(ld.w 0[r13], r14)
	__as1(st.w r14, 0[r11])
	__as2(addi 4, r11, r11)
	__as2(addi 4, r13, r13)
	__as1(cmp r11, r12)
	___asm(bh _initRamCode)
	__as1(jarl _Crypto_30_vHsm_WaitForHsmRam, lp)
#endif

  #define VHSM_SYNC_WITH_REGISTER
#ifdef VHSM_SYNC_WITH_REGISTER
___asm(;/* Flags inside the register ICUM_ICU2PES */)
___asm(;/* Bit 0: vHsm is activated */)
___asm(;/* Bit 1: vHsm is ready */)
___asm(;/* Bit 2-7: not used */)
___asm(waitloop:)
__as1(mov 0xFF1F0010, r11 ; )
__as1(ld.w 0[r11],r18; /* Read the ICUM_ICU2PES register */)
__as1(mov 0x00000003, r11 ; /* Check if vHsm is activated and ready */)
__as1(cmp r11, r18)
___asm(bnz waitloop; /* Loop until the ICUM is ready */)
#endif
...
#else
# if !defined (BRS_FBL_NO_OSSCHEDULE)
  Os_InitMemory();
  Os_Init();
# endif
...
/*void SchM_Enter_CanSM_CANSM_EXCLUSIVE_AREA_5(void)
{
  if (++BrsAsrApplCanInterruptLockCtr == 1u)
  {
    BRS_DRVCAN_ControllerInterrupts_INFIX(Disable)(0u);
...
void SchM_Exit_CanSM_CANSM_EXCLUSIVE_AREA_5(void)
{
  if (--BrsAsrApplCanInterruptLockCtr == 0u)
  {
    BRS_DRVCAN_ControllerInterrupts_INFIX(Enable)(0u);
