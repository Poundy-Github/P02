...
/**********************************************************************************************************************
  VERSION CHECK
**********************************************************************************************************************/
#if (BRSMAINSTARTUP_VERSION != 0x0200u)
...
void Brs_PreMainStartup(void)
{
  ...
  BrsMain_MemoryInit_StageZero_Hook(BrsHw_GetCore());
  ...
  Brs_MemoryZeroInit(&vLinkGen_ZeroInit_Zero_GroupsSet, BRS_INIT_PATTERN_AREAS, BrsHw_GetCore());
#endif
  ...
  Brs_MemoryInit(&vLinkGen_Init_Zero_GroupsSet, BrsHw_GetCore());
#endif

  BrsMain_MemoryInit_StageOne_Hook(BrsHw_GetCore());
  ...
  Brs_MemoryZeroInit(&vLinkGen_ZeroInit_One_BlocksSet, BRS_INIT_PATTERN_BLOCKS, BrsHw_GetCore());
#endif
  ...
  Brs_MemoryZeroInit(&vLinkGen_ZeroInit_One_GroupsSet, BRS_INIT_PATTERN_AREAS, BrsHw_GetCore());
#endif
  ...
  Brs_MemoryInit(&vLinkGen_Init_One_GroupsSet, BrsHw_GetCore());
#endif

  BrsMain_MemoryInit_StageHardReset_Hook(BrsHw_GetCore());
  ...
  if (ResetReason != BRSHW_RESET_SW)
  {
    ...
    Brs_MemoryZeroInit(&vLinkGen_ZeroInit_HardReset_BlocksSet, BRS_INIT_PATTERN_HARDRESET_BLOCKS, BrsHw_GetCore());
  }
#endif
  ...
  if (ResetReason != BRSHW_RESET_SW)
  {
    ...
    Brs_MemoryZeroInit(&vLinkGen_ZeroInit_HardReset_GroupsSet, BRS_INIT_PATTERN_HARDRESET_AREAS, BrsHw_GetCore());
  }
#endif
  ...
  if (ResetReason != BRSHW_RESET_SW)
  {
    ...
    Brs_MemoryInit(&vLinkGen_Init_HardReset_GroupsSet, BrsHw_GetCore());
  }
#endif

  BrsMain_MemoryInit_StageTwo_Hook(BrsHw_GetCore());
  ...
  Brs_MemoryZeroInit(&vLinkGen_ZeroInit_Two_GroupsSet, BRS_INIT_PATTERN_AREAS, BrsHw_GetCore());
#endif
  ...
  Brs_MemoryInit(&vLinkGen_Init_Two_GroupsSet, BrsHw_GetCore());
#endif

  BrsMain_MemoryInit_StageThree_Hook(BrsHw_GetCore());
  ...
  Brs_MemoryZeroInit(&vLinkGen_ZeroInit_Three_GroupsSet, BRS_INIT_PATTERN_AREAS, BrsHw_GetCore());
#endif
  ...
  Brs_MemoryInit(&vLinkGen_Init_Three_GroupsSet, BrsHw_GetCore());
#endif

  BrsMain_PreMainHook(BrsHw_GetCore());
