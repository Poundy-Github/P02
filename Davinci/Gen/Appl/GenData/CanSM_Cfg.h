 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanSM_Cfg.h
 *   Generation Time: 2021-04-05 16:20:55
...
#define CANSM_BOR_CHECK_LEVEL                 STD_ON
...
/** 
  ...
  \{
*/ 
#define CanSM_GetBorCounterL1ToL2OfChannelConfig(Index)               6u
#define CanSM_GetBorTimeL1OfChannelConfig(Index)                      18u
#define CanSM_GetBorTimeL2OfChannelConfig(Index)                      200u
...
#define CanSM_GetTransceiverIdOfChannelConfig(Index)                  2u
...
/** 
  ...
  \{
*/ 
#define CANSM_EQ2_BORCOUNTERL1TOL2OFCHANNELCONFIG                     6u
#define CANSM_EQ2_BORTIMEL1OFCHANNELCONFIG                            18u
#define CANSM_EQ2_BORTIMEL2OFCHANNELCONFIG                            200u
...
#define CANSM_EQ2_TRANSCEIVERIDOFCHANNELCONFIG                        2u
...
extern FUNC(void, CANSM_APPL_CODE) CanServer_BusOffBegin( NetworkHandleType  NetworkHandle, P2VAR(uint8, AUTOMATIC, CANSM_APPL_VAR) OnlineDelayCyclesPtr );
...
extern FUNC(void, CANSM_APPL_CODE) CanServer_BusOffEnd( NetworkHandleType  NetworkHandle );
