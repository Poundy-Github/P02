 ...
 ** Module: E2EPW_Common_Safety_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_rx.c
...
#include "E2EPW_Common_Safety_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_rx.h"
#ifndef STATIC
...
STATIC VAR (E2E_P01CheckStateType, Common_Safety_VAR_INIT)
    StateVal_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
...
STATIC P2VAR ( E2E_P01CheckStateType
    ...
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 =
        &StateVal_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2;
...
STATIC VAR (uint8, Common_Safety_VAR_NOINIT)
    ppa_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_au8 [8];
...
STATIC CONST (E2E_P01ConfigType, Common_Safety_CONST)
    ConfigVal_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 =
{
      56
    , 0
    , 91
...
/**********************************************************
 * Function name: E2EPW_Init_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_rx ()
 ...
 **********************************************************/
FUNC (void, Common_Safety_CODE) E2EPW_ReadInit_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 (void)
{
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 = &StateVal_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->LastValidCounter = 0;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->MaxDeltaCounter  = 0;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->WaitForFirstData = TRUE;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->NewDataAvailable = FALSE;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->LostData         = 0;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->SyncCounter      = 0;
    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->NoNewOrRepeatedDataCounter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_ReceiverState_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 ()
...
FUNC_P2VAR ( E2E_P01CheckStateType
    ...
    E2EPW_Get_CheckState_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 (void)
{
    return State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2;
}

/**********************************************************
 * Function name: E2EPW_Read_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 (SG_AEB2_AEB_FD2 * AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Safety_CODE) E2EPW_Read_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2
    ( P2VAR (SG_AEB2_AEB_FD2, AUTOMATIC, Common_Safety_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Safety_CONST)
        Config_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 = &ConfigVal_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2;

    State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->NewDataAvailable =
        Rte_IsUpdated_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 ();

    if ((State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_AEB2_AEB_FD2 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->CounterOffset >> 3u;
            E2EPW_Marshal_SG_AEB2_AEB_FD2 ( AppData, ppa_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_au8[crcoffset_u16]  = AppData->Checksum_AEB2;
            ppa_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_au8[cntoffset_u16] |= AppData->RollingCounter_AEB2;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2
                     , State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2
                     , ppa_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_AEB2_AEB_FD2_SG_AEB2_AEB_FD2->Status<<24);
    }
