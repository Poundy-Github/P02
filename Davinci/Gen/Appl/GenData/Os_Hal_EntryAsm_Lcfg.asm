 ...
 *********************************************************************************************************************/
  ...
  OS_HAL_ASM_EXC(core0_0x0010, ECCTST_G3KH_SYSERR_ISR)   
    
  OS_HAL_ASM_EXC(core0_0x0020, Os_Hal_UnhandledExc)   
    
  OS_HAL_ASM_EXC(core0_0x0030, CORTST_G3KH_FETRAP_ISR)   
    
  OS_HAL_ASM_EXC(core0_0x0040, Os_Hal_TrapHandler)    
  
  OS_HAL_ASM_EXC(core0_0x0050, CORTST_G3KH_EITRAP1_ISR)     
 ...
 *********************************************************************************************************************/
  ...
  /* Irq Channel 7 */ OS_HAL_ASM_WORD(Os_Hal_Irq_vHsmResponseIsr) 
  ...
  /* Irq Channel 22 */ OS_HAL_ASM_WORD(Os_Hal_Irq_CanIsrGlobalStatus) 
  /* Irq Channel 23 */ OS_HAL_ASM_WORD(Os_Hal_UnhandledIrq) 
  /* Irq Channel 24 */ OS_HAL_ASM_WORD(Os_Hal_Irq_CanIsrStatus_0) 
  /* Irq Channel 25 */ OS_HAL_ASM_WORD(Os_Hal_Irq_CanIsrWakeup_0) 
  ...
  /* Irq Channel 37 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH00_CAT2_ISR) 
  /* Irq Channel 38 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH01_CAT2_ISR) 
  ...
  /* Irq Channel 44 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH04_CAT2_ISR) 
  /* Irq Channel 45 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH05_CAT2_ISR) 
  /* Irq Channel 46 */ OS_HAL_ASM_WORD(Os_Hal_UnhandledIrq) 
  /* Irq Channel 47 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH11_CAT2_ISR) 
  ...
  /* Irq Channel 54 */ OS_HAL_ASM_WORD(Os_Hal_Irq_TAUD0_CH13_CAT2_ISR) 
  /* Irq Channel 55 */ OS_HAL_ASM_WORD(Os_Hal_Irq_TAUD0_CH15_CAT2_ISR) 
  ...
  /* Irq Channel 76 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC0TI_interrupt) 
  /* Irq Channel 77 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC0EE_interrupt) 
  /* Irq Channel 78 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC0RI_interrupt) 
  /* Irq Channel 79 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC0TEI_interrupt) 
  /* Irq Channel 80 */ OS_HAL_ASM_WORD(Os_Hal_UnhandledIrq) 
  /* Irq Channel 81 */ OS_HAL_ASM_WORD(GptIsr_1ms_tick) 
  /* Irq Channel 82 */ OS_HAL_ASM_WORD(Os_Hal_UnhandledIrq) 
  /* Irq Channel 83 */ OS_HAL_ASM_WORD(Os_Hal_UnhandledIrq) 
  /* Irq Channel 84 */ OS_HAL_ASM_WORD(Os_Hal_UnhandledIrq) 
  ...
  /* Irq Channel 113 */ OS_HAL_ASM_WORD(Os_Hal_Irq_CanIsrStatus_1) 
  /* Irq Channel 114 */ OS_HAL_ASM_WORD(Os_Hal_Irq_CanIsrWakeup_1) 
  ...
  /* Irq Channel 120 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Lin_RLIN_31_INTRLIN31) 
  ...
  /* Irq Channel 131 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH12_CAT2_ISR) 
  ...
  /* Irq Channel 164 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Lin_RLIN_32_INTRLIN32) 
  ...
  /* Irq Channel 205 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH09_CAT2_ISR) 
  /* Irq Channel 206 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH13_CAT2_ISR) 
  ...
  /* Irq Channel 221 */ OS_HAL_ASM_WORD(Os_Hal_Irq_CanIsrWakeup_3) 
  ...
  /* Irq Channel 233 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Uart_IntTx4) 
  /* Irq Channel 234 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Uart_IntRx4) 
  /* Irq Channel 235 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Uart_IntErr4) 
  /* Irq Channel 236 */ OS_HAL_ASM_WORD(Os_Hal_UnhandledIrq) 
  /* Irq Channel 237 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Uart_IntTx5) 
  /* Irq Channel 238 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Uart_IntRx5) 
  /* Irq Channel 239 */ OS_HAL_ASM_WORD(Os_Hal_Irq_Uart_IntErr5) 
  /* Irq Channel 240 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC1TI_interrupt) 
  /* Irq Channel 241 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC1EE_interrupt) 
  /* Irq Channel 242 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC1RI_interrupt) 
  /* Irq Channel 243 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTRIIC1TEI_interrupt) 
  ...
  /* Irq Channel 277 */ OS_HAL_ASM_WORD(Os_Hal_Irq_CounterIsr_SystemTimer) 
  ...
  /* Irq Channel 359 */ OS_HAL_ASM_WORD(Os_Hal_Irq_INTFICUIF0DFRQPE) 
  ...
  /* Irq Channel 370 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH18_CAT2_ISR) 
  /* Irq Channel 371 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH19_CAT2_ISR) 
  /* Irq Channel 372 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH20_CAT2_ISR) 
  /* Irq Channel 373 */ OS_HAL_ASM_WORD(Os_Hal_Irq_EXT_INTP_CH21_CAT2_ISR) 
 ...
 *********************************************************************************************************************/
  ...
  OS_HAL_ASM_CAT2ISR(CanIsrStatus_1) 

  OS_HAL_ASM_CAT2ISR(CanIsrStatus_3) 

  OS_HAL_ASM_CAT2ISR(CanIsrWakeup_0) 

  OS_HAL_ASM_CAT2ISR(CanIsrWakeup_1) 

  OS_HAL_ASM_CAT2ISR(CanIsrWakeup_3) 

  OS_HAL_ASM_CAT2ISR(CounterIsr_SystemTimer) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH00_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH01_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH03_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH04_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH05_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH09_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH11_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH12_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH13_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH18_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH19_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH20_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(EXT_INTP_CH21_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(INTFICUIF0DFRQPE) 

  OS_HAL_ASM_CAT2ISR(INTRIIC0EE_interrupt) 

  OS_HAL_ASM_CAT2ISR(INTRIIC0RI_interrupt) 

  OS_HAL_ASM_CAT2ISR(INTRIIC0TEI_interrupt) 

  OS_HAL_ASM_CAT2ISR(INTRIIC0TI_interrupt) 

  OS_HAL_ASM_CAT2ISR(INTRIIC1EE_interrupt) 

  OS_HAL_ASM_CAT2ISR(INTRIIC1RI_interrupt) 

  OS_HAL_ASM_CAT2ISR(INTRIIC1TEI_interrupt) 

  OS_HAL_ASM_CAT2ISR(INTRIIC1TI_interrupt) 

  OS_HAL_ASM_CAT2ISR(Lin_RLIN_31_INTRLIN31) 

  OS_HAL_ASM_CAT2ISR(Lin_RLIN_32_INTRLIN32) 

  OS_HAL_ASM_CAT2ISR(SPI_CSIH3_TIR_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(TAUD0_CH13_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(TAUD0_CH15_CAT2_ISR) 

  OS_HAL_ASM_CAT2ISR(Uart_IntErr4) 

  OS_HAL_ASM_CAT2ISR(Uart_IntErr5) 

  OS_HAL_ASM_CAT2ISR(Uart_IntRx4) 

  OS_HAL_ASM_CAT2ISR(Uart_IntRx5) 

  OS_HAL_ASM_CAT2ISR(Uart_IntTx4) 

  OS_HAL_ASM_CAT2ISR(Uart_IntTx5) 

  OS_HAL_ASM_CAT2ISR(vHsmResponseIsr) 
