 ...
 ** Module: E2EPW_Common_Safety_SG_DHT_FD1_SG_DHT_FD1_rx.c
...
#include "E2EPW_Common_Safety_SG_DHT_FD1_SG_DHT_FD1_rx.h"
#ifndef STATIC
...
STATIC VAR (E2E_P01CheckStateType, Common_Safety_VAR_INIT)
    StateVal_SG_DHT_FD1_SG_DHT_FD1 =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
...
STATIC VAR (uint8, Common_Safety_VAR_NOINIT)
    ppa_SG_DHT_FD1_SG_DHT_FD1_au8 [8];
...
STATIC CONST (E2E_P01ConfigType, Common_Safety_CONST)
    ConfigVal_SG_DHT_FD1_SG_DHT_FD1 =
{
      56
    , 0
    , 203
 ...
 **********************************************************/
FUNC (void, Common_Safety_CODE) E2EPW_ReadInit_SG_DHT_FD1_SG_DHT_FD1 (void)
{
    State_SG_DHT_FD1_SG_DHT_FD1 = &StateVal_SG_DHT_FD1_SG_DHT_FD1;
    State_SG_DHT_FD1_SG_DHT_FD1->LastValidCounter = 0;
    State_SG_DHT_FD1_SG_DHT_FD1->MaxDeltaCounter  = 0;
    State_SG_DHT_FD1_SG_DHT_FD1->WaitForFirstData = TRUE;
    State_SG_DHT_FD1_SG_DHT_FD1->NewDataAvailable = FALSE;
    State_SG_DHT_FD1_SG_DHT_FD1->LostData         = 0;
    State_SG_DHT_FD1_SG_DHT_FD1->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_DHT_FD1_SG_DHT_FD1->SyncCounter      = 0;
    State_SG_DHT_FD1_SG_DHT_FD1->NoNewOrRepeatedDataCounter = 0;
}
...
{
    return State_SG_DHT_FD1_SG_DHT_FD1;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Safety_CODE) E2EPW_Read_SG_DHT_FD1_SG_DHT_FD1
    ( P2VAR (SG_DHT_FD1, AUTOMATIC, Common_Safety_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Safety_CONST)
        Config_SG_DHT_FD1_SG_DHT_FD1 = &ConfigVal_SG_DHT_FD1_SG_DHT_FD1;

    State_SG_DHT_FD1_SG_DHT_FD1->NewDataAvailable =
        Rte_IsUpdated_SG_DHT_FD1_SG_DHT_FD1 ();

    if ((State_SG_DHT_FD1_SG_DHT_FD1->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_DHT_FD1_SG_DHT_FD1 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_DHT_FD1 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_DHT_FD1_SG_DHT_FD1->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_DHT_FD1_SG_DHT_FD1->CounterOffset >> 3u;
            E2EPW_Marshal_SG_DHT_FD1 ( AppData, ppa_SG_DHT_FD1_SG_DHT_FD1_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_DHT_FD1_SG_DHT_FD1_au8[crcoffset_u16]  = AppData->CheckSum_DHT1;
            ppa_SG_DHT_FD1_SG_DHT_FD1_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_DHT_FD1_SG_DHT_FD1_au8[cntoffset_u16] |= AppData->RollingCounter_DHT1;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_DHT_FD1_SG_DHT_FD1
                     , State_SG_DHT_FD1_SG_DHT_FD1
                     , ppa_SG_DHT_FD1_SG_DHT_FD1_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_DHT_FD1_SG_DHT_FD1->Status<<24);
    }
