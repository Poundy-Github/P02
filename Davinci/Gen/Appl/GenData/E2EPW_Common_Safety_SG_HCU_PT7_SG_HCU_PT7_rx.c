 ...
 ** Module: E2EPW_Common_Safety_SG_HCU_PT7_SG_HCU_PT7_rx.c
 ...
 **********************************************************/
FUNC (void, Common_Safety_CODE) E2EPW_ReadInit_SG_HCU_PT7_SG_HCU_PT7 (void)
{
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Safety_CODE) E2EPW_Read_SG_HCU_PT7_SG_HCU_PT7
    ( P2VAR (SG_HCU_PT7, AUTOMATIC, Common_Safety_VAR_INIT) AppData)
{
