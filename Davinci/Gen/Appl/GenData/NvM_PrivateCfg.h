...
#define NVM_SIZE_STANDARD_JOB_QUEUE  (64u) 
...
#define NVM_NOOFWRITEATTEMPTS 5u
...
extern VAR(NvM_RamMngmtAreaType, NVM_CONFIG_DATA) NvM_BlockMngmtArea_at[]; /* PRQA S 3684 */ /* MD_NvM_Cfg_8.11 */
