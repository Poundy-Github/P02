 ...
 ** Module: E2EPW_Common_GateWay_SG_ACC7_ACC_FD2_SG_ACC7_ACC_FD2_rx.c
 ...
 **********************************************************/
FUNC (void, Common_GateWay_CODE) E2EPW_ReadInit_SG_ACC7_ACC_FD2_SG_ACC7_ACC_FD2 (void)
{
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_GateWay_CODE) E2EPW_Read_SG_ACC7_ACC_FD2_SG_ACC7_ACC_FD2
    ( P2VAR (SG_ACC7_ACC_FD2, AUTOMATIC, Common_GateWay_VAR_INIT) AppData)
{
