 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanTp_Cfg.h
 *   Generation Time: 2021-10-25 11:28:14
...
/* -----------------------------------------------------------------------------
    &&&~ Rx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_8892e7d5 0u 
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_5a6f1069 1u 
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_3e4fc4df 2u 
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_0c0cf4f1 3u 

 
/* -----------------------------------------------------------------------------
    &&&~ Tx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_8892e7d5 0u 
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_5a6f1069 1u 


/* -----------------------------------------------------------------------------
    &&&~ Rx Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_2185859a 0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_037f5168     0u 
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_86954882 1u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_a46f9c70     1u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_233f39d0     2u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_4ba4a7e4     3u 


/* -----------------------------------------------------------------------------
    &&&~ TxConfirmation Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_037f5168 0u 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_2185859a     0u 
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_a46f9c70 1u 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_86954882     1u 
...
#define CanTp_GetSizeOfTxQueueOfPCConfig()                                                          2u  /**< the number of accomplishable value elements in CanTp_TxQueue */
