 ...
 ** Module: E2EPW_Common_Normal_SG_BMS4_SG_BMS4_rx.c
...
#include "E2EPW_Marshal_SG_BMS4.h"
#include "E2EPW_CheckDeserial_SG_BMS4.h"
#include "E2EPW_Common_Normal_SG_BMS4_SG_BMS4_rx.h"
#ifndef STATIC
...
/**********************************************************
 * Function name: E2EPW_Init_SG_BMS4_SG_BMS4_rx ()
 ...
 **********************************************************/
FUNC (void, Common_Normal_CODE) E2EPW_ReadInit_SG_BMS4_SG_BMS4 (void)
{
    State_SG_BMS4_SG_BMS4 = &StateVal_SG_BMS4_SG_BMS4;
    State_SG_BMS4_SG_BMS4->LastValidCounter = 0;
    State_SG_BMS4_SG_BMS4->MaxDeltaCounter  = 0;
    State_SG_BMS4_SG_BMS4->WaitForFirstData = TRUE;
    State_SG_BMS4_SG_BMS4->NewDataAvailable = FALSE;
    State_SG_BMS4_SG_BMS4->LostData         = 0;
    State_SG_BMS4_SG_BMS4->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_BMS4_SG_BMS4->SyncCounter      = 0;
    State_SG_BMS4_SG_BMS4->NoNewOrRepeatedDataCounter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_ReceiverState_SG_BMS4_SG_BMS4 ()
...
FUNC_P2VAR ( E2E_P01CheckStateType
    ...
    E2EPW_Get_CheckState_SG_BMS4_SG_BMS4 (void)
{
    return State_SG_BMS4_SG_BMS4;
}

/**********************************************************
 * Function name: E2EPW_Read_SG_BMS4_SG_BMS4 (SG_BMS4 * AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Normal_CODE) E2EPW_Read_SG_BMS4_SG_BMS4
    ( P2VAR (SG_BMS4, AUTOMATIC, Common_Normal_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Normal_CONST)
        Config_SG_BMS4_SG_BMS4 = &ConfigVal_SG_BMS4_SG_BMS4;

    State_SG_BMS4_SG_BMS4->NewDataAvailable =
        Rte_IsUpdated_SG_BMS4_SG_BMS4 ();

    if ((State_SG_BMS4_SG_BMS4->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_BMS4_SG_BMS4 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_BMS4 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_BMS4_SG_BMS4->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_BMS4_SG_BMS4->CounterOffset >> 3u;
            E2EPW_Marshal_SG_BMS4 ( AppData, ppa_SG_BMS4_SG_BMS4_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_BMS4_SG_BMS4_au8[crcoffset_u16]  = AppData->CheckSum_BMS4;
            ppa_SG_BMS4_SG_BMS4_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_BMS4_SG_BMS4_au8[cntoffset_u16] |= AppData->RollingCounter_BMS4;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_BMS4_SG_BMS4
                     , State_SG_BMS4_SG_BMS4
                     , ppa_SG_BMS4_SG_BMS4_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_BMS4_SG_BMS4->Status<<24);
    }
