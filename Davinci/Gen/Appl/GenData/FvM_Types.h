...
**********************************************************************************************************************/
typedef P2FUNC(void, FVM_APPL_CODE, FvMTripCounterMaxNotificationDefType) (void);
typedef P2FUNC(void, FVM_APPL_CODE, FvMResetCounterMaxNotificationDefType) (void);
typedef P2FUNC(void, FVM_APPL_CODE, FvMMessageCounterMaxNotificationDefType) (uint16 freshnessValueID);
typedef P2FUNC(void, FVM_APPL_CODE, FvMTripCounterMaxNotificationWithParamDefType) (uint16 freshnessValueID);
