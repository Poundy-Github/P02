 ...
 ** Module: E2EPW_Common_Normal_SG_HCU_HP5_SG_HCU_HP5_rx.c
...
#include "E2EPW_Common_Normal_SG_HCU_HP5_SG_HCU_HP5_rx.h"
#ifndef STATIC
...
STATIC VAR (E2E_P01CheckStateType, Common_Normal_VAR_INIT)
    StateVal_SG_HCU_HP5_SG_HCU_HP5 =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
...
STATIC VAR (uint8, Common_Normal_VAR_NOINIT)
    ppa_SG_HCU_HP5_SG_HCU_HP5_au8 [8];
...
STATIC CONST (E2E_P01ConfigType, Common_Normal_CONST)
    ConfigVal_SG_HCU_HP5_SG_HCU_HP5 =
{
      56
    , 0
    , 141
 ...
 **********************************************************/
FUNC (void, Common_Normal_CODE) E2EPW_ReadInit_SG_HCU_HP5_SG_HCU_HP5 (void)
{
    State_SG_HCU_HP5_SG_HCU_HP5 = &StateVal_SG_HCU_HP5_SG_HCU_HP5;
    State_SG_HCU_HP5_SG_HCU_HP5->LastValidCounter = 0;
    State_SG_HCU_HP5_SG_HCU_HP5->MaxDeltaCounter  = 0;
    State_SG_HCU_HP5_SG_HCU_HP5->WaitForFirstData = TRUE;
    State_SG_HCU_HP5_SG_HCU_HP5->NewDataAvailable = FALSE;
    State_SG_HCU_HP5_SG_HCU_HP5->LostData         = 0;
    State_SG_HCU_HP5_SG_HCU_HP5->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_HCU_HP5_SG_HCU_HP5->SyncCounter      = 0;
    State_SG_HCU_HP5_SG_HCU_HP5->NoNewOrRepeatedDataCounter = 0;
}
...
{
    return State_SG_HCU_HP5_SG_HCU_HP5;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Normal_CODE) E2EPW_Read_SG_HCU_HP5_SG_HCU_HP5
    ( P2VAR (SG_HCU_HP5, AUTOMATIC, Common_Normal_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Normal_CONST)
        Config_SG_HCU_HP5_SG_HCU_HP5 = &ConfigVal_SG_HCU_HP5_SG_HCU_HP5;

    State_SG_HCU_HP5_SG_HCU_HP5->NewDataAvailable =
        Rte_IsUpdated_SG_HCU_HP5_SG_HCU_HP5 ();

    if ((State_SG_HCU_HP5_SG_HCU_HP5->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_HCU_HP5_SG_HCU_HP5 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_HCU_HP5 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_HCU_HP5_SG_HCU_HP5->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_HCU_HP5_SG_HCU_HP5->CounterOffset >> 3u;
            E2EPW_Marshal_SG_HCU_HP5 ( AppData, ppa_SG_HCU_HP5_SG_HCU_HP5_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_HCU_HP5_SG_HCU_HP5_au8[crcoffset_u16]  = AppData->Checksum_HCU_HP5;
            ppa_SG_HCU_HP5_SG_HCU_HP5_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_HCU_HP5_SG_HCU_HP5_au8[cntoffset_u16] |= AppData->RollingCounter_HCU_HP5;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_HCU_HP5_SG_HCU_HP5
                     , State_SG_HCU_HP5_SG_HCU_HP5
                     , ppa_SG_HCU_HP5_SG_HCU_HP5_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_HCU_HP5_SG_HCU_HP5->Status<<24);
    }
