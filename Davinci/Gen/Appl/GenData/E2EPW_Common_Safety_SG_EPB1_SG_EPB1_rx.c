 ...
 ** Module: E2EPW_Common_Safety_SG_EPB1_SG_EPB1_rx.c
...
#include "E2EPW_CheckDeserial_SG_EPB1.h"
...
/**********************************************************
 * Function name: E2EPW_Init_SG_EPB1_SG_EPB1_rx ()
 ...
 **********************************************************/
FUNC (void, Common_Safety_CODE) E2EPW_ReadInit_SG_EPB1_SG_EPB1 (void)
{
    State_SG_EPB1_SG_EPB1 = &StateVal_SG_EPB1_SG_EPB1;
    State_SG_EPB1_SG_EPB1->LastValidCounter = 0;
    State_SG_EPB1_SG_EPB1->MaxDeltaCounter  = 0;
    State_SG_EPB1_SG_EPB1->WaitForFirstData = TRUE;
    State_SG_EPB1_SG_EPB1->NewDataAvailable = FALSE;
    State_SG_EPB1_SG_EPB1->LostData         = 0;
    State_SG_EPB1_SG_EPB1->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_EPB1_SG_EPB1->SyncCounter      = 0;
    State_SG_EPB1_SG_EPB1->NoNewOrRepeatedDataCounter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_ReceiverState_SG_EPB1_SG_EPB1 ()
...
FUNC_P2VAR ( E2E_P01CheckStateType
    ...
    E2EPW_Get_CheckState_SG_EPB1_SG_EPB1 (void)
{
    return State_SG_EPB1_SG_EPB1;
}

/**********************************************************
 * Function name: E2EPW_Read_SG_EPB1_SG_EPB1 (SG_EPB1 * AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Safety_CODE) E2EPW_Read_SG_EPB1_SG_EPB1
    ( P2VAR (SG_EPB1, AUTOMATIC, Common_Safety_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Safety_CONST)
        Config_SG_EPB1_SG_EPB1 = &ConfigVal_SG_EPB1_SG_EPB1;

    State_SG_EPB1_SG_EPB1->NewDataAvailable =
        Rte_IsUpdated_SG_EPB1_SG_EPB1 ();

    if ((State_SG_EPB1_SG_EPB1->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_EPB1_SG_EPB1 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_EPB1 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_EPB1_SG_EPB1->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_EPB1_SG_EPB1->CounterOffset >> 3u;
            E2EPW_Marshal_SG_EPB1 ( AppData, ppa_SG_EPB1_SG_EPB1_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_EPB1_SG_EPB1_au8[crcoffset_u16]  = AppData->CheckSum_EPB1;
            ppa_SG_EPB1_SG_EPB1_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_EPB1_SG_EPB1_au8[cntoffset_u16] |= AppData->RollingCounter_EPB1;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_EPB1_SG_EPB1
                     , State_SG_EPB1_SG_EPB1
                     , ppa_SG_EPB1_SG_EPB1_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_EPB1_SG_EPB1->Status<<24);
    }
