 ...
 ** Module: E2EPW_CheckDeserial_SG_IFC6_IFC_FD2.c
...
/******************************************************************
 * Function name      : E2EPW_CheckDeserial_SG_IFC6_IFC_FD2
 ...
 * Remarks            : none
 ******************************************************************/
FUNC (uint8, E2EPW_CODE) E2EPW_CheckDeserial_SG_IFC6_IFC_FD2
    ( P2CONST (SG_IFC6_IFC_FD2, AUTOMATIC, E2EPW_APPL_DATA) pde )
{
    VAR (uint8, AUTOMATIC) ret = 0;

    if ((pde->dummy_IFC_FD2_20 & 0xf0u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }

    if ((pde->IFC_NextLeLane_dy & 0xf000u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }

    if ((pde->IFC_NextRiLane_dy & 0xf000u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }

    if ((pde->RollingCounter_IFC6 & 0xf0u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }
