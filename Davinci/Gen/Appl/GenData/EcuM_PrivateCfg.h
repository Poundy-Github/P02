 ...
 *   Generation Time: 2022-01-27 14:24:31
...
#define EcuM_GetEcuM_CRCHash_LowerOfPCConfig()                        0x0118BF20u
#define EcuM_GetEcuM_CRCHash_UpperOfPCConfig()                        0xA2C87C22u
...
#define EcuM_GetNormalMcuModeOfPCConfig()                             McuConf_McuModeSettingConf_McuModeSettingConf_normal  /**< EcuMNormalMcuModeRef id of the Mcu module */
...
#define EcuM_GetSizeOfSleepModeListOfPCConfig()                       2u  /**< the number of accomplishable value elements in EcuM_SleepModeList */
...
#define EcuM_GetMcuModeOfSleepModeList(Index)                         (EcuM_GetSleepModeListOfPCConfig()[(Index)].McuModeOfSleepModeList)
#define EcuM_IsPollingOfSleepModeList(Index)                          ((EcuM_GetSleepModeListOfPCConfig()[(Index)].PollingOfSleepModeList) != FALSE)
#define EcuM_GetWakeupSourceOfSleepModeList(Index)                    (EcuM_GetSleepModeListOfPCConfig()[(Index)].WakeupSourceOfSleepModeList)
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EcuM_SleepModeListType, ECUM_CONST) EcuM_SleepModeList[2];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
