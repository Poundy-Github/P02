 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dcm_Cfg.h
 *   Generation Time: 2022-01-22 14:22:11
...
# define DCM_DIDMGR_OPTYPE_RANGE_ISAVAIL_ENABLED                               STD_ON
...
# define DCM_STATE_SEC_RESET_ATT_CNTR_ON_TIMEOUT_ENABLED                       STD_ON
...
# define DcmConf_DcmDslProtocolRx_DcmDslProtocolRx_Fun                          0u
# define DcmConf_DcmDslProtocolRx_DcmDslProtocolRx_Fun_CANFD                    2u
# define DcmConf_DcmDslProtocolRx_DcmDslProtocolRx_Phy                          1u
# define DcmConf_DcmDslProtocolRx_DcmDslProtocolRx_Phy_CANFD                    3u
/*!  ----- Symbolic name values for Tx PduIds -----  */
# define DcmConf_DcmDslProtocolTx_DcmDslProtocolTx                              0u
# define DcmConf_DcmDslProtocolTx_DcmDslProtocolTx_CANFD                        1u
...
/*! Size of table Dcm_CfgModeMgrRules */
# define DCM_CFGMODEMGRRULES_SIZE                                               2u
...
# define DCM_CFGSTATEPRECONDITIONS_SIZE                                        17u
...
# define DCM_CFGDIDMGRDIDLOOKUPTABLE_SIZE                                       5u
/*! Size of table Dcm_CfgDidMgrDidRanges */
# define DCM_CFGDIDMGRDIDRANGES_SIZE                                            4u
/*! Size of table Dcm_CfgDidMgrRangeDidInfoRefs */
# define DCM_CFGDIDMGRRANGEDIDINFOREFS_SIZE                                     3u
/*! Size of table Dcm_CfgDidMgrDidInfo */
# define DCM_CFGDIDMGRDIDINFO_SIZE                                              4u
/*! Size of table Dcm_CfgDidMgrDidOpInfo */
# define DCM_CFGDIDMGRDIDOPINFO_SIZE                                            8u
/*! Size of table Dcm_CfgDidMgrDidOpClassInfo */
# define DCM_CFGDIDMGRDIDOPCLASSINFO_SIZE                                      16u
/*! Size of table Dcm_CfgDidMgrSignalOpClassInfo */
# define DCM_CFGDIDMGRSIGNALOPCLASSINFO_SIZE                                   15u
...
# define DCM_CFGRIDMGRRIDLOOKUPTABLE_SIZE                                      22u
/*! Size of table Dcm_CfgRidMgrRidInfo */
# define DCM_CFGRIDMGRRIDINFO_SIZE                                             21u
/*! Size of table Dcm_CfgRidMgrOpInfo */
# define DCM_CFGRIDMGROPINFO_SIZE                                              39u
/*! Specifies total number of supported memory operations */
# define DCM_MEMMGR_NUM_MEMORY_OPERATIONS                                       1u
...
# define DCM_CFGMEMMGRALFIDLOOKUPTABLE_SIZE                                     3u
...
# define DCM_DIAG_RCRRP_LIMIT_COUNT                                             6u
...
# define DCM_CFGDIAGOEMNOTIFICATIONINFO_SIZE                                    2u
