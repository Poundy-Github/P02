 ...
 ** Module: E2EPW_Common_Safety_SG_EPS1_FD1_SG_EPS1_FD1_rx.c
 ...
 **********************************************************/
FUNC (void, Common_Safety_CODE) E2EPW_ReadInit_SG_EPS1_FD1_SG_EPS1_FD1 (void)
{
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Safety_CODE) E2EPW_Read_SG_EPS1_FD1_SG_EPS1_FD1
    ( P2VAR (SG_EPS1_FD1, AUTOMATIC, Common_Safety_VAR_INIT) AppData)
{
