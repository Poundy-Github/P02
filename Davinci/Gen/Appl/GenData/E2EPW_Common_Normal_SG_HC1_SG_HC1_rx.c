 ...
 ** Module: E2EPW_Common_Normal_SG_HC1_SG_HC1_rx.c
...
#include "E2EPW_Common_Normal_SG_HC1_SG_HC1_rx.h"
#ifndef STATIC
 ...
 **********************************************************/
FUNC (void, Common_Normal_CODE) E2EPW_ReadInit_SG_HC1_SG_HC1 (void)
{
    State_SG_HC1_SG_HC1 = &StateVal_SG_HC1_SG_HC1;
    State_SG_HC1_SG_HC1->LastValidCounter = 0;
    State_SG_HC1_SG_HC1->MaxDeltaCounter  = 0;
    State_SG_HC1_SG_HC1->WaitForFirstData = TRUE;
    State_SG_HC1_SG_HC1->NewDataAvailable = FALSE;
    State_SG_HC1_SG_HC1->LostData         = 0;
    State_SG_HC1_SG_HC1->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_HC1_SG_HC1->SyncCounter      = 0;
    State_SG_HC1_SG_HC1->NoNewOrRepeatedDataCounter = 0;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Normal_CODE) E2EPW_Read_SG_HC1_SG_HC1
    ( P2VAR (SG_HC1, AUTOMATIC, Common_Normal_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Normal_CONST)
        Config_SG_HC1_SG_HC1 = &ConfigVal_SG_HC1_SG_HC1;

    State_SG_HC1_SG_HC1->NewDataAvailable =
        Rte_IsUpdated_SG_HC1_SG_HC1 ();

    if ((State_SG_HC1_SG_HC1->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_HC1_SG_HC1 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_HC1 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_HC1_SG_HC1->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_HC1_SG_HC1->CounterOffset >> 3u;
            E2EPW_Marshal_SG_HC1 ( AppData, ppa_SG_HC1_SG_HC1_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_HC1_SG_HC1_au8[crcoffset_u16]  = AppData->Checksum_HC1;
            ppa_SG_HC1_SG_HC1_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_HC1_SG_HC1_au8[cntoffset_u16] |= AppData->RollingCounter_HC1;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_HC1_SG_HC1
                     , State_SG_HC1_SG_HC1
                     , ppa_SG_HC1_SG_HC1_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_HC1_SG_HC1->Status<<24);
    }
