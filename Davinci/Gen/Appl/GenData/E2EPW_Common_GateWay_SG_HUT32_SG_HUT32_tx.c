 ...
 ** Module: E2EPW_Common_GateWay_SG_HUT32_SG_HUT32_tx.c
...
/**********************************************************
 * Function name: E2EPW_Init_SG_HUT32_SG_HUT32_tx ()
 ...
 **********************************************************/
FUNC (void, Common_GateWay_CODE) E2EPW_WriteInit_SG_HUT32_SG_HUT32 (void)
{
    State_SG_HUT32_SG_HUT32 = &StateVal_SG_HUT32_SG_HUT32;
    State_SG_HUT32_SG_HUT32->Counter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_SenderState_SG_HUT32_SG_HUT32 ()
...
FUNC_P2VAR ( E2E_P01ProtectStateType
    ...
    E2EPW_Get_ProtectState_SG_HUT32_SG_HUT32 (void)
{
    return State_SG_HUT32_SG_HUT32;
}

/**********************************************************
 * Function name: E2EPW_Write_SG_HUT32_SG_HUT32 (SG_HUT32 *  AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_GateWay_CODE) E2EPW_Write_SG_HUT32_SG_HUT32
    (P2VAR (SG_HUT32, AUTOMATIC, Common_GateWay_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_GateWay_CONST)
        Config_SG_HUT32_SG_HUT32 = &ConfigVal_SG_HUT32_SG_HUT32;
    ...
    {
        E2EPW_Marshal_SG_HUT32 ( AppData, ppa_SG_HUT32_SG_HUT32_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_SG_HUT32_SG_HUT32
                     , State_SG_HUT32_SG_HUT32
                     , ppa_SG_HUT32_SG_HUT32_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_SG_HUT32_SG_HUT32->CRCOffset/8;
        uint16 cntoffset_u16 = Config_SG_HUT32_SG_HUT32->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->CheckSum_HUT32 = ppa_SG_HUT32_SG_HUT32_au8[crcoffset_u16];
        AppData->RollingCounter_HUT32 = (ppa_SG_HUT32_SG_HUT32_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_SG_HUT32_SG_HUT32 ( AppData );
