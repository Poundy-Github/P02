 ...
 *          License:  CBD2000298
 *
 *      Description:  Application types header file for SW-C <TripComputer>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_TRIPCOMPUTER_TYPE_H
# define RTE_TRIPCOMPUTER_TYPE_H
