 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Rte_DidDataProcess_Type.h
 *           Config:  HUT_V3_5.dpa
 ...
 *          License:  CBD2000298
 *
 *      Description:  Application types header file for SW-C <DidDataProcess>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_DIDDATAPROCESS_TYPE_H
# define RTE_DIDDATAPROCESS_TYPE_H
...
# define RTE_MODE_DidDataProcess_DcmDiagnosticSessionControl_DEFAULT_SESSION (1U)
...
# endif
# define RTE_MODE_DidDataProcess_DcmDiagnosticSessionControl_EXTENDED_SESSION (3U)
...
# endif
# define RTE_MODE_DidDataProcess_DcmDiagnosticSessionControl_EOLDiagnosticSession (96U)
...
# endif
# define RTE_MODE_DidDataProcess_DcmDiagnosticSessionControl_UFSKeepProgrammingSession (111U)
...
# endif
# define RTE_TRANSITION_DidDataProcess_DcmDiagnosticSessionControl (255U)
...
#endif /* RTE_DIDDATAPROCESS_TYPE_H */
