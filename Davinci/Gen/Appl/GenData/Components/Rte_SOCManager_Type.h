 ...
 *          License:  CBD2000298
 *
 *      Description:  Application types header file for SW-C <SOCManager>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef RTE_SOCMANAGER_TYPE_H
# define RTE_SOCMANAGER_TYPE_H
