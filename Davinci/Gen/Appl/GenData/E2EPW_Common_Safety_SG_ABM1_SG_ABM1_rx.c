 ...
 ** Module: E2EPW_Common_Safety_SG_ABM1_SG_ABM1_rx.c
...
/**********************************************************
 * Function name: E2EPW_Init_SG_ABM1_SG_ABM1_rx ()
 ...
 **********************************************************/
FUNC (void, Common_Safety_CODE) E2EPW_ReadInit_SG_ABM1_SG_ABM1 (void)
{
    State_SG_ABM1_SG_ABM1 = &StateVal_SG_ABM1_SG_ABM1;
    State_SG_ABM1_SG_ABM1->LastValidCounter = 0;
    State_SG_ABM1_SG_ABM1->MaxDeltaCounter  = 0;
    State_SG_ABM1_SG_ABM1->WaitForFirstData = TRUE;
    State_SG_ABM1_SG_ABM1->NewDataAvailable = FALSE;
    State_SG_ABM1_SG_ABM1->LostData         = 0;
    State_SG_ABM1_SG_ABM1->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_ABM1_SG_ABM1->SyncCounter      = 0;
    State_SG_ABM1_SG_ABM1->NoNewOrRepeatedDataCounter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_ReceiverState_SG_ABM1_SG_ABM1 ()
...
FUNC_P2VAR ( E2E_P01CheckStateType
    ...
    E2EPW_Get_CheckState_SG_ABM1_SG_ABM1 (void)
{
    return State_SG_ABM1_SG_ABM1;
}

/**********************************************************
 * Function name: E2EPW_Read_SG_ABM1_SG_ABM1 (SG_ABM1 * AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Safety_CODE) E2EPW_Read_SG_ABM1_SG_ABM1
    ( P2VAR (SG_ABM1, AUTOMATIC, Common_Safety_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Safety_CONST)
        Config_SG_ABM1_SG_ABM1 = &ConfigVal_SG_ABM1_SG_ABM1;

    State_SG_ABM1_SG_ABM1->NewDataAvailable =
        Rte_IsUpdated_SG_ABM1_SG_ABM1 ();

    if ((State_SG_ABM1_SG_ABM1->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_ABM1_SG_ABM1 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_ABM1 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_ABM1_SG_ABM1->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_ABM1_SG_ABM1->CounterOffset >> 3u;
            E2EPW_Marshal_SG_ABM1 ( AppData, ppa_SG_ABM1_SG_ABM1_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_ABM1_SG_ABM1_au8[crcoffset_u16]  = AppData->CheckSum_ABM1;
            ppa_SG_ABM1_SG_ABM1_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_ABM1_SG_ABM1_au8[cntoffset_u16] |= AppData->RollingCounter_ABM1;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_ABM1_SG_ABM1
                     , State_SG_ABM1_SG_ABM1
                     , ppa_SG_ABM1_SG_ABM1_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_ABM1_SG_ABM1->Status<<24);
    }
