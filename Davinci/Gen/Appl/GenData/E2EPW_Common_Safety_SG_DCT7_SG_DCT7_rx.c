 ...
 ** Module: E2EPW_Common_Safety_SG_DCT7_SG_DCT7_rx.c
...
/**********************************************************
 * Function name: E2EPW_Init_SG_DCT7_SG_DCT7_rx ()
 ...
 **********************************************************/
FUNC (void, Common_Safety_CODE) E2EPW_ReadInit_SG_DCT7_SG_DCT7 (void)
{
    State_SG_DCT7_SG_DCT7 = &StateVal_SG_DCT7_SG_DCT7;
    State_SG_DCT7_SG_DCT7->LastValidCounter = 0;
    State_SG_DCT7_SG_DCT7->MaxDeltaCounter  = 0;
    State_SG_DCT7_SG_DCT7->WaitForFirstData = TRUE;
    State_SG_DCT7_SG_DCT7->NewDataAvailable = FALSE;
    State_SG_DCT7_SG_DCT7->LostData         = 0;
    State_SG_DCT7_SG_DCT7->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_DCT7_SG_DCT7->SyncCounter      = 0;
    State_SG_DCT7_SG_DCT7->NoNewOrRepeatedDataCounter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_ReceiverState_SG_DCT7_SG_DCT7 ()
...
FUNC_P2VAR ( E2E_P01CheckStateType
    ...
    E2EPW_Get_CheckState_SG_DCT7_SG_DCT7 (void)
{
    return State_SG_DCT7_SG_DCT7;
}

/**********************************************************
 * Function name: E2EPW_Read_SG_DCT7_SG_DCT7 (SG_DCT7 * AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Common_Safety_CODE) E2EPW_Read_SG_DCT7_SG_DCT7
    ( P2VAR (SG_DCT7, AUTOMATIC, Common_Safety_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Common_Safety_CONST)
        Config_SG_DCT7_SG_DCT7 = &ConfigVal_SG_DCT7_SG_DCT7;

    State_SG_DCT7_SG_DCT7->NewDataAvailable =
        Rte_IsUpdated_SG_DCT7_SG_DCT7 ();

    if ((State_SG_DCT7_SG_DCT7->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_DCT7_SG_DCT7 (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_DCT7 (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_DCT7_SG_DCT7->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_DCT7_SG_DCT7->CounterOffset >> 3u;
            E2EPW_Marshal_SG_DCT7 ( AppData, ppa_SG_DCT7_SG_DCT7_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_DCT7_SG_DCT7_au8[crcoffset_u16]  = AppData->CheckSum_DCT7;
            ppa_SG_DCT7_SG_DCT7_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_DCT7_SG_DCT7_au8[cntoffset_u16] |= AppData->RollingCounter_DCT7;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_DCT7_SG_DCT7
                     , State_SG_DCT7_SG_DCT7
                     , ppa_SG_DCT7_SG_DCT7_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_DCT7_SG_DCT7->Status<<24);
    }
