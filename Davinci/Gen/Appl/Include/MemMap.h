...
#ifdef WDG_59_DRIVERB_START_SEC_APPL_CODE
  #undef WDG_59_DRIVERB_START_SEC_APPL_CODE
  #define START_SEC_CODE
#endif

#ifdef WDG_59_DRIVERB_STOP_SEC_APPL_CODE
...
#ifdef WDG_59_DRIVERC_START_SEC_CODE_FAST
  #undef WDG_59_DRIVERC_START_SEC_CODE_FAST
  #define START_SEC_CODE_FAST
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_CODE_FAST
  #undef WDG_59_DRIVERC_STOP_SEC_CODE_FAST
  #define STOP_SEC_CODE
#endif

#ifdef WDG_59_DRIVERC_START_SEC_APPL_CODE
  #undef WDG_59_DRIVERC_START_SEC_APPL_CODE
  #define START_SEC_CODE
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_APPL_CODE
  #undef WDG_59_DRIVERC_STOP_SEC_APPL_CODE
  #define STOP_SEC_CODE
#endif

#ifdef WDG_59_DRIVERC_START_SEC_CONFIG_DATA_UNSPECIFIED
  #undef WDG_59_DRIVERC_START_SEC_CONFIG_DATA_UNSPECIFIED
  #define START_SEC_CONST_UNSPECIFIED
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_CONFIG_DATA_UNSPECIFIED
  #undef WDG_59_DRIVERC_STOP_SEC_CONFIG_DATA_UNSPECIFIED
  #define STOP_SEC_CONST
#endif

#ifdef WDG_59_DRIVERC_START_SEC_PRIVATE_CODE
  #undef WDG_59_DRIVERC_START_SEC_PRIVATE_CODE
  #define START_SEC_CODE
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_PRIVATE_CODE
  #undef WDG_59_DRIVERC_STOP_SEC_PRIVATE_CODE
  #define STOP_SEC_CODE
#endif

#ifdef WDG_59_DRIVERC_START_SEC_PUBLIC_CODE
  #undef WDG_59_DRIVERC_START_SEC_PUBLIC_CODE
  #define START_SEC_CODE
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_PUBLIC_CODE
  #undef WDG_59_DRIVERC_STOP_SEC_PUBLIC_CODE
  #define STOP_SEC_CODE
#endif

#ifdef WDG_59_DRIVERC_START_SEC_VAR_INIT_8
  #undef WDG_59_DRIVERC_START_SEC_VAR_INIT_8
  #define START_SEC_VAR_INIT_8BIT
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_VAR_INIT_8
  #undef WDG_59_DRIVERC_STOP_SEC_VAR_INIT_8
  #define STOP_SEC_VAR
#endif

#ifdef WDG_59_DRIVERC_START_SEC_VAR_NO_INIT_16
  #undef WDG_59_DRIVERC_START_SEC_VAR_NO_INIT_16
  #define START_SEC_VAR_NOINIT_16BIT
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_VAR_NO_INIT_16
...
#ifdef WDG_59_DRIVERC_START_SEC_VAR_NO_INIT_UNSPECIFIED
  #undef WDG_59_DRIVERC_START_SEC_VAR_NO_INIT_UNSPECIFIED
  #define START_SEC_VAR_NOINIT_UNSPECIFIED
#endif

#ifdef WDG_59_DRIVERC_STOP_SEC_VAR_NO_INIT_UNSPECIFIED
