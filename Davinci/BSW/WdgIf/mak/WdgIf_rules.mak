...
#------------------------------------------------------------------------------
# 1.00.00   2016-02-18  Chl     Initial Version of migrated WdgIf_rules.mak
...
#e.g.: WdgIf_FILES = WdgIf$(BSW_SRC_DIR)\WdgIf.c
LIBRARIES_TO_BUILD      += WdgIf
WdgIf_FILES = WdgIf$(BSW_SRC_DIR)\WdgIf.c
# e.g.: CC_FILES_TO_BUILD       += WdgIf\WdgIf.c WdgIf\WdgIf_Irq.c
CC_FILES_TO_BUILD       += WdgIf$(BSW_SRC_DIR)\WdgIf.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
