...
#------------------------------------------------------------------------------
# 1.00.00   2017-09-28  ygr     Initial Version
# 1.01.00   2019-02-06  vircbl  Added support of component-based SIP structure
#           2019-02-18  visygr  ESCAN00099172 Linker Errors: Unresolved external symbol 
#------------------------------------------------------------------------------
...
vDem42_FILES             = vDem42$(BSW_SRC_DIR)\vDem42.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += vDem42$(BSW_SRC_DIR)\vDem42.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
