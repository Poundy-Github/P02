...
*********************************************************************************************************************/
#define CryIf_Util_MemClr(dst, count)                                 CryIf_Util_MemSet(dst, 0u, count) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/**********************************************************************************************************************
 ...
 *  \param[in,out]  job    Pointer to the corresponding job object
 ...
 *  \synchronous    TRUE
 *********************************************************************************************************************/
CRYIF_LOCAL FUNC(Std_ReturnType, CRYIF_CODE) CryIf_UpdateRedirectionInfo(P2VAR(Crypto_JobType, AUTOMATIC, CRYIF_APPL_VAR) job);
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
CRYIF_LOCAL FUNC(void, CRYIF_CODE) CryIf_Util_MemSet(P2VAR(uint8, AUTOMATIC, AUTOMATIC) dst, uint8 pattern, uint32 count);
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
CRYIF_LOCAL FUNC(void, CRYIF_CODE) CryIf_Util_MemCpy(P2VAR(uint8, AUTOMATIC, AUTOMATIC) dst, P2CONST(uint8, AUTOMATIC, AUTOMATIC) src, uint32 count);
 ...
 *********************************************************************************************************************/
CRYIF_LOCAL FUNC(Std_ReturnType, CRYIF_CODE) CryIf_KeyElementCopyPartial_Internal(CryIf_CryptoFunctionsIdxOfKeyType cryptoFctIdxSrc,
 ...
 *
 */
CRYIF_LOCAL FUNC(Std_ReturnType, CRYIF_CODE) CryIf_KeyElementCopyPartial_Internal(
 ...
 *
 */
FUNC(Std_ReturnType, CRYIF_CODE) CryIf_KeyElementCopyPartial_Stub(uint32 cryptoKeyId,
                                                                  uint32 keyElementId,
                                                                  uint32 keyElementSourceOffset,
                                                                  uint32 keyElementTargetOffset,
                                                                  uint32 keyElementCopyLength,
                                                                  uint32 targetCryptoIfKeyId,
                                                                  uint32 targetKeyElementId)
{
  CRYIF_DUMMY_STATEMENT(cryptoKeyId); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  ...
  CRYIF_DUMMY_STATEMENT(targetCryptoIfKeyId); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
