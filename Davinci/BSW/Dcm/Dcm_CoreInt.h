...
# define DCM_COREINT_MAJOR_VERSION                                   13u
...
/*! Registers the most significant bit in the event mask of the Dcm_DiagTaskWorker() (used by the DCM core to determine the width of the task event registers)
    Note: Since used in a preprocessor calculation, do not use casted values (i.e. the event with the highest value above) */
# define DCM_TSK_EV_DIAG_WORK_MSB                                    0x0100u
 ...
 *  \pre            -
 *********************************************************************************************************************/
DCM_GLOBAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagProvideDataAsF32(Dcm_DiagDataContextPtrType pDataContext
                                                               ,float32                    value
 ...
 *  \pre            -
 *********************************************************************************************************************/
FUNC(void, DCM_CODE) Dcm_UtiConvertToUint16Array(Dcm_ConstReadOnlyMsgType            sourcePtr
 ...
 *  \pre            -
 *********************************************************************************************************************/
FUNC(void, DCM_CODE) Dcm_UtiConvertToUint32Array(Dcm_ConstReadOnlyMsgType            sourcePtr
 ...
 *  \pre            -
 *********************************************************************************************************************/
FUNC(void, DCM_CODE) Dcm_UtiConvertToFloat32Array(Dcm_ConstReadOnlyMsgType             sourcePtr
 ...
 *
 *********************************************************************************************************************/
DCM_GLOBAL_INLINE FUNC(void, DCM_CODE) Dcm_DiagProvideDataAsF32(Dcm_DiagDataContextPtrType pDataContext                                              /* PRQA S 3219 */ /* MD_MSR_Unreachable */
                                                               ,float32                    value
                                                               ,Dcm_EndiannessType         endianness)
{
