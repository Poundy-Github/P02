...
# define DCM_CORECBK_MAJOR_VERSION                                   13u
 ...
 *  \pre            -
*********************************************************************************************************************/
FUNC(Std_ReturnType, DCM_CODE) Dcm_KeyMAsyncCertificateVerifyFinished(KeyM_CertificateIdType CertId
 ...
 *  \pre            -
*********************************************************************************************************************/
FUNC(void, DCM_CODE) Dcm_CsmAsyncJobFinished(P2CONST(Crypto_JobType, AUTOMATIC, DCM_APPL_DATA) job
