...
/*****************************************************************************
|
| Project Name:   DrvCan_Rh850RscanfdAsr
|
| Target systems: RH850 derivatives with RSCANFD
|
| Compiler:       GreenHills
|                 WindRiver Diab
|                 Renesas
...
| --------     ---------------------     -------------------------------------
| Dzi          Diane Aimee Zouatoum      Vector Informatik GmbH
|-----------------------------------------------------------------------------
|               R E V I S I O N   H I S T O R Y
|-----------------------------------------------------------------------------
| Date        Version   Author  Description
| ----------  --------  ------  ----------------------------------------------
| 2019-04-16   1.00.00   Dzi    - STORYC-8178:   Initial driver for Rscanfd V3 and V4
| 2019-09-27   1.01.00   Dzi    - STORYC-8852:   Final Release
|****************************************************************************/
...
# define DRVCAN_RH850RSCANFDASR_VERSION              0x0101u
# define DRVCAN_RH850RSCANFDASR_RELEASE_VERSION      0x00u
...
#define CAN_SW_MAJOR_VERSION   ((DRVCAN_RH850RSCANFDASR_VERSION & 0xFF00u) >> 8)
#define CAN_SW_MINOR_VERSION   (DRVCAN_RH850RSCANFDASR_VERSION & 0x00FFu)
#define CAN_SW_PATCH_VERSION   (DRVCAN_RH850RSCANFDASR_RELEASE_VERSION & 0xFFu)
...
#  if defined(C_COMP_RENESAS_RH850_RSCAN)        || \
      defined(C_COMP_GHS_RH850_RSCAN)            /* COV_CAN_LL_CONSTANT_DEFINITION_COMPILER */ 
#   define CanLL_DI()
#   define CanLL_EI()
#  else
...
#   define C_ISR_KEYWORD     __interrupt
#  endif
#  if defined(C_COMP_DIABDATA_RH850_RSCAN)       /* COV_CAN_LL_CONSTANT_DEFINITION_COMPILER */
#   define C_ISR_KEYWORD     __interrupt__
#  endif
