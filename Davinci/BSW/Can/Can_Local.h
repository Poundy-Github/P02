...
# define MK_EXTID0(id)                           (((tCanIdType)(id) & kCanExtIdMask) | kCanIdTypeExt)
...
# define CanActualDLCToReg(dlc)                  ((vuint32) (((vuint32) (dlc)) << 28))
...
# define kCanNumberOfTxIntStsRegCell     2u
...
#  define kCanNumberOfTxQueueCell        1u
# endif
# if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
#  define kCanNumberOfSharedReg8Cell     4u
#  define kCanMaxTxBufCell               64u /* per channel */
#  define kCanNumberOfSharedRegTxCell    16u
#  define kCanNumberOfTxQueueCell        4u
# endif
...
{
  volatile vuint32      BCFG;                                  /*!< CmNCFG/CnNCFG */
  volatile vuint32      CR;                                    /*!< CmCTR/CnCTR */
...
{
  volatile vuint32      BCFG;                                  /*!< CmDCFG/CnDCFG */
  volatile vuint32      FDCFG;                                 /*!< CmFDCFG/CnFDCFG */
  volatile vuint32      CR;                                    /*!< CmFDCTR */
  volatile vuint32      SR;                                    /*!< CmFDSTS */
  volatile vuint32      CRC;                                   /*!< CmFDCRC */
#if defined(C_ENABLE_IF_RSCAN_FD_V3) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V3 */
  volatile vuint32      Unused17[3];
#endif
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused20[1];
  volatile vuint32      BLCT;                                  /*!< CnBLCT */
  volatile vuint32      BLSTS;                                 /*!< CnBLSTS */
#endif
} tCanChCtrlFd;
...
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
typedef volatile struct        /* fifo control Enhancement */
{
  volatile vuint32      CFCCE[kCanMaxTxFifosCell];             /*!< CFCCEd */
} tCanChFCE;
#endif

typedef volatile struct        /* fifo status */
{
  volatile vuint32      TRFSR[kCanMaxTxFifosCell];             /*!< CFSTSk */
} tCanChFS;

typedef volatile struct        /* fifo pointer control */
{
  volatile vuint32      TRFPCR[kCanMaxTxFifosCell];            /*!< CFPCTRk */
} tCanChFPC;
...
typedef volatile struct    /* Tx Queue */
{
 volatile vuint32       TQCR[kCanMaxPhysChannelsCell];         /*!< TXQCC */
 volatile vuint32       TQSR[kCanMaxPhysChannelsCell];         /*!< TXQSTS */
 volatile vuint32       TQPCR[kCanMaxPhysChannelsCell];        /*!< TXQPCTR */
} tCanChTXQ;
...
{
  volatile vuint32      THAR0;                                 /*!< THLACC0m */
  volatile vuint32      THAR1;                                 /*!< THLACC1m */
} tCanTHA;
...
typedef volatile struct
{
  ...
  volatile vuint32      Unused01[1];
  volatile vuint32      CGCFG;                                 /*!< GCFG */
  volatile vuint32      CGCR;                                  /*!< GCTR */
  volatile vuint32      CGSR;                                  /*!< GSTS */
  volatile vuint16      CGEF;                                  /*!< GERFLL */
  volatile vuint16      CGEFECC;                               /*!< GERFLH */
  volatile vuint32      CTS;                                   /*!< GTSC */
  /* receive rules */
  volatile vuint32      CRECR;                                 /*!< GAFLECTR */
  volatile vuint32      CRNCFG[kCanNumberOfSharedReg8Cell];    /*!<for v3 GAFLCFG[0/1] , for v4 GAFLCFG[0/1/2/3] */
  /* rx buffers */
  volatile vuint32      CRBNUM;                                /*!< RMNB */
  volatile vuint32      CRBRCF[kCanNumberOfSharedReg16Cell];   /*!< RMND[0/1/2/3] */
  /* fifos */
  volatile vuint32      CRFCR[kCanMaxRxFifosCell];             /*!< RFCCx */
  volatile vuint32      CRFSR[kCanMaxRxFifosCell];             /*!< RFSTSx */
  volatile vuint32      CRFPCR[kCanMaxRxFifosCell];            /*!< RFPCTRx */
  tCanChFC              ChFC[kCanMaxPhysChannelsCell];         /*!< CFCCk */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  tCanChFCE             ChFCE[kCanMaxPhysChannelsCell];        /*!< CFCCEd */
#endif
  tCanChFS              ChFS[kCanMaxPhysChannelsCell];         /*!< CFSTSk */
  tCanChFPC             ChFPC[kCanMaxPhysChannelsCell];        /*!< CFPCTRk */
  volatile vuint32      CFESR;                                 /*!< FESTS */
  volatile vuint32      CFFSR;                                 /*!< FFSTS */
  volatile vuint32      CFMLSR;                                /*!< FMSTS */
  volatile vuint32      CRFISR;                                /*!< RFISTS */
  volatile vuint32      CTRFRISR;                              /*!< CFRISTS */
  volatile vuint32      CTRFTISR;                              /*!< CFTISTS */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  /* fifo one frame status */
  volatile vuint32      CFOFRISTS;                             /*!< CFOFRISTS */
  volatile vuint32      CFOFTISTS;                             /*!< CFOFTISTS */
  volatile vuint32      CFOMOWSTS;                             /*!< CFOMOWSTS */
  volatile vuint32      CFDFFFSTS;                             /*!< CFDFFFSTS */
  volatile vuint32      Unused02[2];
#endif
  /* tx buffers */
  tCanChBC              ChBC[kCanMaxPhysChannelsCell];         /*!< TMCp */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused03[192];
#endif
  tCanChBS              ChBS[kCanMaxPhysChannelsCell];         /*!< TMSTSp */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused04[192];
#endif
  volatile vuint32      CTBTRSR[kCanNumberOfSharedRegTxCell];  /*!< TMTRSTS */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused05[24];
#endif
  volatile vuint32      CTBARSR[kCanNumberOfSharedRegTxCell];  /*!< TMTARSTS */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused06[24];
#endif
  volatile vuint32      CTBTCSR[kCanNumberOfSharedRegTxCell];  /*!< TMTCSTS */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused07[24];
#endif
  volatile vuint32      CTBASR[kCanNumberOfSharedRegTxCell];   /*!< TMTASTS */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused08[24];
#endif
  volatile vuint32      CTBIER[kCanNumberOfSharedRegTxCell];   /*!< TMIEC */
#if defined(C_ENABLE_IF_RSCAN_FD_V3) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V3 */
  volatile vuint32      Unused09[24];
#endif
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused09[28];
#endif
  /* tx queue */
  tCanChTXQ             ChTXQ[kCanNumberOfTxQueueCell];           /*!< TXQCCm ,TXQSTSm , TXQPCTRm */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */                          
  volatile vuint32      TXQESTS;                              /*!< TXQESTS */
  volatile vuint32      TXQFISTS;                             /*!< TXQFISTS */
  volatile vuint32      TXQMSTS;                              /*!< TXQMSTS */
  volatile vuint32      TXQOWSTS;                             /*!< TXQOWSTS */
  volatile vuint32      TXQISTS;                              /*!< TXQISTS */
  volatile vuint32      TXQOFTISTS;                           /*!< TXQOFTISTS */
  volatile vuint32      TXQOFRISTS;                           /*!< TXQOFRISTS */
  volatile vuint32      TXQFSTS;                              /*!< TXQFSTS */
  volatile vuint32      Unused10[24];     
#endif
  /* tx history */
  volatile vuint32      THCR[kCanMaxPhysChannelsCell];        /*!< THLCCm */
  volatile vuint32      THSR[kCanMaxPhysChannelsCell];        /*!< THLSTSm */
  volatile vuint32      THPCR[kCanMaxPhysChannelsCell];       /*!< THLPCTRm */
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused11[40];      
#endif
  /* tx interrupt status, global test */
  volatile vuint32      CGTINTSTS[kCanNumberOfTxIntStsRegCell]; /*!< GTINTSTS[0/1] */
  volatile vuint32      CGTCFG;                               /*!< GTSTCFG */
  volatile vuint32      CGTCR;                                /*!< GTSTCTR */
  volatile vuint32      Unused12;
  /* global CAN-FD config */
  volatile vuint32      CGFDCFG;                              /*!< GFDCFG */
  volatile vuint32      Unused13;
  volatile vuint32      CGTPUR;                               /*!< GLOCKK */
  volatile vuint32      Unused14[4];  
  volatile vuint32      CFDCDTCT;                             /*!< CFDCDTCT */
  volatile vuint32      CFDCDTSTS;                            /*!< CFDCDTSTS */
#if defined(C_ENABLE_IF_RSCAN_FD_V3) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V3 */
  volatile vuint32      Unused15[46];
#endif
#if defined(C_ENABLE_IF_RSCAN_FD_V4) /* COV_CAN_LL_CONSTANT_DEFINITION_DERIVATIVE_IF_RSCAN_FD_V4 */
  volatile vuint32      Unused15[2];                           
  volatile vuint32      CCDTTCT;                             /*!< CFDCDTTCT */
  volatile vuint32      CDTTSTS;                             /*!< CFDCDTTSTS */
  volatile vuint32      Unused16[2];                          
  volatile vuint32      GRINTSTS[kCanMaxPhysChannelsCell];   /*!< CFDGRINTSTS */
  volatile vuint32      Unused17[4];                           
  volatile vuint32      GRSTC;                               /*!< CFDGRSTC */
  volatile vuint32      GFCMC;                               /*!< CFDGFCMC */
  volatile vuint32      Unused18;  
  volatile vuint32      GFTBAC;                              /*!< CFDGFTBAC */
  volatile vuint32      Unused19[28];                          
#endif
  ...
  /* ram test */
  volatile vuint32      CRAMTR[kCanMaxRamTestAccessCell];    /*!< RPGACCr */
  volatile vuint32      Unused26[7872];
  tCanBufTm             BufTmCh[kCanMaxPhysChannelsCell];    /*!< TMID, TMPTR, TMFDCTR, TMDF[] */
#endif
} tCanCell;

V_DEF_P2SFR_CAN_TYPE(V_NONE, tCanCell) tCanCellPtr;
# define Can ((tCanCellPtr)kCanBaseAdr)
