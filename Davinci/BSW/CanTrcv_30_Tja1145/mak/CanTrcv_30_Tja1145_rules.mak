############################################################################### 
# File Name  : CanTrcv_30_Tja1145_rules.mak 
...
# 1.07.00   2011-07-01  Tvi     Add CanTrcv_30_Tja1145_Pbcfg.c
# 1.08.00   2013-04-16  Tvi     Filter CanTrcv_30_Tj1145_Pbcfg.c for CFG5
# 1.09.00   2019-02-06  vircbl  Added support of component-based SIP structure
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += CanTrcv_30_Tja1145
CanTrcv_30_Tja1145_FILES = CanTrcv_30_Tja1145$(BSW_SRC_DIR)\CanTrcv_30_Tja1145.c

# e.g.: CC_FILES_TO_BUILD += drv\CanTrcv_30_Tja1145dio.c
CC_FILES_TO_BUILD       += CanTrcv_30_Tja1145$(BSW_SRC_DIR)\CanTrcv_30_Tja1145.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CanTrcv_30_Tja1145_Cfg.c
