...
_INLINE_ u32_T GetPEID( void);
_INLINE_ u32_T SET_RBCR0_MD( void);
_INLINE_ u32_T CLR_RBCR0_MD( void);
_INLINE_ u32_T SET_RBCR0_BE( RBCR0_T v);
_INLINE_ u32_T CLR_RBCR0_BE( RBCR0_T v);
_INLINE_ u32_T SET_RBCR1_NC( RBCR1_T v);
_INLINE_ u32_T CLR_RBCR1_NC( RBCR1_T v);
_INLINE_ u32_T SET_RBNR_NEXT( u32_T v);
_INLINE_ u32_T SET_RBIP( u32_T v);
...
_INLINE_ u32_T SET_RBCR0_MD( void)
{
    RBCR0_T p;
    __DI();
    p.rbcr0= __STSR( RBCR0);
    p.MD = 1;
    __LDSR( RBCR0, p.rbcr0);
    __SYNCI();
    __RESBANK();
    return (u32_T )p.MD;
}
...
_INLINE_ u32_T SET_RBCR1_NC( RBCR1_T v)
{
    RBCR1_T p;
    __DI();
    p.rbcr1= __STSR( RBCR1);
    p.NC |= v.NC;
    __LDSR( RBCR1, p.rbcr1);
    __SYNCI();
    __RESBANK();
    return p.rbcr1;
}
