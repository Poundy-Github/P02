...
#  define Crypto_30_vHsm_Ipc_GetTxChannelMemoryOffset(txChannelId)    CRYPTO_30_VHSM_IPC_PROTOCOL_INFO_SIZE + \
                                                                      ((txChannelId) * (CRYPTO_30_VHSM_IPC_TX_CHANNEL_MEMORY_SIZE)) /* PRQA S 3453 */ /* MD_CRYPTO_30_VHSM_3453_IPC_MACRO */
# elif (Crypto_30_vHsm_GetIpcProtocolVersionOfvHsm() == 2)
...
# if (Crypto_30_vHsm_GetIpcProtocolVersionOfvHsm() == 1)
#  define Crypto_30_vHsm_Ipc_GetGlobalInfoOffset()                    (Crypto_30_vHsm_Ipc_GetRxChannelMemoryOffset(Crypto_30_vHsm_GetIpcChannelsOfvHsm()))
# elif (Crypto_30_vHsm_GetIpcProtocolVersionOfvHsm() == 2)
