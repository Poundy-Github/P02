...
# define CRYPTO_30_VHSM_JOBRESPONSE_HEADER_SIZE                       (8U)
# define CRYPTO_30_VHSM_JOBREQUEST_BUFFER_LENGTH_SIZE                 (4U)
# define CRYPTO_30_VHSM_JOBRESPONSE_BUFFER_LENGTH_SIZE                (4U)
