...
#if (CANIF_CBK_MINOR_VERSION != 0x06u)
...
#if (CANIF_TYPES_MINOR_VERSION != 0x19u)
...
#if (CANIF_API_MINOR_VERSION != 0x23u)
...
#    error "Invalid generated data: CANIF_CFG_MAXRXDLC_PLUS_MAXMETADATALEN is to small"
#   endif
#  endif
# endif
#endif
 ...
 *               (CANIF_EXTENDEDID_SUPPORT == STD_ON) && (CANIF_DEV_ERROR_DETECT == STD_ON)
 **********************************************************************************************************************/
...
Relation_Context:
DevErrorDetect, J1939, IDType # from this local function #
DevErrorDetect, J1939, IDType # from caller CanIf_Init #
Relation:
...
#  if (CANIF_EXTENDEDID_SUPPORT == STD_ON)
  ...
  else if(CanIf_InitSubCheckJ1939AddrTables() == E_NOT_OK) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
  {
    errorId = CANIF_E_FATAL;
  }
#  endif
...
#  if (CANIF_EXTENDEDID_SUPPORT == STD_ON)
              ...
              if ((CanId & CANIF_J1939_PGN_MASK) == CANIF_J1939_ACKM_PGN) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
...
MD_CanIf_Rule8.3:
  Reason: For parameter DataPtr the typedef Can_<INFIX>_PduInfoPtrType with a possible infix is not used to be compatible with inxfixed and not infixed CAN drivers.
...
MD_CanIf_J1939ConstData:
  Reason: Configuration related J1939 address tables constant data.
  Risk: Statements in the 'if' block are not executed.
  Prevention: Code inspection and test of the different configurations in the component test.
