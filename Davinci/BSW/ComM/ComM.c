...
#  if ( (COMM_EXISTS_PASSIVE_NMTYPEOFCHANNEL == STD_ON) || (COMM_EXISTS_LINSLAVE_NMTYPEOFCHANNEL == STD_ON) )
  boolean isPassiveOrLinSlaveOfChannel = (boolean) ComM_IsPassiveOrLinSlaveOfChannel(Channel); /* PRQA S 2842, 4304 */ /* MD_ComM_2842 */ /* MD_MSR_AutosarBoolean */
#  endif
# endif
...
\ID COV_COMM_NM_LINSLAVE_OR_PASSIVE_ONLY
  \REASON In some configurations it is possible to have only channels with Nm variant LINSLAVE or NONE. In this case, this runtime check will always return true.
