...
# endif /* ECO_IGNORE_LINE */
    {
        ...
        NvM_RequestResultType blockEndNotificationResult;

        /* since a NvM_KillWriteAll might be called from a task which preempted NvM_MainFunction,
           this is a critical section. */
        NvM_EnterCriticalSection();

        if((NvM_ApiFlags_u8 & NVM_APIFLAG_WRITE_ALL_SET) != 0u)
        {
                ...
                && (NvM_CheckBlockId(NvM_CurrentJob_t.JobBlockId_t))) /* COV_NVM_KILLWRITEALL */
            {
                ...
                blockEndNotificationResult =
                    ((mngmt_pt->NvRamAttributes_u8 & NVM_STATE_VALID_SET) != 0u) ? NVM_REQ_OK : NVM_REQ_BLOCK_SKIPPED;

                mngmt_pt->NvRamErrorStatus_u8 = blockEndNotificationResult; /* SBSW_NvM_Access_CurrBlockInfo */
            }
        ...
        {
            NvM_BlockNotification(blockEndNotificationId, NVM_WRITE_ALL, blockEndNotificationResult);
        }
