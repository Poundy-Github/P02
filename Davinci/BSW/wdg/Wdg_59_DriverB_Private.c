   ...
   (boolean LblCriticalSectionFlag)
{
  ...
  (&WDG_59_DriverB_GpWDTAReg_BaseAddr->ucWDTE),
  (WDG_59_DRIVERB_RESTART),
  (&Wdg_59_DriverB_GaaRamMirror[WDG_59_DRIVERB_WDTAReg_WDTE_IDX]))

  WDG_59_DRIVERB_CHECK_WRITE_VERIFY_INIT(
  (&WDG_59_DriverB_GpWDTAReg_BaseAddr->ucWDTE),
  (WDG_59_DRIVERB_RESTART), WDG_59_DRIVERB_MASK_FIRST_8_BITS,
                                              WDG_59_DRIVERB_TRIGGERFUNC_API_ID)
   ...
   * written */
   ...
   WDG_59_DRIVERB_WRITE_REG_AND_MIRROR(
   (&WDG_59_DriverB_GpWDTAReg_BaseAddr->ucEVAC),
   (LucEVAC),
   (&Wdg_59_DriverB_GaaRamMirror[WDG_59_DRIVERB_WDTAReg_EVAC_IDX]))

   WDG_59_DRIVERB_CHECK_WRITE_VERIFY_INIT(
   (&WDG_59_DriverB_GpWDTAReg_BaseAddr->ucEVAC),
   (LucEVAC), WDG_59_DRIVERB_MASK_FIRST_8_BITS,
                                              WDG_59_DRIVERB_TRIGGERFUNC_API_ID)
