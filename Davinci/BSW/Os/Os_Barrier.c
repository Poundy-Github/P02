...
)
{
  if(Os_CoreIsSingleAsrCoreOs() == 0u)                                                                                  /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
  {
    ...
    do
    {
      ...
      for (attendeeIdx = 0; attendeeIdx < (Os_BarrierAttendeeIdx_IteratorType) Barrier->AttendeeCount; ++attendeeIdx)
      {
        synchronized = (Os_BarrierIsSynchronized(Barrier, (Os_BarrierAttendeeIdxType)attendeeIdx)) && synchronized;     /* PRQA S 4404, 4558 */ /* MD_Os_C90BooleanCompatibility, MD_Os_Rule10.1_4558 */ /* SBSW_OS_FC_PRECONDITION */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
      }
