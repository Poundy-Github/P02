...
# define OS_HAL_SELB_INTCX(addr)     (*((P2VAR(volatile uint16, AUTOMATIC, OS_VAR_NOINIT))(addr)))                      /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/*! Macro to initialize SELB_INTC1 register. */
# if (OS_HAL_SELB_INTC1_AVAILABLE == STD_ON)
#  define OS_HAL_SELB_INTC1_INIT(value)    OS_HAL_SELB_INTCX(OS_HAL_SELB_INTC1_BASE) = value;                           /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# else
#  define OS_HAL_SELB_INTC1_INIT(value)
# endif

/*! Macro to initialize SELB_INTC2 register. */
# if (OS_HAL_SELB_INTC2_AVAILABLE == STD_ON)
#  define OS_HAL_SELB_INTC2_INIT(value)    OS_HAL_SELB_INTCX(OS_HAL_SELB_INTC2_BASE) = value;                           /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
# else
