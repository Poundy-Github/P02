 ...
 *  Alexander Lerach              virleh        Vector Informatik GmbH
 ...
 *  02.28.00  2019-05-02  virrlu  STORYC-8297   Added support for derivative P1LC.
 *                        virrlu  ESCAN00102563 OS API functions Os_Get...StackUsage() returns wrong value.
 *            2019-05-03  virrlu  ESCAN00102946 Assembler error: Assembler reports "unmatched text in asm procedure".
 *                        virrlu  STORYC-8191   Add support for derivative C1M-A2.
 *  02.29.00  2019-05-10  visdqk  STORYC-7025   Updates for hierarchical interrupt controllers
 *  02.30.00  2019-06-18  visdqk  FIX-6174      Updates for generic stack gaps.
 *            2019-06-27  virrlu  STORYC-8739   Support WindRiver Diab compiler.
 *  02.31.00  2019-07-17  virrlu  OSC-22        ISR epilogue handled without trap instruction.
 *  02.32.00  2019-09-06  virrlu  OSC-5150      Add support for interrupt select registers SELB_INTCx.
 *            2019-09-17  virsmn  OSC-3472      Derivative specific FRT configuration.
 *  02.33.00  2019-10-08  virrlu  OSC-5244      Add support for Iar compiler.
 *  02.34.00  2019-11-21  virrlu  HALBE-99      Rework compiler warning handling.
 *  02.35.00  2019-12-20  visdqk  OSC-5248      Update version due to generator changes.
 *  02.36.00  2020-01-28  virrlu  HALBE-720     Support vHSM usecase.
 *  02.37.00  2020-02-17  virleh  -             Internal improvements.
 *  02.38.00  2020-03-16  virsmn  OSC-5361      Increase number of configurable OS Applications.
 *  02.39.00  2020-04-14  visror  -             Update due to BSWMD update.
 *            2020-04-22  virrlu  HALBE-1372    Support exception context manipulation.
 *  02.40.00  2020-05-19  visdri  HALBE-1794    Provide new exception context APIs.
 **********************************************************************************************************************/
...
# define OS_HAL_SW_MINOR_VERSION   (40u)
