...
#elif (OS_HAL_CORE_G4X == STD_ON)                                                                                       /* COV_OS_HALPLATFORMCOREAVAILABILITY */
...
{
  /* #10 Return (StackBottom - StackTop)*sizeof(Os_Hal_StackType). */
  return ((uint32)(StackBottom - StackTop) * sizeof(Os_Hal_StackType));                                                 /* PRQA S 0488 */ /* MD_Os_Hal_Rule18.4_0488 */
}
