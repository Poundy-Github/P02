 ...
 *  Petrik Christian              viscpe        Vector Informatik GmbH
...
/*!
  ...
  \{
*/
# define SECOC_SW_MAJOR_VERSION                    10u
...
/*! Service ID: SecOC_AssociateKey() */
# define SECOC_SID_ASSOCIATE_KEY                   7u
/*! Service ID: SecOC_FreshnessValueRead() */
# define SECOC_SID_FRESHNESS_VALUE_READ            8u
/*! Service ID: SecOC_FreshnessValueWrite() */
...
# define SECOC_SID_CANCEL_TRANSMIT                 74u
/*! Service ID: SecOC_ChangeParameter() */
# define SECOC_SID_CHANGE_PARAMETER                75u
/*! Service ID: SecOC_CancelReceive() */
# define SECOC_SID_CANCEL_RECEIVE                  76u
...
# define SECOC_SID_SEND_DEFAULT_AUTHENTICATION_INFORMATION            81u
