 ...
 **********************************************************************************************************************/
#if (SECOC_DEV_ERROR_REPORT == STD_ON)
# define SecOC_ReportDetError(API_ID, ERROR_CODE) ((void) SecOC_Det_ReportError((API_ID), (ERROR_CODE)))
# define SecOC_ReportRuntimeDetError(API_ID, ERROR_CODE) ((void) SecOC_Det_ReportRuntimeError((API_ID), (ERROR_CODE)))
/*
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(Std_ReturnType, SECOC_CODE) SecOC_FreshnessValue_GetVerifyValueFromCallout(SecOC_RxPduInfoIterType rxPduId, P2VAR(uint8, AUTOMATIC, SECOC_APPL_DATA) freshnessValue, uint8 freshnessValueBufferLength);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(PduLengthType, SECOC_CODE) SecOC_GetLengthFromHeader(P2CONST(uint8, AUTOMATIC, SECOC_APPL_DATA) headerData, uint8 headerLength);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_SerializeLengthToHeader(P2VAR(uint8, AUTOMATIC, SECOC_APPL_DATA) dest, uint8 headerLength, PduLengthType authenticPduLength);
#endif
...
/*! \brief      Verifies the MAC of a Secured I-Pdu using the custom callout.
    ...
    \return     verification result.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_VerifyResultType, SECOC_CODE) SecOC_Verify_MACUsingCustomCallout(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_Verify_ProcessVerificationResult(SecOC_VerifyResultType verificationResult, SecOC_RxPduInfoIterType rxPduId, SecOC_VerifyOverrideStatusType verifyOverrideStatus);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_Verify_ProcessSuccessfulVerificationResult(SecOC_RxPduInfoIterType rxPduId, SecOC_VerificationResultType verificationResultType);
#endif
...
/*! \brief      Processes the unsuccessful verification result.
    ...
    \param[in]  rxPduId  rx PduId
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_Verify_ProcessUnsuccessfulVerificationResult(SecOC_RxPduInfoIterType rxPduId);
#endif
...
/*! \brief      Process the 'no verification' result to the upper layer.
    ...
    \param[in]  rxPduId  rx PduId
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_Verify_ProcessNoVerificationResult(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_RxIf_ForwardPduToUpperLayer(SecOC_RxPduInfoIterType rxPduId, P2VAR(PduInfoType, AUTOMATIC, SECOC_APPL_DATA) pduInfoPtr);
#endif
...
/*! \brief      Forwards the Pdu to the upper layer module in case development mode is active and a non-recoverrable error was detected.
    ...
    \param[in]  rxPduId  rx PduId
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_RxIf_ForwardPduToUpperLayerDevMode(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerSecuredPduStartIdxOfRxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfRxSecuredPduDataContainer(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_AuthenticPduDataContainerAuthenticPduStartIdxOfRxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfRxAuthenticPduDataContainer(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_AuthenticPduDataContainerAuthenticPduLengthOfRxPduInfoType, SECOC_CODE) SecOC_GetLengthOfRxAuthenticPduDataContainer(SecOC_RxPduInfoIterType rxPduId);
#endif
...
/*! \brief      Returns the start index of the authentic PDU data container.
    ...
    \return     start index of the authentic PDU data container.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_AuthenticPduDataContainerDataToAuthenticateStartIdxOfRxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfRxAuthenticPduDataContainerDataToAuthenticate(SecOC_RxPduInfoIterType rxPduId);
#endif
...
/*! \brief      Returns the length of the authentic PDU data container.
    ...
    \return     length of the authentic PDU data container.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_AuthenticPduDataContainerDataToAuthenticateLengthOfRxPduInfoType, SECOC_CODE) SecOC_GetLengthOfRxRxAuthenticPduDataContainerDataToAuthenticate(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerSecuredPduStartIdxOfRxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfRxSecuredPduDataContainerSecuredPdu(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerSecuredPduLengthOfRxPduInfoType, SECOC_CODE) SecOC_GetLengthOfRxSecuredPduDataContainerSecuredPdu(SecOC_RxPduInfoIterType rxPduId);
#endif
...
/*! \brief      Returns the length of the Secured Tp Pdu.
    ...
    \return     length of the Secured Pdu.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerTpSecuredPduLengthOfRxPduInfoType, SECOC_CODE) SecOC_GetLengthOfRxTpSecuredPduDataContainerSecuredPdu(SecOC_RxPduInfoIterType rxPduId);
#endif
...
/*! \brief      Adds the Data Id to data to authenticate.
    ...
    \param[in]  rxPduId  rx PduId
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_AddRxDataIdsToDataToAuthenticate(SecOC_RxPduInfoIterType rxPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_AddTxDataIdsToDataToAuthenticate(SecOC_TxPduInfoIterType txPduId);
#endif
...
/*! \brief      Returns the start index of the authentic PDU data container.
    ...
    \return     start index of the authentic PDU data container.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_AuthenticPduDataContainerAuthenticPduStartIdxOfTxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfTxAuthenticPduDataContainerData(SecOC_TxPduInfoIterType txPduId);
#endif
...
/*! \brief      Returns the start index of the Authentic Pdu Header.
    ...
    \return     start index of the authentic PDU data container.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerAuthPduHeaderLengthStartIdxOfTxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfTxAuthPduHeader(SecOC_TxPduInfoIterType txPduId);
#endif
...
/*! \brief      Returns the start index of the secured PDU data container.
    ...
    \return     start index of the secured PDU data container.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerAuthenticPduStartIdxOfTxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfTxSecuredPduDataContainerData(SecOC_TxPduInfoIterType txPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerAuthenticPduLengthOfTxPduInfoType, SECOC_CODE) SecOC_GetLengthOfTxSecuredPduDataContainerData(SecOC_TxPduInfoIterType txPduId);
#endif
...
/*! \brief      Returns the start index of the secured PDU.
    ...
    \return     start index of the secured PDU data container.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerSecuredPduStartIdxOfTxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfTxSecuredPdu(SecOC_TxPduInfoIterType txPduId);
#endif
...
/*! \brief      Returns the length of the secured PDU.
    ...
    \return     length of the secured PDU data container.
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerSecuredPduLengthOfTxPduInfoType, SECOC_CODE) SecOC_GetLengthOfTxSecuredPdu(SecOC_TxPduInfoIterType txPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_AuthenticPduDataContainerDataToAuthenticateStartIdxOfTxPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfTxDataToAuthenticate(SecOC_TxPduInfoIterType txPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_AuthenticPduDataContainerDataToAuthenticateLengthOfTxPduInfoType, SECOC_CODE) SecOC_GetLengthOfDataToAuthenticate(SecOC_TxPduInfoIterType txPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerAuthenticSplitPduStartIdxOfTxSplitPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfTxMessageLinkerAuthSplitPdu(SecOC_TxPduInfoIterType txPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerAuthenticSplitPduStartIdxOfTxSplitPduInfoType, SECOC_CODE) SecOC_GetStartIdxOfTxAuthenticSplitPdu(SecOC_TxPduInfoIterType txPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(SecOC_SecuredPduDataContainerAuthenticSplitPduLengthOfTxSplitPduInfoType, SECOC_CODE) SecOC_GetLengthOfTxAuthenticSplitPdu(SecOC_TxPduInfoIterType txPduId);
#endif
...
/*! \brief      Removes the Can Fd Padding from the related container PDU.
    ...
    \param[in]  rxPduId  rx PduId
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_RxIf_RemoveCanFdContainerPadding(SecOC_RxPduInfoIterType rxPduId);
#endif
...
/*! \brief      Do the processing of the state Unverified.
    ...
    \param[in]  rxPduId  rx PduId
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_Verify_MAC_DoUnverifiedProcessing(SecOC_RxPduInfoIterType rxPduId);
#endif
...
/*! \brief      Returns the parsed freshness value.
    ...
    \return     parsed freshness value
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_FreshnessValue_GetParsedFreshnessValueMSBAligned(SecOC_RxPduInfoIterType rxPduId, P2VAR(uint8, AUTOMATIC, SECOC_APPL_DATA) parsedFreshnessValue, uint8 parsedFreshnessValueBufferLength);
#endif
...
/*! \brief      Returns the parsed freshness value.
    ...
    \return     parsed freshness value
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_FreshnessValue_GetParsedFreshnessValue(SecOC_RxPduInfoIterType rxPduId, P2VAR(uint8, AUTOMATIC, SECOC_APPL_DATA) parsedFreshnessValue, uint8 parsedFreshnessValueBufferLength);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(Std_ReturnType, SECOC_CODE) SecOC_Authenticate_GenerateAuthenticatorUsingCustomCallout(SecOC_TxPduInfoIterType txPduId);
#endif
...
/*! \brief      Calls all verification status Callouts with information about secured PDU and freshness value.
    ...
    \param[in]  verificationStatus   verification status
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_Verify_PropagateVerificationStatusWithSecuredPdu(SecOC_RxPduInfoIterType rxPduId, SecOC_VerificationResultType verificationStatus);
#endif
 ...
 *  \pre        -
    \param[in]  txPduId  Pdu Id
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_TxIf_HandlePdu_TPPDU(SecOC_TxPduInfoIterType txPduId);
#endif
...
**********************************************************************************************************************/
LOCAL_INLINE FUNC(uint8, SECOC_CODE) SecOC_TxIf_CalculatePaddingSize(SecOC_SecuredPduDataContainerAuthenticPduLengthOfTxPduInfoType securedPduLength);
#endif
...
/*! \brief      Adds the CAN FD Padding bytes to the Secured Pdu
    ...
    \param[in]  txPduId Pdu id
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_TxIf_AddCANFDPadding(SecOC_TxPduInfoIterType txPduId);
#endif
 ...
 *
**********************************************************************************************************************/
LOCAL_INLINE FUNC(Std_ReturnType, SECOC_CODE) SecOC_FreshnessValue_GetValueForTxPduOfCallout(SecOC_TxPduInfoIterType txPduId, uint8 * freshnessValue, uint8 freshnessValueBufferLength, uint8 * truncatedFreshnessValue, uint8 truncatedFreshnessValueBufferLength) /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
{
...
# if (SECOC_CUSTOM_AUTHENTICATION_API == STD_OFF)
      SecOC_GetArrayByteAligned(SecOC_GetAddrAuthenticatorCache(SecOC_GetAuthenticatorCacheStartIdxOfTxPduInfo(txPduId)),
                                SecOC_GetAddrSecuredPduDataContainer(SecOC_GetSecuredPduDataContainerTruncatedAuthenticatorStartIdxOfTxPduInfo(txPduId)),
                                (uint16) SecOC_GettruncatedAuthenticationLengthOfTxPduInfo(txPduId),
                                0u, (uint8) ((8u - SecOC_GetTruncAuthStartBitInByteOfTxPduInfo(txPduId)) & 7u), FALSE);    /* SBSW_SECOC_PTR2FUNC_6 */
# endif
 ...
 *
**********************************************************************************************************************/
extern uint8 SecOC_Default_Code;
FUNC(void, SECOC_CODE) SecOC_CopyAuthenticationPatternIntoMacAndFvMValue(SecOC_TxPduInfoIterType txPduId)
{
  ...
  for(; destIdx < SecOC_GetSecuredPduDataContainerAuthInfoDataEndIdxOfTxPduInfo(txPduId); destIdx++)
  {
    ...
    SecOC_SetSecuredPduDataContainer(destIdx, SecOC_Default_Code);        /* SBSW_SECOC_CSL03 */
  }
 ...
 *
**********************************************************************************************************************/
FUNC(Std_ReturnType, SECOC_CODE) SecOC_TxIf_ProcessTxPdu(SecOC_TxPduInfoIterType txPduId)
{
...
#  endif
  ...
  return retVal;
}  /* PRQA S 6050, 6010, 6030 */ /* MD_MSR_STCAL, MD_MSR_STPTH, MD_MSR_STCYC */
#endif
...
# endif
  {
    ...
    SecOC_GetArrayByteAligned(SecOC_GetAddrSecuredPduDataContainer(SecOC_GetSecuredPduDataContainerTruncatedAuthenticatorStartIdxOfRxPduInfo(rxPduId)),
                              SecOC_GetAddrAuthenticatorCache(SecOC_GetAuthenticatorCacheStartIdxOfRxPduInfo(rxPduId)),
                             (uint16) SecOC_GettruncatedAuthenticationLengthOfRxPduInfo(rxPduId),
                              (uint8) SecOC_GetTruncAuthStartBitInByteOfRxPduInfo(rxPduId), 0u, TRUE);  /* SBSW_SECOC_PTR2FUNC_6 */
 ...
 *
**********************************************************************************************************************/
LOCAL_INLINE FUNC(void, SECOC_CODE) SecOC_RxIf_ForwardPduToUpperLayer(SecOC_RxPduInfoIterType rxPduId, P2VAR(PduInfoType, AUTOMATIC, SECOC_APPL_DATA) pduInfoPtr) /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
{
  ...
  if(paddingSize > 0u)
  {
    if(actualLength > 0u)
    {
      ...
      for(; endIdx > SecOC_GetStartIdxOfRxSecuredPduDataContainer(rxPduId); endIdx--)
      {
        ...
        SecOC_SecuredPduDataContainerIterType newAuthenticPduBufferIdx = ((SecOC_SecuredPduDataContainerIterType) srcIdx) + paddingSize;
 ...
 *
**********************************************************************************************************************/
FUNC(void, SECOC_CODE) SecOC_Verify_MAC(SecOC_RxPduInfoIterType rxPduId)
{
...
}  /* PRQA S 6050, 6010, 6030, 6080 */ /* MD_MSR_STCAL, MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STMIF */
#endif
 ...
 *
**********************************************************************************************************************/
FUNC(void, SECOC_CODE) SecOC_GetArrayByteAligned(P2CONST(uint8, AUTOMATIC, SECOC_APPL_DATA) srcBuffer, P2VAR(uint8, AUTOMATIC, SECOC_APPL_DATA) destBuffer, uint16 copyBitLen, uint8 srcStartBitInByte, uint8 destBitOffset, boolean isSrcRightAligned)
{
  uint16_least i = 0u;
 ...
 *
**********************************************************************************************************************/
FUNC(void, SECOC_CODE) SecOC_Authenticate_IncrementAndCheckBuildAttempts(SecOC_TxPduInfoIterType txPduId)       /* PRQA S 1505 */ /* MD_SecOC_1505 */
{
 ...
 *
**********************************************************************************************************************/
FUNC(void, SECOC_CODE) SecOC_Verify_IncrementBuildAttempts(SecOC_RxPduInfoIterType rxPduId)     /* PRQA S 1505 */ /* MD_SecOC_1505 */
{
...
# endif
  ...
  return ret;
}  /* PRQA S 6030, 6080, 6010, 6050 */ /* MD_MSR_STCYC, MD_MSR_STMIF, MD_MSR_STPTH, MD_MSR_STCAL */
...
# if(SECOC_RXSECUREDPDUINFO == STD_ON)
    ...
    SchM_Enter_SecOC_SECOC_EXCLUSIVE_AREA_RXSTATE();
    if((SecOC_GetRxPduState(rxPduInfoIdx) == SECOC_IDLE_RXPDUSTATE) || (SecOC_GetRxPduState(rxPduInfoIdx) == SECOC_PRE_VERIFY_START_RXPDUSTATE)) /* COV_SECOC_TP_ONLY */
    {
#  if (SECOC_EXISTS_AUTHENTIC_SPLIT_MESSAGETYPEOFRXSECUREDPDUINFO == STD_ON)
...
#   if (SECOC_CURRENTMESSAGELINKER == STD_ON)
              {
                ...
                SecOC_GetArrayByteAligned(&(authenticPDUStart[((PduLengthType) (SecOC_GetMessageLinkPosOfRxSecuredPduInfo(id) >> 3u))]),
                                          messageLinker,
                                          (uint16) SecOC_GetMessageLinkLenOfRxSecuredPduInfo(id),
                                          (uint8) ((8u - ((SecOC_GetMessageLinkPosOfRxSecuredPduInfo(id) + 1u) & 7u)) & 7u),
                                          0u, TRUE);   /* SBSW_SECOC_PTR2FUNC_6 */
...
#   if (SECOC_CURRENTMESSAGELINKER == STD_ON)
          {
            uint8 messageLinker[SECOC_MESSAGE_LINKER_SIZE_RXPDUS] = {0u};
            SecOC_GetArrayByteAligned(&(info->SduDataPtr[SecOC_GetMessageLinkerStartByteInCryptoPduOfRxSecuredPduInfo(id)]),
                                                 messageLinker,
                                                 (uint16) SecOC_GetMessageLinkLenOfRxSecuredPduInfo(id),
                                                 SecOC_GetMessagesLinkCryptoPduSrcBitOffsetOfRxSecuredPduInfo(id),
                                                 0u, TRUE);   /* SBSW_SECOC_PTR2FUNC_6 */
           ...
           if(info != NULL_PTR)
            {
              ...
              {
                VStdMemCpyRamToRam(SecOC_GetAddrSecuredPduDataContainer(SecOC_GetSecuredPduDataContainerSecuredPDUMetaDataStartIdxOfRxPduInfo(rxPduInfoIdx)), info->SduDataPtr, SecOC_GetSecuredPduDataContainerSecuredPDUMetaDataLengthOfRxPduInfo(rxPduInfoIdx));    /* PRQA S 0315 */ /* MD_MSR_VStdLibCopy */ /* SBSW_SECOC_MEM_CPY_2RAM */
              }
              else
              {
                errorId = SECOC_E_PARAM;
...
#  if (SECOC_ENABLE_FORCED_PASS_OVERRIDESTATUS == STD_ON)
            ...
            || (overrideStatus == SECOC_OVERRIDE_SKIP_UNTIL_LIMIT_VERIFYOVERRIDESTATUS) || (overrideStatus == SECOC_OVERRIDE_SKIP_UNTIL_NOTICE_VERIFYOVERRIDESTATUS)
...
# if (SECOC_ENABLE_FORCED_PASS_OVERRIDESTATUS == STD_ON)
           ...
           || (overrideStatus == SECOC_OVERRIDE_SKIP_UNTIL_LIMIT_VERIFYOVERRIDESTATUS)
           || (overrideStatus == SECOC_PASS_UNTIL_LIMIT_VERIFYOVERRIDESTATUS)
# endif
          )
        {
