...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((ReadoutBufferId >= Dem_Cfg_GetSizeOfReadoutBuffer())
    || (ReadoutBufferDataIndex >= Dem_Cfg_SizeOfReadOutBufferData()))                                                            /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
...
# endif
      ...
      if (Dem_DTC_TestStoredStatus(lSubEventId) == TRUE)
      {
        ...
        if ( (lMemoryIndex != DEM_MEM_INVALID_MEMORY_INDEX)
          && (lReadoutBufferDataIndex < Dem_Cfg_SizeOfReadOutBufferData()))                                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
        {
