  ...
  )
{
  ...
  if (Dem_DebounceCounterBased_CheckDebounceInfoPtr((Dem_DebounceBase_ConstInfoPtrType)DebounceInfoPtr) == TRUE)                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  {
    ...
    {
      if ((lEnableConditionsSatisfied == TRUE)
        || (Dem_Cfg_EventDebounceContinuous(lEventId) == TRUE))                                                                  /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
        ...
        && (lDebounceInfo->OldDebounceValue < (sint16)Dem_Cfg_EventStorageTarget(lEventId)))                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
            {
  ...
  )
{
  ...
  if (Dem_DebounceCounterBased_GetNewDebounceValue(DebounceInfoPtr) == Dem_Cfg_EventFailedTarget(lEventId))                      /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  {
    ...
    if ( (Dem_EnableCondition_TestEventEnableConditionsFulfilled(lEventId) == TRUE)
      && (Dem_StorageCondition_TestEventStorageConditionsFulfilled(lEventId) == TRUE) )                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
  ...
  )
{
  ...
  if ( /* Unqualified de-bounce state is ok */
       ( (Dem_Cfg_EventFailedTarget(lEventId) > Value) && (Dem_Cfg_EventPassedTarget(lEventId) < Value) )                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
       /* If de-bouncing counter has reached qualified threshold, the event status must match */
    || ( (Dem_Cfg_EventFailedTarget(lEventId) == Value) && (ExpectedThreshold == TRUE))                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || ( (Dem_Cfg_EventPassedTarget(lEventId) == Value) && (ExpectedThreshold == FALSE)) )                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    lReturnValue = Dem_SatelliteData_SetDebounceData(
                      SatelliteData,
