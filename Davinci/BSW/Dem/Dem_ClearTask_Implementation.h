  ...
  if (FirstEventId != DEM_EVENT_INVALID)
  {
    ...
    { /* Event must match the group */
      if (( (lGroupMask == DEM_CFG_GROUPMASK_ALLDTCS)
          ...
          || ((Dem_Cfg_EventGroupMask(lEventIterator) & lGroupMask) != 0u)                                                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#endif
          )
      /* Do not test for suppression: suppressed DTCs are not exempt from ClearGroupOfDTC */
        && (Dem_DTC_TestDtcAvailableInVariant(lEventIterator) == TRUE)                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
        && (Dem_DTC_TestDtcAvailable(lEventIterator) == TRUE)                                                                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
        )
