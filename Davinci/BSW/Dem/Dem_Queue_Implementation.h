...
/* <<<< -------------------------------- Leave Critical Section: DiagMonitor */
    ...
    while (lPid01UpdateFlag != 0u)
    {
      if ((Dem_Data_TestReadinessDynamicallyCalculated(lGroupIter, DEM_DATA_PIDCONTEXT_PID01) == TRUE)
          && (Dem_Esm_TestPid01ReadinessState(lPid01UpdateFlag, lGroupIter) == TRUE))                                            /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
...
# if (DEM_FEATURE_NEED_PERMANENT_FOR_WWHOBD == STD_ON)
      if ( (lOldB1Counter <= DEM_DATA_B1COUNTER_200H)
       ...
       Dem_Memory_MemEntry_IterNext(&MemEntryIter))                                                                              /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if (Dem_Event_TestValidHandle(lEventId) == TRUE)
    {
      if ( (Dem_Cfg_EventObdRelated(lEventId) == TRUE)
        && (Dem_Cfg_EventSupportAging(lEventId) == TRUE) )                                                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ( (Dem_Cfg_ObdEngineRunTime() >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataIsStoredInNV(Dem_Cfg_ObdEngineRunTime()) == FALSE)                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCallbackType(Dem_Cfg_ObdEngineRunTime()) != DEM_CFG_DATA_FROM_CBK)                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(Dem_Cfg_ObdEngineRunTime()) != 4u) )                                                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
