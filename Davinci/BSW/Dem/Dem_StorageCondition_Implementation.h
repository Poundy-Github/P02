  ...
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(StorageCondition)                                                                             /* PRQA S 3112 */ /* MD_DEM_14.2 */
# if (DEM_CFG_HAS_STORAGE_CONDITIONS == STD_ON)
  return Dem_Cfg_IsFulfilledAtInitOfStorageConditionInitTable(StorageCondition);                                                 /* PRQA S 2841 */ /* MD_DEM_2841_readAccesor */
# else
  return TRUE;
# endif
}
...
# if (DEM_CFG_HAS_STORAGE_CONDITIONS == STD_ON)
  Dem_MemSet((Dem_DataPtrType)&Dem_Cfg_GetStorageConditionGroupCounter(0),                                                       /* PRQA S 0310, 0312, 0602 */ /* MD_DEM_11.4_cpy, MD_DEM_11.5, MD_DEM_20.2 */ /* SBSW_DEM_MEMSET_STORAGECONDITIONGROUPCOUNTER */
    0,
