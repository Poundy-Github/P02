  ...
  )
{
  ...
  if (lEventId != DEM_EVENT_INVALID)
  {
    if ( (Dem_Cfg_EventAvailableByVariant(lEventId) == FALSE)
      || (Dem_EventInternalStatus_TestEventDisconnected(Dem_Event_GetInternalStatus(lEventId)) == TRUE) )                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
...
{
#if (DEM_CFG_SUPPORT_DTR == STD_ON)
  Dem_MemSet((Dem_DataPtrType)(&Dem_Cfg_GetDtrStatus(0)),                                                                        /* PRQA S 0310, 0312, 0602 */ /* MD_DEM_11.4_cpy, MD_DEM_11.5, MD_DEM_20.2 */ /* SBSW_DEM_MEMSET_DTRSTATUS */
             DEM_DTR_VISIBLE,
