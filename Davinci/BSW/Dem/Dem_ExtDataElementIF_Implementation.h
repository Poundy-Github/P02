...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || ((Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_CBK)                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    && (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_UINT8_N))                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ( (DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_CBK_WITH_EVENTID)                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_BOOLEAN)                                                /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 1u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_SINT8)                                                  /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 1u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_UINT8)                                                  /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 1u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_SINT16)                                                 /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 2u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_SINT16_INTEL)                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 2u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_UINT16)                                                 /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 2u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_UINT16_INTEL)                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 2u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_SINT32)                                                 /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 4u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                        /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_SINT32_INTEL)                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 4u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_UINT32)                                                 /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 4u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                        /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_UINT32_INTEL)                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(DataIndex) > 4u)                                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                                                            /* SBSW_DEM_POINTER_RUNTIME_CHECK */
...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ((DataIndex >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataCallbackType(DataIndex) != DEM_CFG_DATA_FROM_SR_PORT_SINT8_N)                                                /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCbkRead(DataIndex) == NULL_PTR))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_EXTDATAELEMENTIF_IMPLEMENTATION_FILENAME, __LINE__);                                        /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
