...
)
{
  ...
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(SatelliteId)                                                                                  /* PRQA S 3112 */ /* MD_DEM_14.2 */
  lLowResTimerptr = (Dem_Cfg_DebounceLoResTimerPtrType)Dem_Cfg_GetDebounceLoResTimerOfSatelliteInfo(SatelliteId);
  ...
  )
{
  if (Dem_SatelliteSat_IsLRTimeDebouncingEnabled() == TRUE)
  {
    ...
    lLowResTimerptr = (Dem_Cfg_DebounceLoResTimerPtrType)Dem_Cfg_GetDebounceLoResTimerOfSatelliteInfo(SatelliteId);              /* PRQA S 2842 */ /* MD_DEM_2842_satellite */
...
)
{
  ...
  if (Dem_SatelliteSat_IsHRTimeDebouncingEnabled() == TRUE)
  {
    /* ----- Runtime Checks ------------------------------------------------ */
    if ((Dem_Error_isDevRunTimeChecksEnabled() == TRUE)                                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      && (IterPtr->mIdx >= Dem_Cfg_GetSizeOfDebounceHiResTable()))
    {
      Dem_Error_RunTimeCheckFailed(DEM_SATELLITE_IMPLEMENTATION_FILENAME, __LINE__);                                             /* SBSW_DEM_POINTER_RUNTIME_CHECK */
    }
    else
...
)
{
  ...
  if (Dem_SatelliteSat_IsLRTimeDebouncingEnabled() == TRUE)
  {
    /* ----- Runtime Checks ------------------------------------------------ */
    if ((Dem_Error_isDevRunTimeChecksEnabled() == TRUE)                                                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      && (IterPtr->mIdx >= Dem_Cfg_GetSizeOfDebounceLoResTable()))
    {
      Dem_Error_RunTimeCheckFailed(DEM_SATELLITE_IMPLEMENTATION_FILENAME, __LINE__);                                             /* SBSW_DEM_POINTER_RUNTIME_CHECK */
    }
    else
  ...
  )
{
  ...
  if ( (Dem_Error_isDevRunTimeChecksEnabled() == TRUE)
    && (SatelliteId >= Dem_Cfg_GetSizeOfSatelliteInfo()))                                                                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_SATELLITE_IMPLEMENTATION_FILENAME, __LINE__);                                               /* SBSW_DEM_POINTER_RUNTIME_CHECK */
    lReturnValue = TRUE;
  }
  ...
  )
{
    ...
    && (Dem_Satellite_IsMultipleSatellitesEnabled() == TRUE))
  {
    ...
    lSatExtendedDataPtr = (Dem_Cfg_SatelliteExtendedDataPtrType)Dem_Cfg_GetSatelliteExtendedDataOfSatelliteInfo(SatelliteId);
  ...
  )
{
  if ( (Dem_Error_isDevRunTimeChecksEnabled() == TRUE)
    && ( (SatelliteId >= Dem_Cfg_GetSizeOfSatelliteInfo())                                                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      || (MonitorId >= (Dem_Cfg_GetEventCountOfSatelliteInfo(SatelliteId)))))                                                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_SATELLITE_IMPLEMENTATION_FILENAME, __LINE__);                                               /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
  else
...
{
  Dem_Cfg_SatelliteExtendedDataPtrType lSatExtendedDataPtr;
  lSatExtendedDataPtr = (Dem_Cfg_SatelliteExtendedDataPtrType)Dem_Cfg_GetSatelliteExtendedDataOfSatelliteInfo(SatelliteId);      /* PRQA S 2842 */ /* MD_DEM_2842_satellite */

  /* ----- Config Checks ------------------------------------------------ */
  if ( (Dem_Prestore_isPrestoreFFEnabled() == FALSE)
    || (Dem_Satellite_IsMultipleSatellitesEnabled() == FALSE))                                                                   /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
  ...
  )
{
  ...
  if ((Dem_Prestore_isPrestoreFFEnabled() == TRUE)                                                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    && (Dem_Satellite_IsMultipleSatellitesEnabled() == TRUE))
  {
    Dem_Cfg_SatelliteExtendedDataPtrType lSatExtendedDataPtr;
    lSatExtendedDataPtr = (Dem_Cfg_SatelliteExtendedDataPtrType)Dem_Cfg_GetSatelliteExtendedDataOfSatelliteInfo(SatelliteId);    /* PRQA S 2842 */ /* MD_DEM_2842_satellite */
  ...
  )
{
  ...
  if (Dem_Cfg_EventDebounceContinuous(DebounceInfoPtr->EventId) == TRUE)
  {
    ...
    if (((Dem_Debounce_TestQualifiedResult(DebounceInfoPtr) == TRUE)                                                             /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
      && (Dem_Monitor_TestMonitorStatusTNCTOC(lMonitorStatus) == TRUE))                                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      ...
      && (Dem_Monitor_TestMonitorStatusTF(lMonitorStatus) == FALSE))                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      ...
      && (Dem_Monitor_TestMonitorStatusTF(lMonitorStatus) == TRUE)))                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
      lReturn = TRUE;
    }
  }
  ...
  if ( (Dem_Satellite_TestSimilarConditionsChanged(OldSatelliteData, NewSatelliteData) == TRUE)
    && (Dem_Debounce_GetMonitorTrigger(DebounceInfoPtr) == DEM_EVENT_STATUS_PASSED)                                              /* PRQA S 3415 */ /* MD_DEM_13.5_cf */ /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
    && (Dem_Cfg_EventHealingTarget(DebounceInfoPtr->EventId) == 0u) )                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    lReturn = TRUE;
  }
  ...
  )
{
  ...
  do
  {
    ...
    if (Dem_Debounce_CalculateDebouncing(lDebounceInfoPtr) == TRUE)                                                              /* SBSW_DEM_CALL_DEBOUNCEINFO_POINTER */
    {
      ...
      {
        Dem_Iumpr_ReportRatioFault(lEventId, Dem_Iumpr_FaultOrigin_EventReport);
      }
    }
    else
    {
  ...
  )
{
  ...
  if ( (Dem_Satellite_IsMultipleSatellitesEnabled() == TRUE)
    && (Dem_Prestore_isPrestoreFFEnabled() == TRUE))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_SatelliteInfo_Type lOldSatelliteInfo;                                                                                    /* PRQA S 0759 */ /* MD_MSR_Union */
    Dem_SatelliteInfo_Type lNewSatelliteInfo;                                                                                    /* PRQA S 0759 */ /* MD_MSR_Union */
    do
  ...
  )
{
  ...
  if (Dem_SatelliteSat_IsLRTimeDebouncingEnabled() == TRUE)
  {
    Dem_Satellite_SetDebounceLoResTimer(SatelliteId, Dem_Satellite_GetDebounceLoResTimeBase());
  }
