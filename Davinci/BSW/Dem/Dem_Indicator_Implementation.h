...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ( (IndicatorId >= Dem_Cfg_GetSizeOfGlobalIndicatorStates())
    || (NmNodeIndex >= Dem_Cfg_GlobalJ1939NodeCount()))                                                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Error_RunTimeCheckFailed(DEM_INDICATOR_IMPLEMENTATION_FILENAME, __LINE__);                                               /* SBSW_DEM_POINTER_RUNTIME_CHECK */
  }
  else
  ...
  )
{
  uint8 lReturnValue;
#if (DEM_CFG_SUPPORT_INDICATORS == STD_ON)
  lReturnValue = Dem_Cfg_GlobalIndicatorStates[IndicatorId][NmNodeIndex];                                                        /* PRQA S 2841 */ /* MD_DEM_2841_readAccesor */
#else
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(IndicatorId)                                                                                  /* PRQA S 3112 */ /* MD_DEM_14.2 */
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(NmNodeIndex)                                                                                  /* PRQA S 3112 */ /* MD_DEM_14.2 */
  ...
  )
{
  ...
  if ( (Dem_Cfg_GlobalMilIndicator() == IndicatorId)
    || (Dem_Cfg_GlobalRslIndicator() == IndicatorId)                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_GlobalAwlIndicator() == IndicatorId)                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_GlobalPlIndicator() == IndicatorId))                                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
  ...
  )
{
  ...
  if ( ( (lMilState & DEM_INDICATOR_CONTINUOUS) != 0u)
...
# endif
      ...
      case DEM_INDICATOR_CONTINUOUS:
        Dem_Indicator_SetEventCountContinuous(Dem_Cfg_EventSpecialIndicator(EventId), lNmNodeIndex,
          (uint16)(Dem_Indicator_GetEventCountContinuous(Dem_Cfg_EventSpecialIndicator(EventId), lNmNodeIndex) + 1u));
        break;
# if (DEM_CFG_SUPPORT_J1939 == STD_ON)
      case DEM_INDICATOR_FAST_FLASH:
        Dem_Indicator_SetEventCountFastFlash(Dem_Cfg_EventSpecialIndicator(EventId), lNmNodeIndex, 
          (uint16)(Dem_Indicator_GetEventCountFastFlash(Dem_Cfg_EventSpecialIndicator(EventId), lNmNodeIndex) + 1u));
        break;
      case DEM_INDICATOR_SLOW_FLASH:
        Dem_Indicator_SetEventCountSlowFlash(Dem_Cfg_EventSpecialIndicator(EventId), lNmNodeIndex,
          (uint16)(Dem_Indicator_GetEventCountSlowFlash(Dem_Cfg_EventSpecialIndicator(EventId),lNmNodeIndex) + 1u));
        break;
# endif /* (DEM_CFG_SUPPORT_J1939 == STD_ON) */
# if (DEM_CFG_SUPPORT_J1939 != STD_ON)
      case DEM_INDICATOR_BLINKING:
        Dem_Indicator_SetEventCountBlinking(Dem_Cfg_EventSpecialIndicator(EventId), lNmNodeIndex,
          (uint16)(Dem_Indicator_GetEventCountBlinking(Dem_Cfg_EventSpecialIndicator(EventId), lNmNodeIndex) + 1u));
        break;
...
# endif
      ...
      case DEM_INDICATOR_CONTINUOUS:
        Dem_Indicator_SetEventCountContinuous(lSpecialIndicator, lNmNodeIndex,
          (uint16)(Dem_Indicator_GetEventCountContinuous(lSpecialIndicator, lNmNodeIndex) - 1u));
        break;
# if (DEM_CFG_SUPPORT_J1939 == STD_ON)
      case DEM_INDICATOR_FAST_FLASH:
        Dem_Indicator_SetEventCountFastFlash(lSpecialIndicator, lNmNodeIndex, 
          (uint16)(Dem_Indicator_GetEventCountFastFlash(lSpecialIndicator,lNmNodeIndex) - 1u));
        break;
      case DEM_INDICATOR_SLOW_FLASH:
        Dem_Indicator_SetEventCountSlowFlash(lSpecialIndicator, lNmNodeIndex,
          (uint16)(Dem_Indicator_GetEventCountSlowFlash(lSpecialIndicator, lNmNodeIndex) - 1u));
        break;
# endif /* (DEM_CFG_SUPPORT_J1939 == STD_ON) */
# if (DEM_CFG_SUPPORT_J1939 != STD_ON)
      case DEM_INDICATOR_BLINKING:
        Dem_Indicator_SetEventCountBlinking(lSpecialIndicator, lNmNodeIndex,
          (uint16)(Dem_Indicator_GetEventCountBlinking(lSpecialIndicator, lNmNodeIndex) - 1u));
        break;
      case DEM_INDICATOR_BLINK_CONT:
        Dem_Indicator_SetEventCountContinuous(lSpecialIndicator, lNmNodeIndex,
          (uint16)(Dem_Indicator_GetEventCountContinuous(lSpecialIndicator, lNmNodeIndex) - 1u));
  ...
  )
{
  ...
  { /* Class A event currently active or B1 counter exceeds threshold */
    lReturnValue = DEM_INDICATOR_CONTINUOUS;
         ...
         || (Dem_Indicator_GetDtcClassMILCount(DEM_ESM_WWHOBD_DTCCLASS_B1) != 0u)                                                 /* PRQA S 3415 */ /* MD_DEM_13.5_cf */                                                 
         || (Dem_Indicator_GetDtcClassMILCount(DEM_ESM_WWHOBD_DTCCLASS_B2) != 0u) )                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
...
#  if (DEM_FEATURE_NEED_OBD == STD_ON)                                                                                           /* COV_DEM_UNSUPPORTED_FEATURE XF */
      if (lSpecialIndicator == Dem_Cfg_GlobalMilIndicator())
      {
        (FilterResult->LampStatus).LampStatus =                                                                                  /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
          (uint8) (DEM_J1939_LAMP_RSL_NA | DEM_J1939_LAMP_AWL_NA | DEM_J1939_LAMP_PL_NA | (lLampStatus << 6u));
        (FilterResult->LampStatus).FlashLampStatus =                                                                             /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
          (uint8) (DEM_J1939_FLASHLAMP_RSL_NO_FLASH | DEM_J1939_FLASHLAMP_AWL_NO_FLASH | DEM_J1939_FLASHLAMP_PL_NO_FLASH | (lFlashLampStatus << 6u));
      }
      else
#  endif
      ...
      {
        (FilterResult->LampStatus).LampStatus =                                                                                  /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
          (uint8) (DEM_J1939_LAMP_MIL_NA | DEM_J1939_LAMP_AWL_NA | DEM_J1939_LAMP_PL_NA | (lLampStatus << 4u));
        (FilterResult->LampStatus).FlashLampStatus =                                                                             /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
          (uint8) (DEM_J1939_FLASHLAMP_MIL_NO_FLASH | DEM_J1939_FLASHLAMP_AWL_NO_FLASH | DEM_J1939_FLASHLAMP_PL_NO_FLASH | (lFlashLampStatus << 4u));
      }
      else if (lSpecialIndicator == Dem_Cfg_GlobalAwlIndicator())
      {
        (FilterResult->LampStatus).LampStatus =                                                                                  /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
          (uint8) (DEM_J1939_LAMP_MIL_NA | DEM_J1939_LAMP_RSL_NA | DEM_J1939_LAMP_PL_NA | (lLampStatus << 2u));
        (FilterResult->LampStatus).FlashLampStatus =                                                                             /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
          (uint8) (DEM_J1939_FLASHLAMP_MIL_NO_FLASH | DEM_J1939_FLASHLAMP_RSL_NO_FLASH | DEM_J1939_FLASHLAMP_PL_NO_FLASH | (lFlashLampStatus << 2u));
      }
