...
# if (DEM_FEATURE_NEED_OEM_EXTENSIONS_VCC == STD_OFF)
          && (Dem_Cfg_ERecTrigger(lCfgERecIndex) == (UpdateFlags & Dem_Cfg_ERecTrigger(lCfgERecIndex)))                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
# endif
       )
      {
...
# endif
           (Dem_Cfg_SRecTrigger(lCfgSRecIndex) == (UpdateFlags & Dem_Cfg_SRecTrigger(lCfgSRecIndex))) ) &&                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
         (  (Dem_Cfg_SRecUpdate(lCfgSRecIndex) == TRUE)                                                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
         || (Dem_SnapshotEntry_IteratorIsSnapshotRecordStored(&lSnapshotEntryIter) == FALSE))                                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */ /* SBSW_DEM_POINTER_FORWARD_STACK */
       )
    {
  ...
  )
{
  ...
  if ((Dem_Cfg_GlobalSRecTrigger() == (UpdateFlags & Dem_Cfg_GlobalSRecTrigger()))                                               /* COV_DEM_UNSUPPORTED_COMBINATION_GLOBAL_SRECS */
     && ((Dem_Cfg_GlobalSRecUpdate() == TRUE)                                                                                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */                                                                                 
...
# if (DEM_CFG_SUPPORT_CONFIRMED_VISIBLE_FREEZE_FRAME == STD_ON)
        if ((DEM_OPERATIONCYCLE_TEST_DCY_QUALIFIED(Dem_OperationCycle_GetObdCycleStates()) == TRUE)
          || (Dem_Cfg_EventTripTarget(DTCContext->EventId) == 0u))                                                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
        {
  ...
  )
{
  ...
  if ( (((Effects & DEM_CFG_TRIGGER_PENDING) != 0u)
    && (Dem_UDSStatus_Test_CDTC(Dem_DTC_GetDTCStatus(EventId)) == FALSE))                                                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
# if (DEM_CFG_SUPPORT_PENDING_UPDATE_FREEZE_FRAME == STD_ON)
...
# if (DEM_CFG_DATA_CYCLES_SINCE_FIRST_FAILED == STD_ON)
  if ((Dem_MemoryEntry_GetCyclesSinceFirstFailed(MemoryEntryId) < DEM_OPERATIONCYCLE_CYCLECOUNT_MAX)
    && (Dem_OperationCycle_CycleCountDistance(Dem_MemoryEntry_GetCyclesSinceFirstFailed(MemoryEntryId), CycleCount) >= 0xffU))   /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
...
# if (DEM_CFG_DATA_CYCLES_SINCE_LAST_FAILED == STD_ON)
  if ((Dem_MemoryEntry_GetCyclesSinceLastFailed(MemoryEntryId) < DEM_OPERATIONCYCLE_CYCLECOUNT_MAX)
    && (Dem_OperationCycle_CycleCountDistance(Dem_MemoryEntry_GetCyclesSinceLastFailed(MemoryEntryId), CycleCount) >= 0xffU))    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
...
)
{
  ...
  if ( ((CycleStatus & DEM_OPERATIONCYCLE_CYCLE_STOPPED) != 0u)
    && (Dem_UDSStatus_Test_TNCTOC(lDtcStatus) == FALSE) )                                                                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
