  ...
  )
{
  return (boolean)( (EventId != DEM_EVENT_INVALID)
                 && (EventId < Dem_Cfg_GlobalEventCount()) );                                                                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
}
 ...
 *
 * \details       Process event effects on 'Passed' status report.
 *
 * \param[in,out] EventContext
 *                Event processing context
 *
...
# if (DEM_FEATURE_NEED_TRIPCOUNTER == STD_ON)
    if ( (Dem_UDSStatus_Test_PDTC(EventContext->OldEventStatus) == TRUE) &&
         (Dem_Indicator_TestHasIndicator(EventContext->EventId) == TRUE) )                                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
...
#else
        if ( ((Dem_UDSStatus_Test_PDTC(EventContext->OldEventStatus)) == TRUE)
          && ((Dem_UDSStatus_Test_TFTOC(EventContext->OldEventStatus)) == FALSE) )                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
        {
  ...
  )
{
  ...
  Dem_Iumpr_OpCycleStart(EventId);
...
# if (DEM_CFG_SUPPORT_TYPE1_COMBINATION == STD_ON)
      ...
      if ( (lGroupId == DEM_CFG_COMBINED_GROUP_INVALID)
        || (Dem_UDSStatus_Test_PDTC(Dem_DTC_CalculateCombineGroupUdsStatus(lGroupId)) == FALSE) )                                /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
# endif
      {
...
# endif /* (DEM_CFG_SUPPORT_PERMANENT == STD_ON) */
  ...
  if ( ((EventContext->EventEffects & DEM_CFG_TRIGGER_CONFIRMED) != 0u)
    ...
    && (Dem_UDSStatus_Test_CDTC(EventContext->OldEventStatus) == TRUE)))                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
...
# if (DEM_CFG_SUPPORT_PERMANENT == STD_ON)
    ...
    {
      if ( (Dem_DTC_IsEventCombinationEnabled() == FALSE)                                                                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
...
# endif
  {
    ...
    if ((DEM_OPERATIONCYCLE_TEST_DCY_QUALIFIED(Dem_OperationCycle_GetObdCycleStates()) == TRUE)
      || (Dem_Cfg_EventTripTarget(EventId) == 0u)                                                                                /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      || (QualifyEvent == TRUE))                                                                               
    {
...
#  if (DEM_CFG_AGING_START_TRIGGER_PASSED == STD_ON)
      && (Dem_Cfg_EventAgingTarget(EventId) == 0u)                                                                                /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#  endif
       )
    {
      lReturnValue = Dem_UDSStatus_Reset_PDTC(lReturnValue);
...
#  if (DEM_CFG_AGING_AFTER_HEALING_ALL_DTC == STD_OFF)
      if ( (Dem_Cfg_EventHealingTarget(EventId) != 0u)
        || ( (Dem_Cfg_EventHealingTarget(EventId) == 0u)                                                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
          && (Dem_UDSStatus_Test_WIR(EventStatus) == TRUE) )                                                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#   if (DEM_FEATURE_NEED_AGING_AFTER_HEALING_MIL_ONLY == STD_ON)
        /* Obd relevant events have to heal before they can age */
        || ( (Dem_Cfg_EventHealingTarget(EventId) == 0u)                                                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
          && (Dem_UDSStatus_Test_WIR(EventStatus) == FALSE)                                                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
...
#  if (DEM_FEATURE_NEED_IMMEDIATEHEAL == STD_ON)
    if (Dem_Cfg_EventHealingTarget(EventId) == 0u)
    {
      lReturnValue = (boolean)( (Dem_UDSStatus_Test_TF(EventStatus) == FALSE)
                             && (Dem_UDSStatus_Test_TNCTOC(EventStatus) == FALSE) );                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    }
...
#  if (DEM_FEATURE_NEED_HEALINGCOUNTER == STD_ON)
      ...
      lReturnValue = (boolean)( (Dem_Event_GetTripCount(EventId) >= Dem_Cfg_EventHealingTarget(EventId))
                             && (Dem_UDSStatus_Test_PDTC(EventStatus) == FALSE) );                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#  else
  ...
  )
{
  ...
  lReturnValue = (boolean)
    ...
    || (Dem_Cfg_EventAvailableByVariant(EventId) == FALSE)                                                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
...
)
{
  ...
  if ( (Dem_UDSStatus_Test_TF(lEventStatus) == FALSE)
    && (Dem_UDSStatus_Test_WIR(lEventStatus) == FALSE)                                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    && (Dem_UDSStatus_Test_CDTC(lEventStatus) == FALSE)                                                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    )
  {
  ...
  )
{
  ...
  if (Dem_EventInternalStatus_TestEventDisconnected(lEventInternalStatus) == FALSE)
  {
    if ( ((Dem_InitState_TestMasterInState(DEM_INITSTATE_PREINITIALIZED) == TRUE) || (Dem_Event_MayDisconnect(EventId) == TRUE)) /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      && (Dem_EventInternalStatus_TestAvailabilityChanged(lEventInternalStatus) == FALSE) )                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
/* >>>> -------------------------------- Enter Critical Section: DiagMonitor */
      Dem_EnterCritical_DiagMonitor();
      lEventInternalStatus = Dem_Event_GetInternalStatus(EventId);
  ...
  )
{
  ...
  if ( (Dem_Cfg_EventUdsDtc(EventId) != DEM_CFG_DTC_UDS_INVALID)
    ...
    && (Dem_StorageCondition_TestEventStorageConditionsFulfilled(EventId) == TRUE) )                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
  ...
  )
{
  ...
  if ( (lEventContext.OldEventStatus != lEventContext.NewEventStatus)                                                            /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#if (DEM_CFG_SUPPORT_RETRY_STORAGE == STD_ON)
    || (Dem_DTC_TestStoredStatus(EventId) == FALSE)                                                                              /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#endif
      )
      ...
      if (lDTCContext.DtcEffects != DEM_CFG_TRIGGER_NONE)
      {
        ...
        if (Dem_DTC_TestEventStoresPermanentDTC(EventId) == TRUE)
        {
          if ((Dem_UDSStatus_Test_CDTC(lDTCContext.OldDtcStatus) == FALSE)
            && (Dem_UDSStatus_Test_CDTC(lDTCContext.NewDtcStatus) == TRUE))                                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
          {
...
)
{
  ...
  if ( (Dem_EventInternalStatus_Test_QualifyStatus_CDTC(lEventQualifyStatus) == FALSE)
    && (Dem_UDSStatus_Test_CDTC(lEventStatus) == TRUE)                                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    )
...
# endif
  ...
  if ( (Dem_EventInternalStatus_Test_QualifyStatus_WIR(lEventQualifyStatus) == FALSE)
    && (Dem_UDSStatus_Test_WIR(lEventStatus) == TRUE))                                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
