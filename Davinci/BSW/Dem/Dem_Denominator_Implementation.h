 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_Denominator_TestConditionsReached(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Denominator_SetConditionsReached(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Denominator_ResetConditionsReached(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)                                                    /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
{
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_Denominator_TestGeneralIndividualConditionReached(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
  return ((Dem_Iumpr_Ratio_GetRatioStatusUtil(RatioIndex) & DEM_RATIO_INDIGENDEN_CONDITIONS_REACHED) != 0u);
}
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Denominator_SetGeneralIndividualConditionReached(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
  Dem_Iumpr_Ratio_SetRatioStatusUtil(RatioIndex, (Dem_Iumpr_Ratio_GetRatioStatusUtil(RatioIndex) | DEM_RATIO_INDIGENDEN_CONDITIONS_REACHED));
}
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Denominator_ResetGeneralIndividualConditionReached(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
  Dem_Iumpr_Ratio_SetRatioStatusUtil(RatioIndex, (Dem_Iumpr_Ratio_GetRatioStatusUtil(RatioIndex) & DEM_RATIO_INDIGENDEN_CONDITIONS_REACHED_MASK));
}
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Denominator_SetValue(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex, CONST(uint16, AUTOMATIC) Value)
{
  if ((Dem_Error_isDevRunTimeChecksEnabled() == TRUE)
    && (RatioIndex >= Dem_Iumpr_Ratio_Denominator_GetCount()))                                                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
 ...
 *                Ratio hasn't changed
 *
 * \pre           Should only be called, for denominator's of type cold start and evap
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE for different RatioIdx
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_500Mi_Increment(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
...
Dem_Iumpr_Ratio_ColdStart_Increment(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
  ...
  if ((Dem_Iumpr_Ratio_Denominator_TestIncremented(RatioIndex) == FALSE)
    && (Dem_Iumpr_Ratio_Denominator_TestGeneralIndividualConditionReached(RatioIndex) == TRUE)
...
Dem_Iumpr_Ratio_Evap_Increment(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
  ...
  if ((Dem_Iumpr_Ratio_Denominator_TestIncremented(RatioIndex) == FALSE)
    && (Dem_Iumpr_Ratio_Denominator_TestGeneralIndividualConditionReached(RatioIndex) == TRUE)
    && (Dem_Iumpr_Ratio_Denominator_TestConditionsReached(RatioIndex) == TRUE))
  {
    Dem_Iumpr_Ratio_Denominator_IncrementValue(RatioIndex);
    lUpdateRatio = TRUE;
  }
...
Dem_Iumpr_Ratio_Denominator_Increment(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
  ...
  case DEM_IUMPR_DEN_500MI:
    lUpdateRatio = Dem_500Mi_Increment(RatioIndex);
    break;
...
Dem_Iumpr_Ratio_Denominator_NotReach(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex, CONST(Dem_IumprDenomCondIdType, AUTOMATIC) ConditionId)
{
  ...
  /* Set General Individual Conditions reached */
  if (ConditionId == DEM_IUMPR_GENERAL_INDIVIDUAL_DENOMINATOR)
  {
    if (Dem_Iumpr_Ratio_Denominator_TestGeneralIndividualConditionReached(RatioIndex) == TRUE)
    {
      Dem_Iumpr_Ratio_Denominator_ResetGeneralIndividualConditionReached(RatioIndex);
      lUpdateRatio = TRUE;
    }
...
)
{
  ...
  switch (Dem_Iumpr_Ratio_Denominator_GetDenominatorGroup(RatioIndex))
  {
    case DEM_IUMPR_DEN_500MI:
    {
      Dem_500mi_OpCycleStart(RatioIndex);
      break;
    }
    default:
    {
