...
Dem_Cfg_EventIndicatorIterInit(
  CONST(Dem_EventIdType, AUTOMATIC)  EventId,                                                                                    /* PRQA S 3206 */ /* MD_DEM_3206 */
  CONSTP2VAR(Dem_Cfg_EventIndicatorIterType, AUTOMATIC, AUTOMATIC)  IterPtr                                                      /* PRQA S 3206, 3673 */ /* MD_DEM_3206, MD_DEM_8.13_fp */
  )
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(EventId)                                                                                      /* PRQA S 3112 */ /* MD_DEM_14.2 */
...
#if (DEM_FEATURE_NEED_PERMANENT_FOR_WWHOBD == STD_ON) && (DEM_CFG_VARIANT_POSTBUILD_SELECTABLE == STD_ON)
/* ****************************************************************************
 % Dem_Cfg_IsPermanentSupportedInThisVariant
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_IsPermanentSupportedInThisVariant(void)
{
...
{
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(SRecIndex)                                                                                    /* PRQA S 3112 */ /* MD_DEM_14.2 */
  return (boolean)Dem_Cfg_IsFFUpdateOfFreezeFrameNumTable(SRecIndex);                                                            /* PRQA S 2841 */ /* MD_DEM_2841_readAccesor */
}
#endif
