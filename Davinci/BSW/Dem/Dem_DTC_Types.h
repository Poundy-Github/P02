...
#define DEM_DTC_TEST_J1939_STATUS_ADTC(Status)   (((Status) & (DEM_UDS_STATUS_CDTC | DEM_UDS_STATUS_TF)) == (DEM_UDS_STATUS_CDTC | DEM_UDS_STATUS_TF)) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Status 'PreviouslyActiveDTC' -------------------------------------------- */
/*! Test previously active DTC state of UDS status */
#define DEM_DTC_TEST_J1939_STATUS_PADTC(Status)  (((Status) & (DEM_UDS_STATUS_CDTC | DEM_UDS_STATUS_TF)) == (DEM_UDS_STATUS_CDTC)) /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Pre-confirmed status bit 'unconfirmedDTC' ------------------------------- */
/*! Test pre-confirmed DTC state of SI.30 status */
#define DEM_DTC_TEST_PC_STATUS_UDTC(Status)      (((Status) & 0x01U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set pre-confirmed DTC state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_UDTC(Status)       ((uint8)((Status) | 0x01U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset pre-confirmed DTC state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_UDTC(Status)     ((uint8)((Status) & 0xfeU))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
#define DEM_DTC_TEST_PC_STATUS_UDTCTOC(Status)   (((Status) & 0x02U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set pre-confirmed DTC this operating cycle state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_UDTCTOC(Status)    ((uint8)((Status) | 0x02U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset pre-confirmed DTC this operating cycle state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_UDTCTOC(Status)  ((uint8)((Status) & 0xfdU))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Pre-confirmed status bit 'unconfirmedDTCSinceLastClear' ----------------- */
/*! Test pre-confirmed DTC since last clear state of SI.30 status */
#define DEM_DTC_TEST_PC_STATUS_UDTCSLC(Status)   (((Status) & 0x04U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set pre-confirmed DTC since last clear state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_UDTCSLC(Status)    ((uint8)((Status) | 0x04U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset pre-confirmed DTC since last clear state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_UDTCSLC(Status)  ((uint8)((Status) & 0xfbU))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Pre-confirmed status bit 'agedDTC' -------------------------------------- */
/*! Test aged DTC state of SI.30 status */
#define DEM_DTC_TEST_PC_STATUS_ADTC(Status)      (((Status) & 0x08U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set aged DTC state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_ADTC(Status)       ((uint8)((Status) | 0x08U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset aged DTC state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_ADTC(Status)     ((uint8)((Status) & 0xf7U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Pre-confirmed status bit 'symptomSinceLastClear' ------------------------ */
/*! Test symptom since last clear state of SI.30 status */
#define DEM_DTC_TEST_PC_STATUS_SSLC(Status)      (((Status) & 0x10U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set symptom since last clear state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_SSLC(Status)       ((uint8)((Status) | 0x10U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset symptom since last clear state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_SSLC(Status)     ((uint8)((Status) & 0xefU))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
#define DEM_DTC_TEST_PC_STATUS_WIRSLC(Status)    (((Status) & 0x20U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set warning indicator requested since last clear state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_WIRSLC(Status)     ((uint8)((Status) | 0x20U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset warning indicator requested since last clear state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_WIRSLC(Status)   ((uint8)((Status) & 0xdfU))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Pre-confirmed status bit 'emissionRelatedDTC' --------------------------- */
/*! Test emission related DTC state of SI.30 status */
#define DEM_DTC_TEST_PC_STATUS_ODBDTC(Status)    (((Status) & 0x40U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set emission related DTC state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_ODBDTC(Status)     ((uint8)((Status) | 0x40U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset emission related DTC state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_ODBDTC(Status)   ((uint8)((Status) & 0xbfU))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/* Pre-confirmed status bit 'testFailedSinceLastClear' --------------------- */
/*! Test test failed since last clear state of SI.30 status */
#define DEM_DTC_TEST_PC_STATUS_TFSLC(Status)     (((Status) & 0x80U) != 0u)                                                       /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set test failed since last clear state of SI.30 status */
#define DEM_DTC_SET_PC_STATUS_TFSLC(Status)      ((uint8)((Status) | 0x80U))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Reset test failed since last clear state of SI.30 status */
#define DEM_DTC_RESET_PC_STATUS_TFSLC(Status)    ((uint8)((Status) & 0x7fU))                                                     /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
