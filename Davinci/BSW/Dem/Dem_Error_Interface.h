...
# define Dem_Det_ErrorRegisterDefine()           uint8 lErrorId;                                                                 /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set error register with DET error code */
# define Dem_Det_ErrorRegisterSet(value)         lErrorId = (value);                                                             /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Get error register with DET error code */
# define Dem_Det_ErrorRegisterGet()              lErrorId                                                                        /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
