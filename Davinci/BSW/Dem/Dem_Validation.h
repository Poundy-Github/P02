...
#if !defined PRQA_SIZE_T && !defined _lint && !defined _REVIEW_HELPER && !defined TESTCONFIG_UNSUPPORTED_FEATURECOMBINATION /* COV_DEM_UNSUPPORTED_TESTED_FEATURE TF xf xf xf xf tf */
