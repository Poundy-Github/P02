...
#define DEM_DATA_TEST_USERDATA_CHANGED(Status)   (((Status) & DEM_DATA_USERDATA_CHANGED) != 0u)                                   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set userdata changed flag of data changed state */
#define DEM_DATA_SET_USERDATA_CHANGED(Status)    ((uint8)((Status) | DEM_DATA_USERDATA_CHANGED))                                 /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/*! Test statistics changed flag of data changed state */
#define DEM_DATA_TEST_STATISTICS_CHANGED(Status)  (((Status) & DEM_DATA_STATISTICS_CHANGED) != 0u)                                /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set statistics changed flag of data changed state */
#define DEM_DATA_SET_STATISTICS_CHANGED(Status)  ((uint8)((Status) | DEM_DATA_STATISTICS_CHANGED))                               /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/*! Test normal sample update flag of time series update state */
#define DEM_DATA_TEST_NORMAL_SAMPLE_UPDATE(Status)  (((Status) & DEM_DATA_NORMAL_SAMPLE_UPDATE) != 0u)                            /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set normal sample update flag of time series update state */
#define DEM_DATA_SET_NORMAL_SAMPLE_UPDATE(Status)  ((uint8)((Status) | DEM_DATA_NORMAL_SAMPLE_UPDATE))                           /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */

/*! Test fast sample update flag of time series update state */
#define DEM_DATA_TEST_FAST_SAMPLE_UPDATE(Status)   (((Status) & DEM_DATA_FAST_SAMPLE_UPDATE) != 0u)                               /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Set fast sample update flag of time series update state */
#define DEM_DATA_SET_FAST_SAMPLE_UPDATE(Status)    ((uint8)((Status) | DEM_DATA_FAST_SAMPLE_UPDATE))                             /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
