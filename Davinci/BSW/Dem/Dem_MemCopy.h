...
#  define Dem_MemCpy_Macro(dst, src, len)        { uint16_least lMemCopyIndex; \
                                                 ...
                                                 } }                                                                             /* PRQA S 3453, 3458 */ /* MD_MSR_FctLikeMacro, MD_MSR_FctLikeMacro */
# endif
...
# define Dem_MemCpy(dst, src, len)               Dem_MemCpy_Macro((dst), (src), (len))                                           /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Wrapper macro for memset */
# define Dem_MemSet(dst, val, len)               Dem_MemSet_Macro((dst), (val), (len))                                           /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
/*! Wrapper macro for memcopy */
# define Dem_MemCpy(dst, src, len)               VStdMemCpy((Dem_SharedDataPtrType)(dst), (Dem_SharedDataPtrType)(src), (len))   /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
/*! Wrapper macro for memset */
# define Dem_MemSet(dst, val, len)               VStdMemSet((Dem_SharedDataPtrType)(dst), (val), (len))                          /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#endif
