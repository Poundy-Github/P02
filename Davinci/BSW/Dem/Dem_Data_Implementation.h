...
# if (DEM_DEV_RUNTIME_CHECKS == STD_ON)
  if ( (Dem_Cfg_ObdDistanceInformation() >= Dem_Cfg_GlobalDataElementCount())
    || (Dem_Cfg_DataIsStoredInNV(Dem_Cfg_ObdDistanceInformation()) == FALSE)                                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataCallbackType(Dem_Cfg_ObdDistanceInformation()) != DEM_CFG_DATA_FROM_CBK)                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || (Dem_Cfg_DataSize(Dem_Cfg_ObdDistanceInformation()) != 4u) )                                                               /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
  ...
  if (lPermanentIndex != Dem_Cfg_GlobalPermanentMaxCount())
  {
    ...
    case DEM_ESM_PERMANENT_ACTIVE:
      if ( (Dem_UDSStatus_Test_WIR(OldDtcStatus) == TRUE)
        && (Dem_UDSStatus_Test_WIR(NewDtcStatus) == FALSE))                                                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
...
#endif /* (DEM_CFG_SUPPORT_PERMANENT == STD_ON) && (DEM_CFG_SUPPORT_OBDII == STD_ON) */
  ...
  )
{
  ...
  if ( (ReadinessGroup != DEM_CFG_READINESS_NONE)
    && (Dem_Data_TestReadinessDynamicallyCalculated(ReadinessGroup, DEM_DATA_PIDCONTEXT_PID01) == TRUE))                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
        ...
        if (lReadinessGroup == ReadinessGroup)
        {
          ...
          if (Dem_Event_TestEventUnavailable(lEventId) == FALSE)
          {
            ...
            if ((Dem_DTCInternalStatus_TestExtendedStatus_TPSLC(lExtStatus) == FALSE)
              || (Dem_UDSStatus_Test_PDTC(lEventStatus) == TRUE))                                                                /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
            {
...
#  if (DEM_CFG_SUPPORT_PERMANENTDTC_IMMEDIATE_VISIBLE == STD_ON)
          || (Dem_EventInternalStatus_Test_QualifyStatus_WIR(Dem_Event_GetQualifyStatus(EventId)) == TRUE)                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#  endif
          )
# endif
        {
