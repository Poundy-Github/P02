...
{
  return ((Dem_DTC_IsEventCombinationType1Enabled()) || (Dem_DTC_IsEventCombinationType2Enabled()));                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
}
...
# if (DEM_CFG_SUPPORT_USER_CONTROLLED_WIR == STD_ON)
        ...
        Dem_Cfg_CombinedGroupIterNext(&lCombinedIter))                                                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
  {
    ...
    if ( (Dem_Cfg_EventAvailableByVariant(lSubEventId) == TRUE)                                                                  
      && (Dem_EventInternalStatus_TestEventDisconnected(Dem_Event_GetInternalStatus(lSubEventId)) == FALSE) )                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
      lWirActive = (boolean)(lWirActive                                                                                          
        || (Dem_DTCInternalStatus_TestUserControlledWir(Dem_Event_GetInternalStatus(lSubEventId)) == TRUE));                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    }
  }
...
# if (DEM_CFG_SUPPORT_PERMANENTDTC_IMMEDIATE_VISIBLE == STD_ON)
    if ((Dem_UDSStatus_Test_WIR(lOldDtcStatus) == FALSE)
      && (Dem_UDSStatus_Test_WIR(lArgs.Common.NewDtcStatus) == TRUE))                                                            /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
...
#  if (DEM_CFG_SUPPORT_TYPE1_COMBINATION == STD_ON)
      if (DTCContext->GroupId != DEM_CFG_COMBINED_GROUP_INVALID)
      {
        if ( (Dem_UDSStatus_Test_TF(DTCContext->NewDtcStatus) == FALSE)
          && (Dem_UDSStatus_Test_TNCTOC(DTCContext->NewDtcStatus) == FALSE)                                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#   if (DEM_CFG_AGING_00_START_TESTS_TFTOC == STD_ON)
          && (Dem_UDSStatus_Test_TFTOC(DTCContext->NewDtcStatus) == FALSE)                                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#   endif
          )
        {
...
# if (DEM_CFG_AGING_NEXT_TESTS_TFTOC == STD_ON)
    ...
    &&
# endif
    (Dem_UDSStatus_Test_TNCTOC(DTCStatus) == FALSE));                                                                            /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
}
#endif
  ...
  { /* If all Events belonging to a DTC are disconnected, that DTC is disconnected as well */
         ...
         Dem_Cfg_CombinedGroupIterNext(&lCombinedIter))                                                                          /* SBSW_DEM_CALL_ITERATOR_POINTER */
    {
      ...
      if (Dem_Cfg_EventAvailableByVariant(lSubEventId) == TRUE)
      {
        ...
        lDoDisconnect = (boolean)(lDoDisconnect && (Dem_EventInternalStatus_TestEventDisconnected(lInternalStatus) == TRUE));    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
...
# if ((DEM_FEATURE_NEED_PID01_CALCULATION == STD_ON) && (DEM_CFG_SUPPORT_TYPE1_COMBINATION == STD_ON))
    ...
    if ( (Dem_Cfg_EventReadinessGroup(EventId) != DEM_CFG_READINESS_NONE)
      && (Dem_UDSStatus_Test_TF(lCombinedGroupStatus) == FALSE)                                                                  /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      && (Dem_UDSStatus_Test_TNCTOC(lCombinedGroupStatus) == FALSE)                                                              /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      )
    {
      for (Dem_Cfg_CombinedGroupIterInit(lGroupId, &lCombinedIter);                                                              /* SBSW_DEM_CALL_ITERATOR_POINTER */
           Dem_Cfg_CombinedGroupIterExists(&lCombinedIter) == TRUE;                                                              /* SBSW_DEM_CALL_ITERATOR_POINTER */
...
)
{
  if (Dem_Cfg_EventSupportAging(EventId) == TRUE)
  {
    ...
    if ( (Dem_DTCInternalStatus_GetStoredStatus(lInternalStatus) != Dem_DTCInternalStatus_StoredStatus_None)
      && (Dem_UDSStatus_Test_TF(lEventStatus) == FALSE) )                                                                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
...
# if (DEM_CFG_SUPPORT_CONFIRMED_VISIBLE_FREEZE_FRAME == STD_ON)
    if ((Dem_UDSStatus_Test_CDTC(lOldDtcStatus) == FALSE)                                                                        
      && (Dem_UDSStatus_Test_CDTC(lArgs.Common.NewDtcStatus) == TRUE))                                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
  ...
  )
{
  ...
  if ((Dem_DTCInternalStatus_GetStoredStatus(lInternalStatus) == Dem_DTCInternalStatus_StoredStatus_Active)
     || (Dem_UDSStatus_Test_CDTC(Dem_DTC_RetrieveStatus(EventId)) == TRUE))                                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
  ...
  )
{
  ...
  lReturn = (boolean)((Dem_DTC_isRetryStorageEnabled() == TRUE)
    && (Dem_DTCInternalStatus_GetStoredStatus(Dem_DTC_GetInternalStatus(EventId)) == Dem_DTCInternalStatus_StoredStatus_None));  /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  return lReturn;
}
...
# else /* (DEM_CFG_SUPPORT_WWHOBD == STD_ON)  */
  ...
  lReturnValue = (boolean)
    ...
    && (Dem_UDSStatus_Test_TF(Dem_DTC_GetDTCStatus(EventId)) == TRUE)                                                            /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
...
# else /* DEM_FEATURE_NEED_PERMANENT_FOR_WWHOBD == STD_ON */
  lReturnValue = FALSE;
#  if (DEM_CFG_VARIANT_POSTBUILD_SELECTABLE == STD_ON)
  if(Dem_Cfg_IsPermanentSupportedInThisVariant() == TRUE)
#  endif
  {
  ...
  )
{
  ...
  lReturnValue = (boolean)
    ...
    || (Dem_DTC_TestDtcAvailableInVariant(EventId) == FALSE)                                                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    || ( (Dem_DTC_TestDtcAvailable(EventId) == FALSE)                                                                            /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  ...
  if (lGroupId != DEM_CFG_COMBINED_GROUP_INVALID)
  {
        ...
        Dem_Cfg_CombinedGroupIterNext(&lCombinedIter))                                                                           /* SBSW_DEM_CALL_ITERATOR_POINTER */
    {
      ...
      if ( (lSubEventId != EventId)
        && (Dem_EventInternalStatus_TestEventDisconnected(lInternalStatus) == FALSE) )                                           /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
        lReturnValue = TRUE;
        break;
      }
...
# if (DEM_CFG_SUPPORT_TYPE2_COMBINATION == STD_ON)
      if ( (Dem_UDSStatus_Test_CDTC(lArgs.Common.OldDtcStatus) == TRUE)
        && (Dem_UDSStatus_Test_CDTC(lArgs.Common.NewDtcStatus) == FALSE) )                                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
# endif
      {
...
# if (DEM_CFG_SUPPORT_PENDING_STORAGE_FREEZE_FRAME == STD_ON)
  if ( (Dem_Cfg_EventObdRelated(EventId) == TRUE)
    && (Dem_UDSStatus_Test_CDTC(Dem_DTC_RetrieveStatus(EventId)) == FALSE) )                                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  ...
  )
{
  ...
  if (DTCContext->GroupId != DEM_CFG_COMBINED_GROUP_INVALID)
  {
    if ( (Dem_UDSStatus_Test_TF(DTCContext->OldDtcStatus) == TRUE)
      && (Dem_UDSStatus_Test_TF(DTCContext->NewDtcStatus) == FALSE))                                                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
...
# endif
  ...
  if (Dem_DTC_TestEventStoresPermanentDTC(EventId) == TRUE)
  {
    ...
    if ((Dem_UDSStatus_Test_CDTC(lOldInternalDtcStatus) == TRUE)
      && (Dem_UDSStatus_Test_CDTC(lNewInternalDtcStatus) == FALSE))                                                              /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
...
# if ((DEM_CFG_SUPPORT_PERMANENT == STD_ON) && (DEM_CFG_PROCESS_CDTC_STOREDONLY == STD_ON))
  if (Dem_DTC_TestEventStoresPermanentDTC(EventId) == TRUE)
  {
...
#  if (DEM_CFG_AGING_00_START_TESTS_TFTOC == STD_ON)
        && (Dem_UDSStatus_Test_TFTOC(OldUdsStatus) == FALSE))                                                                    /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#  else
        && (Dem_UDSStatus_Test_TF(OldUdsStatus) == FALSE))                                                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#  endif
      {
#  if (DEM_CFG_SUPPORT_TYPE1_COMBINATION == STD_ON)
        if ((Dem_Cfg_EventCombinedGroup(EventId) == DEM_CFG_COMBINED_GROUP_INVALID)
...
)
{
  ...
  if ((Dem_Cfg_EventUdsDtc(DTCContext->EventId) != DEM_CFG_DTC_UDS_INVALID)
    && (Dem_StorageCondition_TestEventStorageConditionsFulfilled(DTCContext->EventId) == TRUE))                                  /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
    Dem_Cfg_MemoryIndexType lMemoryIndex;
    Dem_Event_InternalStatusType lInternalStatus;
  ...
  )
{
  ...
  if (lMemoryIndex != DEM_MEM_INVALID_MEMORY_INDEX)
  {
    ...
    if ((DEM_DATA_TEST_USERDATA_CHANGED(lBlockModification)
      || (lIsOccurrence == TRUE))
      && (Dem_Cfg_EventSupportImmediateNv(DTCContext->EventId) == TRUE))                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
    {
...
#  if (DEM_CFG_SUPPORT_TYPE1_COMBINATION == STD_ON)
      || (Dem_DTCInternalStatus_TestFdcToc(Dem_Event_GetInternalStatus(EventId)) == FALSE)                                       /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
#  endif
      )
    {
...
# endif
      ...
      if ((Dem_DTCInternalStatus_GetStoredStatus(lInternalStatus) == Dem_DTCInternalStatus_StoredStatus_None)
        && (Dem_UDSStatus_Test_CDTC(Dem_DTC_RetrieveStatus(lEventId)) == FALSE))                                                 /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
...
{
  if ((Dem_Cfg_EventUdsDtc(EventId) != DEM_CFG_DTC_UDS_INVALID)
      && (Dem_Event_GetAgingCounter(EventId) != DEM_OPERATIONCYCLE_CYCLECOUNT_INVALID))                                          /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
