  ...
  )
{
  ...
  if (lFilterId != DEM_CFG_FILTER_INVALID)
  {
    lReturnValue = (boolean)((Dem_FilterData_TestFilterSet(lFilterId, DEM_FILTERDATA_FILTER_DTC) == TRUE)
                     && (Dem_FilterData_TestUseFdc(lFilterId) == TRUE));                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  }
  else
  {
    lReturnValue = FALSE;
  ...
  )
{
  ...
  {
    lReturnValue = (boolean)((Dem_FilterData_TestFilterSet(lFilterId, DEM_FILTERDATA_FILTER_DTC) == TRUE)
                    && (Dem_FilterData_TestUseSeverity(lFilterId) == TRUE));                                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  }
  else
  {
    lReturnValue = FALSE;
  ...
  )
{
  ...
  if ( (lFilterId != DEM_CFG_FILTER_INVALID) && (Dem_ClientAccess_TestNodeValid(ClientId) == TRUE) )                             /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
  ...
  )
{
  ...
  lFreezeFrameIteratorId = Dem_ClientData_GetFreezeFrameIteratorId(ClientId);
  if ( (lFreezeFrameIteratorId != DEM_CFG_FREEZEFRAMEITERATOR_INVALID) && (Dem_ClientAccess_TestNodeValid(ClientId) == TRUE) )   /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
