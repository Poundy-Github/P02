...
Dem_Iumpr_Ratio_Numerator_GetValue(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_ResetIncremented(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_SetIncremented(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
...
Dem_Iumpr_Ratio_Numerator_TestIncremented(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_TestFaultDetect(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_ResetFaultDetect(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_TestLock(void);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_Increment(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_TestFidPending(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_SetFidPending(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_TestDisconnect(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
...
)
{
  if ((Dem_Error_isDevRunTimeChecksEnabled() == TRUE)
    && (RatioIndex >= Dem_Iumpr_Ratio_GetCount()))                                                                                     /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
 ...
 */
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_ResetIncremented(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)                                                            /* PRQA S 3219 */ /* MD_DEM_14.1_ACCESSOR */
{
...
Dem_Iumpr_Ratio_Numerator_Increment(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex)
{
  ...
  if ((Dem_Iumpr_Ratio_Numerator_TestIncremented(RatioIndex) == FALSE) /* Not yet incremented */
    ...
    && (Dem_Iumpr_Ratio_Numerator_TestLock() == FALSE))                                                                                      /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
  {
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_HandleOverflow(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
 ...
 *****************************************************************************/
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Iumpr_Ratio_Numerator_SetFaultDetect(CONST(Dem_RatioIdIndexType, AUTOMATIC) RatioIndex);
...
)
{
  ...
  if ((Dem_Error_isDevRunTimeChecksEnabled() == TRUE) &&                                                                         /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
...
)
{
  ...
  if (Dem_Iumpr_Ratio_IsUpdatePending(RatioIndex) == TRUE)
  {
    ...
    if (Dem_Iumpr_Ratio_TestProcessingAllowed(RatioIndex) == TRUE)
    {
      ...
      /* --- Denominator --- */
      if (Dem_Iumpr_Ratio_Denominator_Increment(RatioIndex))
      {
        lUpdateNvM = TRUE;
      }

      /* --- Numerator --- */
      if (Dem_Iumpr_Ratio_Numerator_Increment(RatioIndex))
      {
        lUpdateNvM = TRUE;
      }
      ...
      if ((Dem_Iumpr_Ratio_Numerator_GetValue(RatioIndex) == DEM_RATIO_MAX_VALUE)
        || (Dem_Iumpr_Ratio_Denominator_GetValue(RatioIndex) == DEM_RATIO_MAX_VALUE))                                                        /* PRQA S 3415 */ /* MD_DEM_13.5_cf */
      {
        /* divide by two if max value has been reached   [CCR1968.2 (g)(5.2.1)(C)] */
