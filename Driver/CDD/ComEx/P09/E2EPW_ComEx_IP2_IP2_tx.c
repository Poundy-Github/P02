 ...
 ** Module: E2EPW_ComEx_IP2_IP2_tx.c
...
/* PRQA S 5087 EOF */
#include "ComEx.h"
#include "E2EPW_Marshal_IP2.h"
#include "E2EPW_ComEx_IP2_IP2_tx.h"
#ifndef STATIC
...
/**********************************************************
 * Function name: E2EPW_Init_IP2_E2E_tx ()
 ...
 **********************************************************/
FUNC (void, ComEx_CODE) E2EPW_WriteInit_IP2_E2E (void)
{
    State_IP2_E2E = &StateVal_IP2_E2E;
    State_IP2_E2E->Counter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_SenderState_IP2_E2E ()
...
FUNC_P2VAR ( E2E_P01ProtectStateType
    ...
    E2EPW_Get_ProtectState_IP2_E2E (void)
{
    return State_IP2_E2E;
}

/**********************************************************
 * Function name: E2EPW_Write_IP2_E2E (ComEx_E2ETYPE *  AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, ComEx_CODE) E2EPW_Write_IP2_E2E
    (P2VAR (ComEx_E2ETYPE, AUTOMATIC, ComEx_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, ComEx_CONST)
        Config_IP2_E2E = &ConfigVal_IP2_E2E;
    ...
    {
        E2EPW_Marshal_IP2 ( AppData, ppa_IP2_E2E_au8 );
    }
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_IP2_E2E->CRCOffset/8;
        uint16 cntoffset_u16 = Config_IP2_E2E->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->Checksum = ppa_IP2_E2E_au8[crcoffset_u16];
        AppData->RollingCounter = (ppa_IP2_E2E_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_IP2_E2E ( AppData );
