 ...
 ** Module: E2EPW_ComEx_DMS5_DMS_FD1_DMS5_DMS_FD1_tx.c
...
/* PRQA S 5087 EOF */
#include "ComEx.h"
#include "E2EPW_Marshal_DMS5_DMS_FD1.h"
#include "E2EPW_ComEx_DMS5_DMS_FD1_DMS5_DMS_FD1_tx.h"
#ifndef STATIC
 ...
 **********************************************************/
FUNC (void, ComEx_CODE) E2EPW_WriteInit_DMS5_DMS_FD1_E2E (void)
{
    State_DMS5_DMS_FD1_E2E = &StateVal_DMS5_DMS_FD1_E2E;
    State_DMS5_DMS_FD1_E2E->Counter = 0;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, ComEx_CODE) E2EPW_Write_DMS5_DMS_FD1_E2E
    (P2VAR (ComEx_E2ETYPE, AUTOMATIC, ComEx_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, ComEx_CONST)
        Config_DMS5_DMS_FD1_E2E = &ConfigVal_DMS5_DMS_FD1_E2E;
    ...
    {
        E2EPW_Marshal_DMS5_DMS_FD1 ( AppData, ppa_DMS5_DMS_FD1_E2E_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_DMS5_DMS_FD1_E2E
                     , State_DMS5_DMS_FD1_E2E
                     , ppa_DMS5_DMS_FD1_E2E_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_DMS5_DMS_FD1_E2E->CRCOffset/8;
        uint16 cntoffset_u16 = Config_DMS5_DMS_FD1_E2E->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->Checksum = ppa_DMS5_DMS_FD1_E2E_au8[crcoffset_u16];
        AppData->RollingCounter = (ppa_DMS5_DMS_FD1_E2E_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_DMS5_DMS_FD1_E2E ( AppData );
