 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Can_Server.c
 *           Config:  D:/code/A08/VIP_A08_bak/Davinci/Gen/HUT_V3_5.dpa
 *        SW-C Type:  Can_Server
 *  Generation Time:  2022-01-19 14:01:06
 *
...
static const Com_Disable_RxPdu_Receive_Info Com_Disable_RxPdu_Receive_Cfg = 
{
    ...
    {
		CanIfConf_CanIfRxPduCfg_CSA1_oB30_for_SC_CAN_V3_2_068772bc_Rx,
 ...
 *   uint8 Rte_CData_NvBlockNeed_ActiveWU_Counter_DefaultValue(void)
...
static void CanServer_NetWorkAbnormal_record(uint8 recordType, uint8 awakeReason)
{
    ...
    na_data.records[0].Time_Month   = Decimal_to_BCD(currentDate.u8Month);
