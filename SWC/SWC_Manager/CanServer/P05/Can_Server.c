 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  Can_Server.c
 *           Config:  E:/06.Code/VIP_MCU_3.5/Gwm_v3.5_dev/Davinci_p05/Gen/HUT_V3_5.dpa
 *        SW-C Type:  Can_Server
 *  Generation Time:  2022-01-27 11:35:01
 *
...
static const Com_Disable_RxPdu_Receive_Info Com_Disable_RxPdu_Receive_Cfg = 
{
    ...
    /*CSA3  BCM6(GW)  BCM11  BCM10  BCM8  STBS1*/    
	{
		...
		CanIfConf_CanIfRxPduCfg_BCM10_oB30_for_SC_CAN_V3_2_99624f8c_Rx,
 ...
 *********************************************************************************************************************/
...
#endif
    {
        ...
        for(index = 0u; index < cna.config->signalConfigs[signalId].currentSize; index++)
        {
            cna.config->currentBuffer[signalCfg->currentStart + index] = value[index];
        }
