 ...
 *           Config:  D:/code/VIP03/VIP/Davinci/Gen/HUT_V3_5.dpa
 *        SW-C Type:  SocDtcProcess
 *  Generation Time:  2021-03-31 19:41:22
 *
 ...
 *********************************************************************************************************************/
 ...
 static TMCU_ActRotSpd mcuActSpd;
 ...
 *********************************************************************************************************************/
    ...
    *Data = (uint8)(systemPowerStatus.s_PowerVoltage.value * 10.0f);
    return RTE_E_OK;
 ...
 *********************************************************************************************************************/
    if(((SocVConfigDataBuf[VCONFIG_KIND_FUEL] == 0x3)||(SocVConfigDataBuf[VCONFIG_KIND_FUEL] == 0x4))&&
      (SocVConfigDataBuf[VCONFIG_KIND_ELECTROMOTOR_POSITION] == 0x5))
    {
 ...
 *********************************************************************************************************************/
    ...
    if(DEM_CYCLE_STATE_START == powerCycleSts)
    {
        ...
        (void)Rte_Enter_SocDtcPorcessExclusiveArea();
        memcpy(ptrIn,(uint8 *)dtcBuffer,DTC_BUFFER_SIZE);
        memset(dtcBuffer,0,DTC_BUFFER_SIZE);
        (void)Rte_Exit_SocDtcPorcessExclusiveArea();
 ...
 *********************************************************************************************************************/
    ...
    Rte_Read_rpSR_SG_ABS3_SG_ABS3(&sgAbs3Ptr);
    Rte_Read_rpSR_EngSpdVldty_EngSpdVldty(&sgEngSpdVldty);
    Rte_Read_rpSR_EngSpd_EngSpd(&sgEngSpd);
    Rte_Read_rpSR_OdoParament_Element(&OdoData);
    Rte_Read_rpSR_TMCU_ActRotSpd_TMCU_ActRotSpd(&mcuActSpd);
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_SysPowerModKL15_SysPowerMod(SysPowerMod *data)
 *   Std_ReturnType Rte_Read_SysPowerModVldKL15_SysPowerModVld(SysPowerModVld *data)
 ...
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_DiagnosticMonitor_AVMCalibrationFailed_ResetEventStatus(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_DiagnosticMonitor_AVMCalibrationFailed_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 ...
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_DiagnosticMonitor_Read_HUDScreen_IDFailed_ResetEventStatus(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_DiagnosticMonitor_Read_HUDScreen_IDFailed_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 ...
 *********************************************************************************************************************/
    ...
    fctRet = Rte_Read_SysPowerModKL15_SysPowerMod(&signalSysPowerMode);
    ...
    fctRet = Rte_Read_rpSR_SG_ABS3_SG_ABS3(&sgAbs3Ptr);
    if(E_OK != fctRet)
    {
    ...
    fctRet =Rte_Read_rpSR_EngSpdVldty_EngSpdVldty(&sgEngSpdVldty);
    if(E_OK != fctRet)
    {
        sgEngSpdVldty = 0;
    }

    fctRet = Rte_Read_rpSR_EngSpd_EngSpd(&sgEngSpd);
    if(E_OK != fctRet)
    {
        sgEngSpd = 0;
    }
