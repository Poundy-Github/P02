 ...
 *  Generation Time:  2022-01-04 10:33:38
 *
 ...
 *********************************************************************************************************************/
 ...
 #define LOW_VOLTAGE_THRSH       ((float64)9.0f)//9V
 #define LOW2_VOLTAGE_THRSH      ((float64)12.0f)//12V
 #define LOW3_VOLTAGE_THRSH      ((float64)10.0f)//10V
 #define LOW4_VOLTAGE_THRSH      ((float64)12.5f)//12.5V
 #define SIGNAL_MISSING_MAX_NUMBER      (10u)
 #define SOC_DTC_SIZE            (69u)
 ...
 static uint8 SocVConfig_CanBusType = 0; /* 0:CAN; 1:CAN FD */
 ...
 static const SocDtcEventHandlerCfg_t SocDtcCfg_Table[SOC_DTC_SIZE]=
 {
    ...
    ,{ 0x910011, Rte_Call_DiagnosticMonitor_RVC_CameraShortToGroundQnx_SetEventStatus}
    ,{ 0x910012, Rte_Call_DiagnosticMonitor_RVC_CameraShortToBatteryQnx_SetEventStatus}
    ,{ 0x910013, Rte_Call_DiagnosticMonitor_RVC_CameraOpenCircuitQnx_SetEventStatus}
    ,{ 0x95F811, Rte_Call_DiagnosticMonitor_A2B_ShortTodGround_SetEventStatus}
    ,{ 0x95F812, Rte_Call_DiagnosticMonitor_A2B_ShortTodBattary_SetEventStatus}
    ,{ 0x95F813, Rte_Call_DiagnosticMonitor_A2B_OpenCircuit_SetEventStatus}
 };
 ...
 *********************************************************************************************************************/
    sint64 tUtcTime;
    uint32 u32TmpDate = 0;
    DateTimeType_t currentDate = {0u,0u,0u,0u,0u,0u,0u};
 ...
 *********************************************************************************************************************/
  ...
  (void)Rte_Write_ClearDTC_Service0x14_StatusFlag(reqMonitorReInitCounter);
 ...
 *********************************************************************************************************************/
    ...
    VConfig_GetKindConfig(VCONFIG_KIND_PT_CAN_BUS_TYPE,&SocVConfig_CanBusType);
    if (SocVConfig_CanBusType == 1u)
    {
      Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_VEHSPDVLD_0X137, &sgAbs3Ptr.VehSpdVld_0x265, (uint8)sizeof(sgAbs3Ptr.VehSpdVld_0x265));
      Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_VEHSPD_0X137, &sgAbs3Ptr.VehSpd_0x265, (uint8)sizeof(sgAbs3Ptr.VehSpd_0x265));
    }
    else
    {
      Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_VEHSPDVLD_0X265, &sgAbs3Ptr.VehSpdVld_0x265, (uint8)sizeof(sgAbs3Ptr.VehSpdVld_0x265));
      Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_VEHSPD_0X265, &sgAbs3Ptr.VehSpd_0x265, (uint8)sizeof(sgAbs3Ptr.VehSpd_0x265));
    }

    (void)Rte_Read_rpSR_TMCU_ActSpd_RM_TMCU_ActSpd_RM(&mcuActSpd);

    Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_ENGSPDVLDTY, &sgEngSpdVldty, (uint8)sizeof(sgEngSpdVldty));
    Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_ENGSPD, &sgEngSpd, (uint8)sizeof(sgEngSpd));
 ...
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_DiagnosticMonitor_RVC_CameraOpenCircuitQnx_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_DiagnosticMonitor_RVC_CameraShortToBatteryQnx_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 *   Std_ReturnType Rte_Call_DiagnosticMonitor_RVC_CameraShortToGroundQnx_SetEventStatus(Dem_EventStatusType EventStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_DiagnosticMonitor_E_NOT_OK
 ...
 *   Std_ReturnType Rte_Call_EnableCondition_BatteryVoltage2_SetEnableCondition(boolean ConditionFulfilled)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_EnableCondition_E_NOT_OK
 *   Std_ReturnType Rte_Call_EnableCondition_BatteryVoltage3_SetEnableCondition(boolean ConditionFulfilled)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_EnableCondition_E_NOT_OK
 *   Std_ReturnType Rte_Call_EnableCondition_BatteryVoltage4_SetEnableCondition(boolean ConditionFulfilled)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_EnableCondition_E_NOT_OK
 ...
 *********************************************************************************************************************/
    ...
    KL15RetValue = Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_SYSPOWERMOD, &KL15Data, (uint8)sizeof(KL15Data));
    ...
    if((systemPowerStatus.s_PowerVoltage.value > LOW2_VOLTAGE_THRSH)&&(systemPowerStatus.s_PowerVoltage.value < HIGH_VOLTAGE_THRSH))
    {
        Rte_Call_EnableCondition_BatteryVoltage2_SetEnableCondition(TRUE);
    }
    else
    {
        Rte_Call_EnableCondition_BatteryVoltage2_SetEnableCondition(FALSE);
    }

    if((systemPowerStatus.s_PowerVoltage.value > LOW3_VOLTAGE_THRSH)&&(systemPowerStatus.s_PowerVoltage.value < HIGH_VOLTAGE_THRSH))
    {
        Rte_Call_EnableCondition_BatteryVoltage3_SetEnableCondition(TRUE);
    }
    else
    {
        Rte_Call_EnableCondition_BatteryVoltage3_SetEnableCondition(FALSE);
    }
    if((systemPowerStatus.s_PowerVoltage.value > LOW4_VOLTAGE_THRSH)&&(systemPowerStatus.s_PowerVoltage.value < HIGH_VOLTAGE_THRSH))
    {
        Rte_Call_EnableCondition_BatteryVoltage4_SetEnableCondition(TRUE);
    }
    else
    {
        Rte_Call_EnableCondition_BatteryVoltage4_SetEnableCondition(FALSE);
    }
    ...
    fctRet = Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_ENGSPDVLDTY, &sgEngSpdVldty, (uint8)sizeof(sgEngSpdVldty));
    Rte_Call_rpCS_ComEx_ReceiveSignal(COMEX_SIGNAL_RX_ENGSPD, &sgEngSpd, (uint8)sizeof(sgEngSpd));
    ...
    {
        (void)Rte_Write_ppSR_DtcInfoForIPErrorStatus_Element(0);
    }
    else
    {
        (void)Rte_Write_ppSR_DtcInfoForIPErrorStatus_Element(1);
    }
...
static Std_ReturnType SocDiagnosticMonitorSetEventStatus(uint32 Dtc,Dem_EventStatusType EventStatus)
{
    ...
    static Dem_EventStatusType lastEventStatus[SOC_DTC_SIZE] = {0};
    for(i = 0; i < SOC_DTC_SIZE; i++)
    {
        if(SocDtcCfg_Table[i].dtc == Dtc)
        {
            lRetValue = SocDtcCfg_Table[i].setEventFct(EventStatus);
            if(lastEventStatus[i] != EventStatus)
            {
               can_warn("Soc report dtc %06X %s",Dtc,EventStatus == DEM_EVENT_STATUS_FAILED?"fail":"pass");
               lastEventStatus[i] = EventStatus;
            }
            break;
        }
    }
