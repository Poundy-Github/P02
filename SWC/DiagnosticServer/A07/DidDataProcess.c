 ...
 *********************************************************************************************************************/
    (void)memcpy((uint8 *)Data,(uint8*)Rte_Pim_NvBlockNeed_VIN_MirrorBlock(),sizeof(A_17Bytes));
 ...
 *     Argument data: uint8* is of type A_200Bytes
 ...
 *     Argument data: uint8* is of type A_300Bytes
 ...
 *********************************************************************************************************************/
    ...
    { 
        case DCM_INITIAL: 
            ...
            if((E_OK == fctRet)&&(NVM_REQ_PENDING != nvmStatus)&&(length == sizeof(A_200Bytes)))
            {
