 ...
 *  Generation Time:  2021-09-24 14:55:39
 *
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_ppSR_DTC_SpeedoInfo_Element(s_SpeedoInfo_t *data)
 *   Std_ReturnType Rte_Read_ppSR_DTC_TachoInfo_Element(s_TachoInfo_t *data)
