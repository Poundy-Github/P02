...
int32_t IPC_M2S_POWERSocManagerHeathResponse_Pack(IPC_M2S_POWERSocManagerHeathResponse_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_M2S_POWER_SOCMANAGER_MSGSUB_HEATHRESPONSE_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_M2S_POWER_MSGMAJOR_SOCMANAGER_ID;
        payload[4] = IPC_M2S_POWER_SOCMANAGER_MSGSUB_HEATHRESPONSE_ID;
        payload[5] = IPC_GET_BYTE(data->u8Reserved, 0);
        totalLength = IPC_M2S_POWER_SOCMANAGER_MSGSUB_HEATHRESPONSE_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_M2S_POWERSocManagerHeathResponse_Parse(IPC_M2S_POWERSocManagerHeathResponse_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_M2S_POWER_SOCMANAGER_MSGSUB_HEATHRESPONSE_LENGTH == length))
    {
...
int32_t IPC_M2S_POWERSystemStateMCUState_Pack(IPC_M2S_POWERSystemStateMCUState_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_M2S_POWER_SYSTEMSTATE_MSGSUB_MCUSTATE_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_M2S_POWER_MSGMAJOR_SYSTEMSTATE_ID;
        payload[4] = IPC_M2S_POWER_SYSTEMSTATE_MSGSUB_MCUSTATE_ID;
        payload[5] = IPC_GET_BYTE(data->MCUState, 0);
        totalLength = IPC_M2S_POWER_SYSTEMSTATE_MSGSUB_MCUSTATE_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_M2S_POWERSystemStateMCUState_Parse(IPC_M2S_POWERSystemStateMCUState_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_M2S_POWER_SYSTEMSTATE_MSGSUB_MCUSTATE_LENGTH == length))
    {
        IPC_GET_BYTE(data->MCUState, 0) = payload[0];
        ret = 0;
    }
    return ret;
}
...
int32_t IPC_M2S_POWERPowerInfoFOTAACK_Pack(IPC_M2S_POWERPowerInfoFOTAACK_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_M2S_POWER_POWERINFO_MSGSUB_FOTAACK_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_M2S_POWER_MSGMAJOR_POWERINFO_ID;
        payload[4] = IPC_M2S_POWER_POWERINFO_MSGSUB_FOTAACK_ID;
        payload[5] = IPC_GET_BYTE(data->StsACK, 0);
        totalLength = IPC_M2S_POWER_POWERINFO_MSGSUB_FOTAACK_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_M2S_POWERPowerInfoFOTAACK_Parse(IPC_M2S_POWERPowerInfoFOTAACK_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_M2S_POWER_POWERINFO_MSGSUB_FOTAACK_LENGTH == length))
    {
        IPC_GET_BYTE(data->StsACK, 0) = payload[0];
        ret = 0;
    }
    return ret;
}
...
int32_t IPC_M2S_POWERPowerInfoAPP_INFOMS_Pack(IPC_M2S_POWERPowerInfoAPP_INFOMS_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_M2S_POWER_POWERINFO_MSGSUB_APP_INFOMS_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_M2S_POWER_MSGMAJOR_POWERINFO_ID;
        payload[4] = IPC_M2S_POWER_POWERINFO_MSGSUB_APP_INFOMS_ID;
        payload[5] = IPC_GET_BYTE(data->type, 0);
        payload[6] = IPC_GET_BYTE(data->value, 0);
        totalLength = IPC_M2S_POWER_POWERINFO_MSGSUB_APP_INFOMS_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_M2S_POWERPowerInfoAPP_INFOMS_Parse(IPC_M2S_POWERPowerInfoAPP_INFOMS_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_M2S_POWER_POWERINFO_MSGSUB_APP_INFOMS_LENGTH == length))
    {
        IPC_GET_BYTE(data->type, 0) = payload[0];
        IPC_GET_BYTE(data->value, 0) = payload[1];
        ret = 0;
    }
    return ret;
}
...
int32_t IPC_S2M_POWERSocManagerPowerOFFReady_Pack(IPC_S2M_POWERSocManagerPowerOFFReady_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_S2M_POWER_SOCMANAGER_MSGSUB_POWEROFFREADY_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_S2M_POWER_MSGMAJOR_SOCMANAGER_ID;
        payload[4] = IPC_S2M_POWER_SOCMANAGER_MSGSUB_POWEROFFREADY_ID;
        payload[5] = IPC_GET_BYTE(data->u8Reserved, 0);
        totalLength = IPC_S2M_POWER_SOCMANAGER_MSGSUB_POWEROFFREADY_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_S2M_POWERSocManagerPowerOFFReady_Parse(IPC_S2M_POWERSocManagerPowerOFFReady_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_S2M_POWER_SOCMANAGER_MSGSUB_POWEROFFREADY_LENGTH == length))
    {
        IPC_GET_BYTE(data->u8Reserved, 0) = payload[0];
        ret = 0;
    }
...
int32_t IPC_S2M_POWERSocManagerHealthset_Pack(IPC_S2M_POWERSocManagerHealthset_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_S2M_POWER_SOCMANAGER_MSGSUB_HEALTHSET_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_S2M_POWER_MSGMAJOR_SOCMANAGER_ID;
        payload[4] = IPC_S2M_POWER_SOCMANAGER_MSGSUB_HEALTHSET_ID;
        payload[5] = IPC_GET_BYTE(data->u8Reserved, 0);
        totalLength = IPC_S2M_POWER_SOCMANAGER_MSGSUB_HEALTHSET_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_S2M_POWERSocManagerHealthset_Parse(IPC_S2M_POWERSocManagerHealthset_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_S2M_POWER_SOCMANAGER_MSGSUB_HEALTHSET_LENGTH == length))
    {
        IPC_GET_BYTE(data->u8Reserved, 0) = payload[0];
        ret = 0;
    }
...
int32_t IPC_S2M_POWERSystemStateFOTASts_Pack(IPC_S2M_POWERSystemStateFOTASts_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_FOTASTS_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_S2M_POWER_MSGMAJOR_SYSTEMSTATE_ID;
        payload[4] = IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_FOTASTS_ID;
        payload[5] = IPC_GET_BYTE(data->State, 0);
        totalLength = IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_FOTASTS_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_S2M_POWERSystemStateFOTASts_Parse(IPC_S2M_POWERSystemStateFOTASts_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_FOTASTS_LENGTH == length))
    {
        IPC_GET_BYTE(data->State, 0) = payload[0];
        ret = 0;
    }
    return ret;
}
...
int32_t IPC_S2M_POWERSystemStateGetSMSts_Pack(IPC_S2M_POWERSystemStateGetSMSts_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_GETSMSTS_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_S2M_POWER_MSGMAJOR_SYSTEMSTATE_ID;
        payload[4] = IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_GETSMSTS_ID;
        payload[5] = IPC_GET_BYTE(data->State, 0);
        totalLength = IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_GETSMSTS_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_S2M_POWERSystemStateGetSMSts_Parse(IPC_S2M_POWERSystemStateGetSMSts_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_GETSMSTS_LENGTH == length))
    {
        IPC_GET_BYTE(data->State, 0) = payload[0];
        ret = 0;
    }
...
int32_t IPC_S2M_POWERSystemStateAPP_INFOSM_Pack(IPC_S2M_POWERSystemStateAPP_INFOSM_t *data, uint8_t *payload, uint16_t length)
{
    ...
    if((data != NULL) && (payload != NULL) &&
        (length >= IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_APP_INFOSM_LENGTH))
    {
        payload[2] = IPC_GROUP_POWER_ID;
        payload[3] = IPC_S2M_POWER_MSGMAJOR_SYSTEMSTATE_ID;
        payload[4] = IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_APP_INFOSM_ID;
        payload[5] = IPC_GET_BYTE(data->type, 0);
        payload[6] = IPC_GET_BYTE(data->value, 0);
        totalLength = IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_APP_INFOSM_LENGTH + 5;
        payload[0] = (uint8_t)(totalLength >> 8);
        payload[1] = (uint8_t)(totalLength);
        ret = (int32_t)totalLength;
    }
...
int32_t IPC_S2M_POWERSystemStateAPP_INFOSM_Parse(IPC_S2M_POWERSystemStateAPP_INFOSM_t *data, uint8_t *payload, uint16_t length)
{
    int32_t ret = -1;
    if((payload != NULL) && (data != NULL) &&
        (IPC_S2M_POWER_SYSTEMSTATE_MSGSUB_APP_INFOSM_LENGTH == length))
    {
        IPC_GET_BYTE(data->type, 0) = payload[0];
        IPC_GET_BYTE(data->value, 0) = payload[1];
        ret = 0;
