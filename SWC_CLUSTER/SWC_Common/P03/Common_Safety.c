 ...
 *  Generation Time:  2022-04-08 21:05:33
 *
 ...
 *   Std_ReturnType Rte_Call_rpCS_SWCSafety_ComEx_GetRxE2EStatus(ComEx_SignalGroupIdType GroupId, uint32 *E2eStatus)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_ComEx_COMEX_ERROR_PARAM, RTE_E_ComEx_E_OK
 *   Std_ReturnType Rte_Call_rpCS_SWCSafety_ComEx_ReceiveSignal(ComEx_SignalIdType SignalId, uint8 *SignalDataPtr, uint8 Length)
 ...
 *   Std_ReturnType Rte_Call_rpCS_SWCSafety_ComEx_SendSignal(ComEx_SignalIdType SignalId, ComEx_ConstSignalDataType SignalDataPtr, uint8 Length)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_ComEx_COMEX_ERROR_PARAM, RTE_E_ComEx_E_OK
 *
 * Service Calls:
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_ppSR_SWCSafety_DrvGearDisp_Element(DrvGearDisp data)
 *   Std_ReturnType Rte_Write_ppSR_SWCSafety_GearMsgMiss_Element(uint8 data)
 *
 * Client/Server Interfaces:
 * =========================
 *   Server Invocation:
