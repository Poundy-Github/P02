 ...
 *           Config:  D:/code/VIP-P03/VIP/Davinci/Gen/HUT_V3_5.dpa
 *        SW-C Type:  Common_GateWay
 *  Generation Time:  2022-04-08 21:05:29
 *
 ...
 * NVM_IPC_CAN2_Type: Array with 200 element(s) of type uint8
 ...
 *   DataSyncFlag of type uint8
 *   Sd_BaroPressure of type uint16
 *   Sd_Heilvl of type uint16
 *   Sd_HeilvlSign of type uint8
 *   Sd_PitchAngle of type uint8
 *   Sd_PitchAngleSign of type uint8
 *   Sd_GeoGraphic of type uint8
 *   Sd_SteerWheel of type uint8
 *   Sd_SteerWheelSign of type uint8
 ...
 * Per-Instance Memory:
 * ====================
 *   uint8 *Rte_Pim_NvBlockNeed_Block_IPC_CAN_Data2_MirrorBlock(void)
 *     Returnvalue: uint8* is of type NVM_IPC_CAN2_Type
 ...
 *   ----------------------------------
 *   uint8 *Rte_CData_NvBlockNeed_Block_IPC_CAN_Data2_DefaultValue(void)
 *     Returnvalue: uint8* is of type NVM_IPC_CAN2_Type
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_AWakeHold_DVRRemtCnSts(uint8 data)
 *   Std_ReturnType Rte_Write_AwakeHlod_Heartbeat_counter(uint8 data)
 ...
 *   Server Invocation:
 *   ------------------
 *   Std_ReturnType Rte_Call_CNA_SignalGroupSet_Operation(const EventSignalInfo_Type *event_signal_info)
 *     Synchronous Server Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_CNA_SignalGroupSet_Std_ReturnType
 ...
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rcCS_SWCNormal_ReceiveOffroadInfo_Callback(uint8 *data)
 *     Synchronous Server Invocation. Timeout: None
 ...
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rpCS_SWCGateWay_TtToChime_Callback(uint8 *data)
 *     Synchronous Server Invocation. Timeout: None
 ...
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_Defs_NvBlockNeed_Block_IPC_CAN_Data2_EraseBlock(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_Defs_NvBlockNeed_Block_IPC_CAN_Data2_GetErrorStatus(NvM_RequestResultType *ErrorStatus)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_Defs_NvBlockNeed_Block_IPC_CAN_Data2_InvalidateNvBlock(void)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_Defs_NvBlockNeed_Block_IPC_CAN_Data2_ReadBlock(dtRef_VOID DstPtr)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_Defs_NvBlockNeed_Block_IPC_CAN_Data2_RestoreBlockDefaults(dtRef_VOID DstPtr)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_NvMService_AC3_Defs_NvBlockNeed_Block_IPC_CAN_Data2_WriteBlock(dtRef_const_VOID SrcPtr)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_Defs_E_NOT_OK
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: NvMNotifyJobFinished_NvBlockNeed_Block_IPC_CAN_Data2_JobFinished
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <JobFinished> of PortPrototype <NvMNotifyJobFinished_NvBlockNeed_Block_IPC_CAN_Data2>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   void NvMNotifyJobFinished_NvBlockNeed_Block_IPC_CAN_Data2_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: NvMNotifyJobFinished_NvBlockNeed_Block_IPC_CAN_Data2_JobFinished_doc
 *********************************************************************************************************************/
...
FUNC(void, Common_GateWay_CODE) NvMNotifyJobFinished_NvBlockNeed_Block_IPC_CAN_Data2_JobFinished(NvM_ServiceIdType ServiceId, NvM_RequestResultType JobResult) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: NvMNotifyJobFinished_NvBlockNeed_Block_IPC_CAN_Data2_JobFinished
 *********************************************************************************************************************/
