 ...
 *  Generation Time:  2021-06-11 21:53:29
 *
 ...
 *   CxD_EV_mode_is_not_available_due_to_battery_available_power_low (13U)
 ...
 *   Cx0_Closed (0U)
 *   Cx1_Open (1U)
 * UVCAntiVirusFdbk: Enumeration of integer in interval [0...7] with enumerators
 *   Cx0_OFF (0U)
 *   Cx1_ON (1U)
 *   Cx2_Failed (2U)
 *   Cx3_Interrupted (3U)
 ...
 *   Std_ReturnType Rte_Read_UVCAntiVirusFdbk_UVCAntiVirusFdbk(UVCAntiVirusFdbk *data)
 ...
 *********************************************************************************************************************/
    TC_Api_Emergy_Get_IVI_Alive_Respone(Id,Data); /* period check ivi alive and response */
