 ...
 *           Config:  C:/01-Project/B03_dev/Davinci/Gen/HUT_V3_5.dpa
 *        SW-C Type:  Common_GateWay
 *  Generation Time:  2021-06-08 14:25:17
 *
 ...
 * HeadPosnX: Integer in interval [0...65535]
 * HeadPosnY: Integer in interval [0...65535]
 * HeadPosnZ: Integer in interval [0...65535]
 ...
 * dummy_DMS_FD1_10: Integer in interval [0...255]
 * dummy_DMS_FD1_11: Integer in interval [0...255]
 * dummy_DMS_FD1_12: Integer in interval [0...255]
 * dummy_DMS_FD1_13: Boolean
 * dummy_DMS_FD1_19: Integer in interval [0...255]
 * dummy_DMS_FD1_20: Integer in interval [0...255]
 * dummy_DMS_FD1_21: Integer in interval [0...255]
 * dummy_DMS_FD1_22: Boolean
 * dummy_DMS_FD1_23: Boolean
 * dummy_DMS_FD1_24: Boolean
 * dummy_DMS_FD1_25: Integer in interval [0...255]
 * dummy_DMS_FD1_26: Integer in interval [0...255]
 * dummy_DMS_FD1_5: Boolean
 * dummy_DMS_FD1_6: Boolean
 * dummy_DMS_FD1_7: Integer in interval [0...255]
 * dummy_DMS_FD1_8: Integer in interval [0...255]
 * dummy_DMS_FD1_9: Boolean
 ...
 *   Cx00_Valid_value (0U)
 *   CxFF_Valid_value (255U)
 * Checksum_DMS2: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_values (0U)
 *   CxFF_Valid_values (255U)
 * Checksum_DMS3: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_values (0U)
 *   CxFF_Valid_values (255U)
 * Checksum_DMS5: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_values (0U)
 *   CxFF_Valid_values (255U)
 * Checksum_DMS6: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_values (0U)
 *   CxFF_Valid_values (255U)
 ...
 *   CxA_Reserved (10U)
 *   CxF_Reserved (15U)
 * DMSSts: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_Blindness (0U)
 *   Cx1_Error (1U)
 *   Cx2_Active (2U)
 *   Cx3_Not_active (3U)
 ...
 *   Cx6_Reserved (6U)
 *   Cx7_Invalid (7U)
 * DistrctnLvl: Enumeration of integer in interval [0...255] with enumerators
 ...
 *   Cx6_Reserved (6U)
 *   Cx7_Invalid (7U)
 * DistrctnLvlQlty: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 *   Cx7F_Invalid (127U)
 * DistrctnLvlQlty_ACC: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 *   Cx7F_Invalid (127U)
 * DistrctnLvl_ACC: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_No_distraction (0U)
 *   Cx1_Low_level_distraction (1U)
 *   Cx2_Middle_level_distraction (2U)
 ...
 *   Cx6_Reserved (6U)
 *   Cx7_Invalid (7U)
 * DrowsnsLvlQlty_ACC: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 *   Cx7F_Invalid (127U)
 * DrowsnsLvl_ACC: Enumeration of integer in interval [0...255] with enumerators
 ...
 *   Cx6_Reserved (6U)
 *   Cx7_Invalid (7U)
 * DrvBehvSts: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_No_actiong (0U)
 *   Cx1_Smoking (1U)
 *   Cx2_on_the_phone (2U)
 *   Cx3_Reserved (3U)
 ...
 *   TC_ENERGY_DTE (2U)
 * ExprsnSts: Enumeration of integer in interval [0...7] with enumerators
 *   Cx0_No_expression (0U)
 *   Cx1_Smile (1U)
 *   Cx2_Angry (2U)
 *   Cx3_Surprise (3U)
 *   Cx4_Sad (4U)
 ...
 * HeadPosQlty: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 *   Cx7F_Invalid (127U)
 * HeadRotAngQlty: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 ...
 *   Cx3_Resvered (3U)
 * LEyeOpenSts: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_No (0U)
 *   Cx1_Yes (1U)
 *   Cx2_Loss_left_eye (2U)
 *   Cx3_Invalid (3U)
 * LEyeOpenStsQlty: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 ...
 *   Cx3_Reserved (3U)
 * REyeOpenSts: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_No (0U)
 *   Cx1_Yes (1U)
 *   Cx2_Loss_right_eye (2U)
 *   Cx3_Invalid (3U)
 * REyeOpenStsQlty: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 ...
 *   Cx5_Reserved (5U)
 *   Cx7_Reserved (7U)
 * RobustGazeAngQlty: Enumeration of integer in interval [0...255] with enumerators
 *   Cx00_Valid_value (0U)
 *   Cx64_Valid_value (100U)
 *   Cx65_Reserved (101U)
 *   Cx7E_Reserved (126U)
 ...
 *   CxE_Valid_value (14U)
 *   CxF_Invalid_value (15U)
 * RollingCounter_DMS2: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_Valid_value (0U)
 *   CxE_Valid_value (14U)
 *   CxF_Invalid_value (15U)
 * RollingCounter_DMS3: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_Valid_value (0U)
 *   CxE_Valid_value (14U)
 *   CxF_Invalid_value (15U)
 * RollingCounter_DMS5: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_Valid_value (0U)
 *   CxE_Valid_value (14U)
 *   CxF_Invalid_value (15U)
 * RollingCounter_DMS6: Enumeration of integer in interval [0...255] with enumerators
 *   Cx0_Valid_value (0U)
 *   CxE_Valid_value (14U)
 *   CxF_Invalid_value (15U)
 ...
 * ABM2_0x245: Array with 8 element(s) of type uint8
 ...
 * AEB_FD1_0x18B: Array with 64 element(s) of type uint8
 * AEB_FD2_0x227: Array with 64 element(s) of type uint8
 * AMP1_0x3E1: Array with 8 element(s) of type uint8
 * AMP2_0x3E3: Array with 16 element(s) of type uint8
 * AMP3_0x3E5: Array with 8 element(s) of type uint8
 * AMP4_ANC1_0x2D2: Array with 8 element(s) of type uint8
 * AMP5_IESS1_0x3A1: Array with 8 element(s) of type uint8
 ...
 * DVR_FD1_0x2EC: Array with 64 element(s) of type uint8
 * ECM10_0x139: Array with 8 element(s) of type uint8
 * ECM11_0x2D3: Array with 8 element(s) of type uint8
 * ECM1_0x111: Array with 8 element(s) of type uint8
 * ECM20_0x3B7: Array with 8 element(s) of type uint8
 * ECM2_0x271: Array with 8 element(s) of type uint8
 * ECM3_0x371: Array with 8 element(s) of type uint8
 * ECM4_0x82: Array with 8 element(s) of type uint8
 * ECM7_0x84: Array with 8 element(s) of type uint8
 * ECM8_0x86: Array with 8 element(s) of type uint8
 * ECM9_0x102: Array with 8 element(s) of type uint8
 * ECM_PT6_0x290: Array with 8 element(s) of type uint8
 ...
 * EPS2_0x162: Array with 8 element(s) of type uint8
 ...
 * GLO_NASS1_0x56: Array with 8 element(s) of type uint8
 ...
 * HUT_FD2_0x288: Array with 64 element(s) of type uint8
 * HUT_FD3_0x2E9: Array with 64 element(s) of type uint8
 ...
 * IFC1_0x109: Array with 8 element(s) of type uint8
 ...
 * Ibooster_FD2_0x120: Array with 64 element(s) of type uint8
 ...
 * STBS1_0x21F: Array with 8 element(s) of type uint8
 * TMCU6_0x93: Array with 8 element(s) of type uint8
 ...
 * T_Box_FD4_0x1E1: Array with 16 element(s) of type uint8
 * T_Box_FD6_0x33D: Array with 8 element(s) of type uint8
 * Trailer1_0x273: Array with 8 element(s) of type uint8
 * VMDR1_0x2FB: Array with 8 element(s) of type uint8
 ...
 *   Fuel_Level_Display_Value of type uint16
 ...
 *   Fuel_Level_Display_Value_Aux of type uint16
 ...
 * SG_DMS2_DMS_FD1: Record with elements
 *   Checksum_DMS2 of type Checksum_DMS2
 *   DistrctnLvl of type DistrctnLvl
 *   DistrctnLvl_ACC of type DistrctnLvl_ACC
 *   DistrctnLvlQlty of type DistrctnLvlQlty
 *   DistrctnLvlQlty_ACC of type DistrctnLvlQlty_ACC
 *   DrowsnsLvl_ACC of type DrowsnsLvl_ACC
 *   DrowsnsLvlQlty_ACC of type DrowsnsLvlQlty_ACC
 *   dummy_DMS_FD1_5 of type dummy_DMS_FD1_5
 *   dummy_DMS_FD1_6 of type dummy_DMS_FD1_6
 *   dummy_DMS_FD1_7 of type dummy_DMS_FD1_7
 *   dummy_DMS_FD1_8 of type dummy_DMS_FD1_8
 *   dummy_DMS_FD1_9 of type dummy_DMS_FD1_9
 *   dummy_DMS_FD1_10 of type dummy_DMS_FD1_10
 *   dummy_DMS_FD1_11 of type dummy_DMS_FD1_11
 *   RollingCounter_DMS2 of type RollingCounter_DMS2
 * SG_DMS3_DMS_FD1: Record with elements
 *   Checksum_DMS3 of type Checksum_DMS3
 *   DrvBehvSts of type DrvBehvSts
 *   dummy_DMS_FD1_12 of type dummy_DMS_FD1_12
 *   dummy_DMS_FD1_13 of type dummy_DMS_FD1_13
 *   HeadPosnX of type HeadPosnX
 *   HeadPosnY of type HeadPosnY
 *   HeadPosnZ of type HeadPosnZ
 *   HeadPosQlty of type HeadPosQlty
 *   RollingCounter_DMS3 of type RollingCounter_DMS3
 * SG_DMS5_DMS_FD1: Record with elements
 *   Checksum_DMS5 of type Checksum_DMS5
 *   DMSSts of type DMSSts
 *   dummy_DMS_FD1_19 of type dummy_DMS_FD1_19
 *   dummy_DMS_FD1_20 of type dummy_DMS_FD1_20
 *   dummy_DMS_FD1_21 of type dummy_DMS_FD1_21
 *   HeadDetn of type HeadDetn
 *   HeadPitchAng of type HeadPitchAng
 *   HeadRollAng of type HeadRollAng
 *   HeadRotAngQlty of type HeadRotAngQlty
 *   HeadYawAng of type HeadYawAng
 *   RollingCounter_DMS5 of type RollingCounter_DMS5
 * SG_DMS6_DMS_FD1: Record with elements
 *   Checksum_DMS6 of type Checksum_DMS6
 *   dummy_DMS_FD1_22 of type dummy_DMS_FD1_22
 *   dummy_DMS_FD1_23 of type dummy_DMS_FD1_23
 *   dummy_DMS_FD1_24 of type dummy_DMS_FD1_24
 *   dummy_DMS_FD1_25 of type dummy_DMS_FD1_25
 *   dummy_DMS_FD1_26 of type dummy_DMS_FD1_26
 *   LEyeOpenSts of type LEyeOpenSts
 *   LEyeOpenStsQlty of type LEyeOpenStsQlty
 *   REyeOpenSts of type REyeOpenSts
 *   REyeOpenStsQlty of type REyeOpenStsQlty
 *   RobustGazeAngQlty of type RobustGazeAngQlty
 *   RobustGazePitchAng of type RobustGazePitchAng
 *   RobustGazeYawAng of type RobustGazeYawAng
 *   RollingCounter_DMS6 of type RollingCounter_DMS6
 ...
 *   Std_ReturnType Rte_Read_ABM2_0x245_ABM2_0x245(uint8 *data)
 *     Argument data: uint8* is of type ABM2_0x245
 ...
 *   Std_ReturnType Rte_Read_AEB_FD1_0x18B_AEB_FD1_0x18B(uint8 *data)
 *     Argument data: uint8* is of type AEB_FD1_0x18B
 *   Std_ReturnType Rte_Read_AEB_FD2_0x227_AEB_FD2_0x227(uint8 *data)
 *     Argument data: uint8* is of type AEB_FD2_0x227
 *   Std_ReturnType Rte_Read_AMP1_0x3E1_AMP1_0x3E1(uint8 *data)
 *     Argument data: uint8* is of type AMP1_0x3E1
 ...
 *   Std_ReturnType Rte_Read_AMP4_ANC1_0x2D2_AMP4_ANC1_0x2D2(uint8 *data)
 *     Argument data: uint8* is of type AMP4_ANC1_0x2D2
 *   Std_ReturnType Rte_Read_AMP5_IESS1_0x3A1_AMP5_IESS1_0x3A1(uint8 *data)
 *     Argument data: uint8* is of type AMP5_IESS1_0x3A1
 ...
 *   Std_ReturnType Rte_Read_ECM10_0x139_ECM10_0x139(uint8 *data)
 *     Argument data: uint8* is of type ECM10_0x139
 ...
 *   Std_ReturnType Rte_Read_ECM20_0x3B7_ECM20_0x3B7(uint8 *data)
 *     Argument data: uint8* is of type ECM20_0x3B7
 ...
 *   Std_ReturnType Rte_Read_ECM4_0x82_ECM4_0x82(uint8 *data)
 *     Argument data: uint8* is of type ECM4_0x82
 *   Std_ReturnType Rte_Read_ECM7_0x84_ECM7_0x84(uint8 *data)
 *     Argument data: uint8* is of type ECM7_0x84
 *   Std_ReturnType Rte_Read_ECM8_0x86_ECM8_0x86(uint8 *data)
 *     Argument data: uint8* is of type ECM8_0x86
 *   Std_ReturnType Rte_Read_ECM9_0x102_ECM9_0x102(uint8 *data)
 *     Argument data: uint8* is of type ECM9_0x102
 *   Std_ReturnType Rte_Read_ECM_PT6_0x290_ECM_PT6_0x290(uint8 *data)
 *     Argument data: uint8* is of type ECM_PT6_0x290
 ...
 *   Std_ReturnType Rte_Read_EPS2_0x162_EPS2_0x162(uint8 *data)
 *     Argument data: uint8* is of type EPS2_0x162
 ...
 *   Std_ReturnType Rte_Read_GLO_NASS1_0x56_GLO_NASS1_0x56(uint8 *data)
 *     Argument data: uint8* is of type GLO_NASS1_0x56
 ...
 *   Std_ReturnType Rte_Read_IFC1_0x109_IFC1_0x109(uint8 *data)
 *     Argument data: uint8* is of type IFC1_0x109
 ...
 *   Std_ReturnType Rte_Read_Ibooster_FD2_0x120_Ibooster_FD2_0x120(uint8 *data)
 *     Argument data: uint8* is of type Ibooster_FD2_0x120
 ...
 *   Std_ReturnType Rte_Read_STBS1_0x21F_STBS1_0x21F(uint8 *data)
 *     Argument data: uint8* is of type STBS1_0x21F
 *   Std_ReturnType Rte_Read_TMCU6_0x93_TMCU6_0x93(uint8 *data)
 *     Argument data: uint8* is of type TMCU6_0x93
 ...
 *   Std_ReturnType Rte_Read_T_Box_FD4_0x1E1_T_Box_FD4_0x1E1(uint8 *data)
 *     Argument data: uint8* is of type T_Box_FD4_0x1E1
 *   Std_ReturnType Rte_Read_Trailer1_0x273_Trailer1_0x273(uint8 *data)
 *     Argument data: uint8* is of type Trailer1_0x273
 *   Std_ReturnType Rte_Read_VMDR1_0x2FB_VMDR1_0x2FB(uint8 *data)
 *     Argument data: uint8* is of type VMDR1_0x2FB
 ...
 *   boolean Rte_IsUpdated_Ibooster_FD2_0x120_Ibooster_FD2_0x120(void)
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_DMS_FD1_0x24D_DMS_FD1_0x24D(const uint8 *data)
 *     Argument data: uint8* is of type DMS_FD1_0x24D
 *   Std_ReturnType Rte_Write_DVR_FD1_0x2EC_DVR_FD1_0x2EC(const uint8 *data)
 *     Argument data: uint8* is of type DVR_FD1_0x2EC
 *   Std_ReturnType Rte_Write_ExprsnSts_ExprsnSts(ExprsnSts data)
 ...
 *   Std_ReturnType Rte_Write_HUT_FD2_0x288_HUT_FD2_0x288(const uint8 *data)
 *     Argument data: uint8* is of type HUT_FD2_0x288
 *   Std_ReturnType Rte_Write_HUT_FD3_0x2E9_HUT_FD3_0x2E9(const uint8 *data)
 *     Argument data: uint8* is of type HUT_FD3_0x2E9
 ...
 *   Std_ReturnType Rte_Write_SG_DMS2_DMS_FD1_SG_DMS2_DMS_FD1(const SG_DMS2_DMS_FD1 *data)
 *   Std_ReturnType Rte_Write_SG_DMS3_DMS_FD1_SG_DMS3_DMS_FD1(const SG_DMS3_DMS_FD1 *data)
 *   Std_ReturnType Rte_Write_SG_DMS5_DMS_FD1_SG_DMS5_DMS_FD1(const SG_DMS5_DMS_FD1 *data)
 *   Std_ReturnType Rte_Write_SG_DMS6_DMS_FD1_SG_DMS6_DMS_FD1(const SG_DMS6_DMS_FD1 *data)
 ...
 *   Std_ReturnType Rte_Write_T_Box_FD6_0x33D_T_Box_FD6_0x33D(const uint8 *data)
 *     Argument data: uint8* is of type T_Box_FD6_0x33D
 ...
 *     Synchronous Server Invocation. Timeout: None
 *   Std_ReturnType Rte_Call_rpCS_SWCGateway_UTCTime_GetUTCTimeInMillis(uint64 *arg)
 *     Synchronous Server Invocation. Timeout: None
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: IPC_Tx_E2E_CanMsg_DMS_FD1_CallBack
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <CallBack> of PortPrototype <ppCS_SWCGateWay_IPC_Tx_E2E_CanMsg_DMS_FD1>
 *
 **********************************************************************************************************************
 *
 * Runnable prototype:
 * ===================
 *   void IPC_Tx_E2E_CanMsg_DMS_FD1_CallBack(void)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: IPC_Tx_E2E_CanMsg_DMS_FD1_CallBack_doc
 *********************************************************************************************************************/
...
FUNC(void, Common_GateWay_CODE) IPC_Tx_E2E_CanMsg_DMS_FD1_CallBack(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: IPC_Tx_E2E_CanMsg_DMS_FD1_CallBack
 *********************************************************************************************************************/
    IPC_API_E2eTxCanMsgDownLoadCallback(SWC_IPC_CAN_MSG_DMS_FD1);
 ...
 *********************************************************************************************************************/
  ...
  IPC_API_E2eTxCanMsgDownLoadCallback( SWC_IPC_CAN_MSG_HUT_IP2 );
